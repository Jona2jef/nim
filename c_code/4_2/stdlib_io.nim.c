...
N_LIB_PRIVATE N_NIMCALL(int, getFileHandle__systemZio_229)(FILE* f);
N_LIB_PRIVATE N_NIMCALL(void, close__systemZio_218)(FILE* f);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setInheritable__systemZio_235)(int f, NIM_BOOL inheritable);
N_LIB_PRIVATE N_NIMCALL(int, getOsFileHandle__systemZio_232)(FILE* f);
...
N_LIB_PRIVATE N_NIMCALL(NI64, rawFileSize__systemZio_335)(FILE* file);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile__systemZio_343)(FILE* file, NI64 len);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllBuffer__systemZio_330)(FILE* file);
...
N_LIB_PRIVATE NIM_CONST tyArray__Djap3EijveoDksCG9bY8s5w FormatOpen__systemZio_373 = {"rb",
"wb",
"w+b",
"r+b",
"ab"}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__systemZio_391)(FILE** f, NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	void* p;
{	result = (NIM_BOOL)0;
	p = fopen(nimToCStringConv(filename), FormatOpen__systemZio_373[(mode)- 0]);
	{
		FILE* f2;
		struct stat res;
		...
		f2 = ((FILE*) (p));
		{
			...
			T7_ = (NIM_BOOL)0;
			T8_ = (int)0;
			T8_ = getFileHandle__systemZio_229(f2);
			T9_ = (int)0;
			T9_ = fstat(T8_, (&res));
			T7_ = (((NI32) 0) <= T9_);
			if (!(T7_)) goto LA10_;
		...
		LA11_: ;
		{
			...
			NIM_BOOL T16_;
			T15_ = (int)0;
			T15_ = getOsFileHandle__systemZio_232(f2);
			T16_ = (NIM_BOOL)0;
			T16_ = setInheritable__systemZio_235(T15_, NIM_FALSE);
			if (!!(T16_)) goto LA17_;
			close__systemZio_218(f2);
			result = NIM_FALSE;
			goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(FILE*, open__systemZio_432)(NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	result = (FILE*)0;
	{
		...
		NimStringDesc* T7_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__systemZio_391(&result, filename, mode, bufSize);
		if (!!(T3_)) goto LA4_;
		T6_ = NIM_NIL;
				...
				while (1) {
					{
						...
						T10_ = (NIM_BOOL)0;
						T10_ = eqeq___system_7734(T9_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T10_);
						{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile__systemZio_343)(FILE* file, NI64 len) {
	...
	bytes = readBuffer__systemZio_144(file, ((void*) ((&result->data[((NI) 0)]))), ((NI) (len)));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = endOfFile__systemZio_339(file);
		if (!T3_) goto LA4_;
		{
	...
	LA4_: ;
	{
		NimStringDesc* T11_;
		T11_ = NIM_NIL;
		T11_ = readAllBuffer__systemZio_330(file);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAll__systemZio_352)(FILE* file) {
	...
	result = NIM_NIL;
	{
		...
		len = rawFileSize__systemZio_335(file);
	}
	goto LA1_;
	LA3_: ;
	{
	...
	LA1_: ;
	{
		...
		result = readAllFile__systemZio_343(file, len);
	}
	goto LA6_;
	LA8_: ;
	{
		result = readAllBuffer__systemZio_330(file);
	}
	LA6_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile__systemZio_471)(NimStringDesc* filename) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		result = readAll__systemZio_352(f);
		popSafePoint();
		}
		else {
			popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readLine__systemZio_273)(FILE* f) {
	...
	result = rawNewString(((NI) 80));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = readLine__systemZio_240(f, (&result));
		if (!!(T3_)) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, readLines__systemZio_494)(NimStringDesc* filename, NI n) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		result = newSeq__systemZio_503(n);
		{
			NI i;
			NI colontmp_;
			NI res;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = readLine__systemZio_240(f, (&result->data[i]));
						if (!!(T11_)) goto LA12_;
						raiseEOF__systemZio_117();
					}
					LA12_: ;
...
{	result = (NIM_BOOL)0;
	oshandle = filehandle;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = setInheritable__systemZio_235(oshandle, NIM_FALSE);
		if (!!(T3_)) goto LA4_;
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
	(*f) = fdopen(filehandle, FormatOpen__systemZio_373[(mode)- 0]);
...
N_LIB_PRIVATE N_NIMCALL(void, write__systemZio_306)(FILE* f, NimStringDesc** a, NI aLen_0) {
	{
		NimStringDesc** x;
		NI i;
		x = (NimStringDesc**)0;
