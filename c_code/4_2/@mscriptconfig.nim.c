...
static N_INLINE(NimStringDesc*, getCurrentExceptionMsg__system_6992)(void);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__pureZos_1455)(NimStringDesc* source, NimStringDesc* dest);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, paramStr__pureZos_1540)(NI i);
...
N_LIB_PRIVATE N_NIMCALL(NI, paramCount__pureZos_1546)(void);
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_59)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	popSafePoint();
		...
		if (isObj(nimBorrowCurrentException()->Sup.m_type, (&NTIoserror__BeJgrOdDsczOwEWOZbRfKA_))) {
			...
			asgnRef((void**) (&(*colonenvP_).errorMsg1), getCurrentExceptionMsg__system_6992());
			popCurrentException();
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_145)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	...
	T2_ = NIM_NIL;
	T2_ = paramStr__pureZos_1540(((NI) (T1_)));
	setResult__vm_243(a, T2_);
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_147)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	NI T1_;
	T1_ = (NI)0;
	T1_ = paramCount__pureZos_1546();
