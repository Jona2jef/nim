...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getModuleName__modulepaths_10)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
STRING_LITERAL(TM__GM5IT6miOywfWPAzqo7pmA_5, "/home/runner/work/nightlies/nightlies/nim/compiler/modulepaths.nim", 66);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getModuleName__modulepaths_10)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 22):
	{
		...
		T2_ = NIM_NIL;
		T2_ = toFullPath__msgs_538(conf, (*n).info.fileIndex);
		nimZeroMem((void*)(&T3_), sizeof(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg));
		nossplitFile(T2_, (&T3_));
		result = pathSubs__options_4196(conf, (*n)._kind_3.strVal, T3_.Field0);
		popSafePoint();
		}
		else {
			popSafePoint();
...
appendString(T6_, (*n)._kind_3.strVal);
				liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T6_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__GM5IT6miOywfWPAzqo7pmA_4, NIM_FALSE);
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 29):
	{
		...
		modname = getModuleName__modulepaths_10(conf, (*n)._kind_6.sons->data[((NI) 2)]);
		result = getModuleName__modulepaths_10(conf, n1);
		T10_ = NIM_NIL;
		T10_ = renderTree__renderer_46(n0, 4);
		T11_ = NIM_NIL;
...
appendString(result, modname);
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 30):
	{
		NimStringDesc* T13_;
		T13_ = NIM_NIL;
		T13_ = renderTree__renderer_46(n, 4);
	...
	{
		NimStringDesc* T15_;
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 20), ((NimStringDesc*) &TM__GM5IT6miOywfWPAzqo7pmA_7), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__GM5IT6miOywfWPAzqo7pmA_8, NIM_FALSE);
		T15_ = NIM_NIL;
		T15_ = renderTree__renderer_46(n, 4);
	...
	{
		result = getModuleName__modulepaths_10(conf, (*n)._kind_6.sons->data[((NI) 0)]);
	}
	break;
	default:
	{
		...
		NimStringDesc* T19_;
		T18_ = NIM_NIL;
		T18_ = renderTree__renderer_46(n, 0);
		T19_ = NIM_NIL;
		T19_ = nsuFormatSingleElem(((NimStringDesc*) &TM__GM5IT6miOywfWPAzqo7pmA_11), T18_);
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T19_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__GM5IT6miOywfWPAzqo7pmA_12, NIM_FALSE);
...
N_LIB_PRIVATE N_NIMCALL(NI32, checkModuleName__modulepaths_21)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NIM_BOOL doLocalError) {
	...
	T1_ = NIM_NIL;
	T1_ = toFullPath__msgs_538(conf, (*n).info.fileIndex);
	fullPath = findModule__options_4501(conf, modulename, T1_);
	{
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = isEmpty__options_4486(fullPath);
		if (!T4_) goto LA5_;
		{
			NimStringDesc* m;
			NimStringDesc* T16_;
...
appendString(T16_, m);
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T16_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__GM5IT6miOywfWPAzqo7pmA_14, NIM_FALSE);
		}
		LA9_: ;
		result = ((NI32) -1);
	}
