...
static N_INLINE(NIM_BOOL, mustRehash__importer_2483)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__importer_2669)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__importer_2996)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w* t, tySequence__E8pi9b5QNahsURYzXMjh3qw** data, NI key, NI val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__importer_3177)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w t, NI key, NI hc);
...
N_LIB_PRIVATE N_NIMCALL(void, impMod__importer_3844)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* it, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* importStmtResult);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, myImportModule__importer_3555)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw** n, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* importStmtResult);
static N_INLINE(void, nimZeroMem)(void* p, NI size);
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size);
N_LIB_PRIVATE N_NIMCALL(void, transformImportAs__importer_3437)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyTuple__aTNxDjHI7v9cq37xS7PT7jA* Result);
...
N_LIB_PRIVATE N_CLOSURE(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processPragma__importer_3444)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n2, void* ClE_0);
N_LIB_PRIVATE N_NIMCALL(void, splitPragmas__importer_1365)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyTuple__gl9aBynoPugGpNG5ucPu9cFw* Result);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___importer_3468)(tySet_tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw x);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, collectionToString__importer_3472)(tySet_tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw x, NimStringDesc* prefix, NimStringDesc* separator, NimStringDesc* suffix);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_LIB_PRIVATE N_NIMCALL(void, addQuoted__importer_3504)(NimStringDesc** s, tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw x);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, reprEnum)(NI e, TNimType* typ);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_LIB_PRIVATE N_NIMCALL(NI32, checkModuleName__modulepaths_21)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NIM_BOOL doLocalError);
N_LIB_PRIVATE N_NIMCALL(void, addImportFileDep__semdata_611)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, NI32 f);
static N_INLINE(NI, find__importer_3566)(tySequence__48JTohSgTy339bRxHzUD8KA* a, NI32 item);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, importModuleAs__importer_2193)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* realModule, NIM_BOOL importHidden);
...
static N_INLINE(void, suggestSym__sigmatch_5375)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ** usageSym, NIM_BOOL isDecl);
...
static N_INLINE(void, addDecl__lookups_841)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* sym, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbols__importer_2078)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod);
N_LIB_PRIVATE N_NIMCALL(void, addImport__importer_1458)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_ImportedModule__kyodd8HBOgfP30dipCL3JQ* im);
...
N_LIB_PRIVATE N_NIMCALL(void, importPureEnumFields__importer_77)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TType__facALICuu8zUj0hjvbTLFg* etyp);
...
N_LIB_PRIVATE N_NIMCALL(void, importPureEnumField__importer_69)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s);
N_LIB_PRIVATE N_NIMCALL(void, afterImport__importer_3615)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m);
N_LIB_PRIVATE N_NIMCALL(NI*, X5BX5D___importer_3714)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w* t, NI key);
...
N_LIB_PRIVATE N_NIMCALL(void, incl__importer_240)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w* s, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ key);
...
static N_INLINE(NIM_BOOL, mustRehash__importer_333)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__importer_525)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w* s);
static N_INLINE(NI, rawGetKnownHC__importer_776)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w t, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ key, NI hc);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__importer_1142)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w* s, tySequence__Bis5AbpONWcIRrPyPJS8Yw** data, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ key, NI hc, NI h);
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbolsExcept__importer_1825)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* exceptSet);
N_LIB_PRIVATE N_NIMCALL(void, readExceptSet__importer_17)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* Result);
N_LIB_PRIVATE N_NIMCALL(void, importSymbol__importer_1422)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* importSet);
...
N_LIB_PRIVATE N_NIMCALL(void, rawImportSymbol__importer_119)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* origin, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* importSet);
static N_INLINE(NIM_BOOL, hasPattern__ast_4733)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s);
...
STRING_LITERAL(TM__NsDkQfDe2CjzDqtBRW9bqQg_7, "/home/runner/work/nightlies/nightlies/nim/compiler/importer.nim", 63);
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				eh = n->data[i].Field0;
				{
					...
					n->data[i].Field2 = 0;
					rawInsert__importer_2996(t, (&(*t).data), T17_, T18_, eh, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___importer_2284)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w* t, NI key, NI val) {
	...
	NI index;
	{
		...
		T3_ = ((*t).data ? (*t).data->Sup.len : 0);
		if (!(T3_ == ((NI) 0))) goto LA4_;
		correctSizeX60gensym106_ = slotsNeeded__pureZcollectionsZtables_42(((NI) 32));
		(*t).counter = ((NI) 0);
		unsureAsgnRef((void**) (&(*t).data), (tySequence__E8pi9b5QNahsURYzXMjh3qw*) newSeq((&NTIkeyvaluepairseq__E8pi9b5QNahsURYzXMjh3qw_), ((NI) (correctSizeX60gensym106_))));
	}
	LA4_: ;
	hc = (NI)0;
	index = rawGet__sigmatch_5618((*t), key, (&hc));
	{
	...
	{
		{
			...
			correctSizeX60gensym109_ = slotsNeeded__pureZcollectionsZtables_42(((NI) 32));
			(*t).counter = ((NI) 0);
			unsureAsgnRef((void**) (&(*t).data), (tySequence__E8pi9b5QNahsURYzXMjh3qw*) newSeq((&NTIkeyvaluepairseq__E8pi9b5QNahsURYzXMjh3qw_), ((NI) (correctSizeX60gensym109_))));
		}
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__importer_2483((*t));
			if (!T18_) goto LA19_;
			enlarge__importer_2669(t);
			index = rawGetKnownHC__importer_3177((*t), key, hc);
		}
		LA19_: ;
		index = (NI)(((NI) -1) - index);
		rawInsert__importer_2996(t, (&(*t).data), key, val, hc, index);
		(*t).counter += ((NI) 1);
	}
	LA6_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, declarePureEnumField__importer_61)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s) {
	NIM_BOOL amb;
	amb = NIM_FALSE;
	{
		tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* T3_;
		T3_ = NIM_NIL;
		T3_ = someSymFromImportTable__lookups_381(c, (*s).name, (&amb));
		if (!(T3_ == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL))) goto LA4_;
		strTableAdd__astalgo_3332((&(*c).pureEnumFields), s);
	}
	LA4_: ;
}
static N_INLINE(NI, len__ast_3198)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
...
N_LIB_PRIVATE N_NIMCALL(void, splitPragmas__importer_1365)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyTuple__gl9aBynoPugGpNG5ucPu9cFw* Result) {
	...
	unsureAsgnRef((void**)&(*Result).Field1, NIM_NIL);
	{
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							ni = (*colontmp_)._kind_6.sons->data[i];
							{
								...
								T20_ = whichKeyword__idents_214((*ni)._kind_5.ident);
							...
							LA18_: ;
							{
								liMessage__msgs_1117((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__NsDkQfDe2CjzDqtBRW9bqQg_6, NIM_FALSE);
							}
							LA16_: ;
							i_2 += ((NI) 1);
						} LA15: ;
		...
		LA10_: ;
		{
			liMessage__msgs_1117((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__NsDkQfDe2CjzDqtBRW9bqQg_8, NIM_FALSE);
		}
		LA5_: ;
	}
	goto LA1_;
	LA3_: ;
	{
		unsureAsgnRef((void**) (&(*Result).Field0), n);
		{
			...
			NI T31_;
			T27_ = (NI)0;
			T27_ = safeLen__ast_3191((*Result).Field0);
			if (!(((NI) 0) < T27_)) goto LA28_;
			nimZeroMem((void*)(&_), sizeof(tyTuple__gl9aBynoPugGpNG5ucPu9cFw));
			T30_ = (NI)0;
			T30_ = len__ast_3198((*Result).Field0);
			splitPragmas__importer_1365(c, (*(*Result).Field0)._kind_6.sons->data[(NI)(T30_ - ((NI) 1))], (&_));
			T31_ = (NI)0;
			T31_ = len__ast_3198((*Result).Field0);
...
appendString(result, separator);
					...
					LA8_: ;
					addQuoted__importer_3504((&result), value);
				}
				LA6_: ;
				i += ((NI) 1);
			} LA3: ;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___importer_3468)(tySet_tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw x) {
	NimStringDesc* result;
	result = NIM_NIL;
	result = collectionToString__importer_3472(x, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_10), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_11), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_12));
	return result;
}
N_LIB_PRIVATE N_CLOSURE(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processPragma__importer_3444)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n2, void* ClE_0) {
	...
	splitPragmas__importer_1365((*colonenvP_).c1, n2, (&T1_));
	result2 = NIM_NIL;
	result2 = T1_.Field0;
	kws = NIM_NIL;
	kws = T1_.Field1;
	result = result2;
	{
		...
		L = T3_;
		{
			while (1) {
				...
				ai = (&kws->data[i]);
				switch ((*ai)) {
				case ((tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw) 293):
				{
				...
				default:
				{
					...
					T8_ = NIM_NIL;
					T9_ = NIM_NIL;
					T9_ = dollar___importer_3468(TM__NsDkQfDe2CjzDqtBRW9bqQg_13);
					T8_ = rawNewString((T9_ ? T9_->Sup.len : 0) + 26);
appendString(T8_, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_9));
appendString(T8_, T9_);
					liMessage__msgs_1117((*(*(*colonenvP_).c1).graph).config, (*(*colonenvP_).n3).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T8_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__NsDkQfDe2CjzDqtBRW9bqQg_14, NIM_FALSE);
				}
				break;
				}
				i += ((NI) 1);
...
{	colonenv_ = NIM_NIL;
	...
	nimZeroMem((void*)(&(*colonenv_).ret2), sizeof(tyTuple__aTNxDjHI7v9cq37xS7PT7jA));
	{
		...
		if (!(T3_)) goto LA4_;
		T5_ = NIM_NIL;
		T5_ = considerQuotedIdent__lookups_28((*colonenv_).c1, (*(*colonenv_).n3)._kind_6.sons->data[((NI) 0)], ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL));
		T3_ = eqStrings((*T5_).s, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_2));
		LA4_: ;
		if (!T3_) goto LA6_;
		asgnRef((void**) (&(*colonenv_).ret2.Field0), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 78), (*(*colonenv_).n3).info));
		nimZeroMem((void*)(&T8_), sizeof(tyProc__BbZ5yrR1DkdL0SAcvr6ToA));
		T8_.ClP_0 = processPragma__importer_3444; T8_.ClE_0 = colonenv_;
		T9_ = NIM_NIL;
		...
		add__ast_4797((*colonenv_).ret2.Field0, T9_);
		add__ast_4797((*colonenv_).ret2.Field0, (*(*colonenv_).n3)._kind_6.sons->data[((NI) 2)]);
	}
	goto LA1_;
	LA6_: ;
	{
		...
		T11_.ClP_0 = processPragma__importer_3444; T11_.ClE_0 = colonenv_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, importModuleAs__importer_2193)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* realModule, NIM_BOOL importHidden) {
	...
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym104_;
	result = NIM_NIL;
	result = realModule;
	{
	...
	LA3_: ;
	{
		...
		LA8_: ;
		if (!T6_) goto LA9_;
		liMessage__msgs_1117((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_19), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NsDkQfDe2CjzDqtBRW9bqQg_20, NIM_FALSE);
	}
	goto LA1_;
	LA9_: ;
	{
		...
		T14_ = nextSymId__ast_3132((*c).Sup.idgen);
		result = createModuleAlias__ast_4081(realModule, T14_, (*(*n)._kind_6.sons->data[((NI) 1)])._kind_5.ident, (*n).info, (*(*(*c).graph).config).options);
	}
	goto LA1_;
	LA12_: ;
	LA1_: ;
	{
		...
		result = createModuleAlias__ast_4081(realModule, T19_, (*realModule).name, (*n).info, (*(*(*c).graph).config).options);
	}
	LA17_: ;
	{
	...
	xX60gensym103_ = result;
	xX60gensym104_ = realModule;
	X5BX5Deq___importer_2284((&(*c).importModuleMap), (NI)((NI)((NU64)(((NI) ((*xX60gensym103_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym103_).Sup.itemId.item))), (NI)((NI)((NU64)(((NI) ((*xX60gensym104_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym104_).Sup.itemId.item))));
	return result;
}
static N_INLINE(void, suggestSym__sigmatch_5375)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ** usageSym, NIM_BOOL isDecl) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, myImportModule__importer_3555)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw** n, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* importStmtResult) {
	...
	transformImportAs__importer_3437(c, (*n), (&transf));
	unsureAsgnRef((void**) (&(*n)), transf.Field0);
	f = checkModuleName__modulepaths_21((*(*c).graph).config, (*n), NIM_TRUE);
	{
		NI L;
		NI T5_;
		NI recursion;
		...
		addImportFileDep__semdata_611(c, f);
		T5_ = ((*(*c).graph).importStack ? (*(*c).graph).importStack->Sup.len : 0);
		L = T5_;
		recursion = find__importer_3566((*(*c).graph).importStack, f);
...
appendString(err, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_17));
						...
						T18_ = NIM_NIL;
						T19_ = NIM_NIL;
						T19_ = toFullPath__msgs_538((*(*c).graph).config, (*(*c).graph).importStack->data[i]);
						T20_ = NIM_NIL;
						T20_ = toFullPath__msgs_538((*(*c).graph).config, (*(*c).graph).importStack->data[(NI)(i + ((NI) 1))]);
...
appendString(err, T18_);
		...
		realModule = NIM_NIL;
		T22_ = NIM_NIL;
		T22_ = pushOptionEntry__semdata_462(c);
		(void)(T22_);
		realModule = (*(*c).graph).importModuleCallback((*c).graph, (*c).module, f);
		result = importModuleAs__importer_2193(c, (*n), realModule, transf.Field1);
		...
		asgnRef((void**) (&(*(*c).graph).importStack), (tySequence__48JTohSgTy339bRxHzUD8KA*) setLengthSeqV2(&((*(*c).graph).importStack)->Sup, (&NTIseqLint5150T__48JTohSgTy339bRxHzUD8KA_), ((NI) (L))));
		{
			...
			liMessage__msgs_1117((*(*c).graph).config, (*(*n)).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T27_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NsDkQfDe2CjzDqtBRW9bqQg_22, NIM_FALSE);
		}
		LA25_: ;
		{
...
appendString(T37_, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_24));
			liMessage__msgs_1117((*(*c).graph).config, (*(*n)).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 20), T37_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NsDkQfDe2CjzDqtBRW9bqQg_25, NIM_FALSE);
		}
		LA30_: ;
		suggestSym__sigmatch_5375((*c).graph, (*(*n)).info, result, &(*(*c).graph).usageSym, NIM_FALSE);
		T38_ = NIM_NIL;
		T38_ = newSymNode__ast_3719(result, (*(*n)).info);
		add__ast_4797(importStmtResult, T38_);
	}
	LA3_: ;
	return result;
}
static N_INLINE(void, addDecl__lookups_841)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* sym, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	addDeclAt__lookups_815(c, (*c).currentScope, sym, info);
}
N_LIB_PRIVATE N_NIMCALL(void, incl__importer_1492)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* other) {
	{
		NI item;
			...
			while (1) {
				...
				i = res;
				{
					...
					case ((tyEnum_ImportMode__OHfXXgrGOSWpZv16VYg4yQ) 1):
					{
						...
						case ((tyEnum_ImportMode__OHfXXgrGOSWpZv16VYg4yQ) 1):
						{
							incl__importer_1492((&(*c).imports->data[i]._mode_2.imported), (&(*im)._mode_2.imported));
						}
						break;
						}
					}
					...
					case ((tyEnum_ImportMode__OHfXXgrGOSWpZv16VYg4yQ) 2):
					{
						...
						case ((tyEnum_ImportMode__OHfXXgrGOSWpZv16VYg4yQ) 2):
						{
							...
							initIntSet__pureZcollectionsZintsets_238((&cut));
							{
								NI j;
										...
										i_3 = ((NI) 0);
										{
											while (1) {
												...
												j = colontmp__2.a[(i_2)- 0];
												{
													NIM_BOOL T27_;
													T27_ = (NIM_BOOL)0;
													T27_ = contains__astalgo_3496((&(*c).imports->data[i]._mode_3.exceptSet), j);
													if (!T27_) goto LA28_;
													incl__pureZcollectionsZintsets_55((&cut), j);
												}
												LA28_: ;
												i_3 += ((NI) 1);
											} LA24: ;
													...
													j_2 = ((NI) 0);
													{
														while (1) {
															if (!!((w == ((NU) 0)))) goto LA36;
															{
																...
																T41_ = (NI)0;
																T41_ = pluspercent___system_696((NI)((NU64)(i_4) << (NU64)(((NI) 6))), j_2);
																j = (NI)((NI)((NU64)((*r).key) << (NU64)(((NI) 9))) | T41_);
																{
																	NIM_BOOL T44_;
																	T44_ = (NIM_BOOL)0;
																	T44_ = contains__astalgo_3496((&(*c).imports->data[i]._mode_3.exceptSet), j);
																	if (!T44_) goto LA45_;
																	incl__pureZcollectionsZintsets_55((&cut), j);
																}
																LA45_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, importPureEnumFields__importer_77)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TType__facALICuu8zUj0hjvbTLFg* etyp) {
	{
		...
		j = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = len__ast_3198((*etyp).n);
		i = ((NI) 0);
		{
			while (1) {
				...
				e = (*(*(*etyp).n)._kind_6.sons->data[j])._kind_4.sym;
				{
					...
					internalErrorImpl__msgs_1430((*(*c).graph).config, (*s).info, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_26), TM__NsDkQfDe2CjzDqtBRW9bqQg_27);
				}
				LA6_: ;
				{
						...
						L = T10_;
						{
							while (1) {
								...
								im = (&(*c).imports->data[i_2]);
								{
									...
									candidate = initIdentIter__lookups_151((&ti), (&marked), (&(*im)), (*e).name, (*c).graph);
									{
										while (1) {
				...
				} LA8: ;
				{
					...
					importPureEnumField__importer_69(c, e);
				}
				LA22_: ;
				i += ((NI) 1);
			} LA3: ;
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbols__importer_2078)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod) {
	...
	addImport__importer_1458(c, (&T1_));
	{
		...
		L = T3_;
		{
			while (1) {
				...
				it = (&(*(*c).graph).ifaces->data[(*fromMod).position].converters->data[i]);
				{
					...
					loadPackedSym__modulegraphs_8940((*c).graph, it);
					{
						if (!(((*(*it).sym).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 1))&63U)))!=0)) goto LA12_;
						addConverter__semdata_653(c, (*it));
					}
					LA12_: ;
				}
				LA8_: ;
	...
	}
	{
		...
		i_2 = ((NI) 0);
		T15_ = ((*(*c).graph).ifaces->data[(*fromMod).position].patterns ? (*(*c).graph).ifaces->data[(*fromMod).position].patterns->Sup.len : 0);
		L_2 = T15_;
		{
			while (1) {
				...
				it_2 = (&(*(*c).graph).ifaces->data[(*fromMod).position].patterns->data[i_2]);
				{
					...
					loadPackedSym__modulegraphs_8940((*c).graph, it_2);
					{
						if (!(((*(*it_2).sym).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 1))&63U)))!=0)) goto LA24_;
						addPattern__semdata_692(c, (*it_2));
					}
					LA24_: ;
				}
				LA20_: ;
	...
	}
	{
		...
		i_3 = ((NI) 0);
		T27_ = ((*(*c).graph).ifaces->data[(*fromMod).position].pureEnums ? (*(*c).graph).ifaces->data[(*fromMod).position].pureEnums->Sup.len : 0);
		L_3 = T27_;
		{
			while (1) {
				...
				it_3 = (&(*(*c).graph).ifaces->data[(*fromMod).position].pureEnums->data[i_3]);
				{
					...
					loadPackedSym__modulegraphs_8940((*c).graph, it_3);
					importPureEnumFields__importer_77(c, (*it_3).sym, (*(*it_3).sym).typ);
				}
				LA32_: ;
				i_3 += ((NI) 1);
			} LA29: ;
...
N_LIB_PRIVATE N_NIMCALL(NI*, X5BX5D___importer_3714)(tyObject_Table__Ea0e9azliYta9cYyn0d49ah0w* t, NI key) {
	...
	result = (NI*)0;
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__sigmatch_5618((*t), key, (&hcX60gensym22_));
	{
	...
	h = (NI)(hc & T6_);
	{
		while (1) {
			...
			if (!T9_) goto LA8;
			{
				...
				T12_ = (t.data->data[h].Field0 == hc);
				if (!(T12_)) goto LA13_;
				T12_ = eqeq___sigmatch_6286(t.data->data[h].Field1, key);
				LA13_: ;
				if (!T12_) goto LA14_;
				result = h;
				goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__importer_1142)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w* s, tySequence__Bis5AbpONWcIRrPyPJS8Yw** data, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ key, NI hc, NI h) {
	{
		...
		if (!(T3_ == ((NI) 0))) goto LA4_;
		correctSizeX60gensym36_ = slotsNeeded__pureZcollectionsZsets_49(((NI) 64));
		(*s).counter = ((NI) 0);
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					...
					if (!T9_) goto LA10_;
					T12_ = (NI)0;
					T12_ = rawGetKnownHC__importer_776((*s), n->data[i].Field1, n->data[i].Field0);
					j = (NI)(((NI) -1) - T12_);
					rawInsert__importer_1142(s, (&(*s).data), n->data[i].Field1, n->data[i].Field0, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, incl__importer_240)(tyObject_HashSet__Gy4haGrophX9bC5RxnPAc6w* s, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ key) {
	...
	NI index;
	{
		...
		if (!(T3_ == ((NI) 0))) goto LA4_;
		correctSizeX60gensym29_ = slotsNeeded__pureZcollectionsZsets_49(((NI) 64));
		(*s).counter = ((NI) 0);
	...
	index = rawGet__sigmatch_6031((*s), key, (&hc));
	{
		if (!(index < ((NI) 0))) goto LA8_;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = mustRehash__importer_333((*s));
			if (!T12_) goto LA13_;
			enlarge__importer_525(s);
			index = rawGetKnownHC__importer_776((*s), key, hc);
		}
		LA13_: ;
		rawInsert__importer_1142(s, (&(*s).data), key, hc, (NI)(((NI) -1) - index));
		(*s).counter += ((NI) 1);
	}
	LA8_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, afterImport__importer_3615)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m) {
	...
	xX60gensym139_ = m;
	T1_ = (NI*)0;
	T1_ = X5BX5D___importer_3714((&(*c).importModuleMap), (NI)((NI)((NU64)(((NI) ((*xX60gensym139_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym139_).Sup.itemId.item))));
	realModuleId = (*T1_);
	{
		...
		importHidden = (((*m).options &((NU32)1<<((NU)(((tyEnum_TOption__WspMeQySXNP2XoTWR5MTgg) 27))&31U)))!=0);
		{
			...
			T5_ = (NIM_BOOL)0;
			T5_ = isCachedModule__modulegraphs_2709((*c).graph, m);
			if (!T5_) goto LA6_;
			nimZeroMem((void*)(&rodIt), sizeof(tyObject_RodIter__Y6aA9bUtpfLvVVtyih9aAbQg));
			r = initRodIterAllSyms__icZic_8667((&rodIt), (*(*c).graph).config, (*(*c).graph).cache, (&(*(*c).graph).packed_0), ((NI32) ((*m).position)), importHidden);
			{
				while (1) {
					...
					s = r;
					{
						...
						tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym142_;
						tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym143_;
						xX60gensym141_ = (*s).owner;
						if (!!(((NI)((NI)((NU64)(((NI) ((*xX60gensym141_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym141_).Sup.itemId.item))) == realModuleId))) goto LA12_;
						xX60gensym142_ = m;
						T14_.Field0 = (NI)((NI)((NU64)(((NI) ((*xX60gensym142_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym142_).Sup.itemId.item)));
						xX60gensym143_ = s;
						T14_.Field1 = (NI)((NI)((NU64)(((NI) ((*xX60gensym143_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym143_).Sup.itemId.item)));
						incl__importer_240((&(*c).exportIndirections), T14_);
					}
					LA12_: ;
				...
				L = T21_;
				{
					while (1) {
						...
						s_2 = &colontmp_->data[i];
						{
							...
							s = (*s_2);
							{
								tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym141__2;
								tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ T32_;
								tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym142__2;
								tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym143__2;
								xX60gensym141__2 = (*s).owner;
								if (!!(((NI)((NI)((NU64)(((NI) ((*xX60gensym141__2).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym141__2).Sup.itemId.item))) == realModuleId))) goto LA30_;
								xX60gensym142__2 = m;
								T32_.Field0 = (NI)((NI)((NU64)(((NI) ((*xX60gensym142__2).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym142__2).Sup.itemId.item)));
								xX60gensym143__2 = s;
								T32_.Field1 = (NI)((NI)((NU64)(((NI) ((*xX60gensym143__2).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym143__2).Sup.itemId.item)));
								incl__importer_240((&(*c).exportIndirections), T32_);
							}
							LA30_: ;
						}
						LA26_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, impMod__importer_3844)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* it, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* importStmtResult) {
	...
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m;
	it_2 = it;
	m = myImportModule__importer_3555(c, &it_2, importStmtResult);
	{
		if (!!((m == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA3_;
		addDecl__lookups_841(c, m, (*it_2).info);
		importAllSymbols__importer_2078(c, m);
		afterImport__importer_3615(c, m);
	}
	LA3_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalImport__importer_3854)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	result = NIM_NIL;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 116), (*n).info);
	{
		NI i;
		NI colontmp_;
		NI i_2;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				it = (*n)._kind_6.sons->data[i];
				{
					...
					imp = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 29), (*it).info);
					add__ast_4797(imp, sep);
					add__ast_4797(imp, dir);
					add__ast_4797(imp, sep);
					{
						...
						colontmp__2 = (*it)._kind_6.sons->data[((NI) 2)];
						{
							...
							i_3 = (NI)0;
							colontmp__3 = (NI)0;
							colontmp__3 = safeLen__ast_3191(colontmp__2);
							i_4 = ((NI) 0);
							{
								while (1) {
				...
				LA11_: ;
				{
					impMod__importer_3844(c, it, result);
				}
				LA4_: ;
				i_2 += ((NI) 1);
			} LA3: ;
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbolsExcept__importer_1825)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* exceptSet) {
		...
		L = T3_;
		{
			while (1) {
				...
				it = (&(*(*c).graph).ifaces->data[(*fromMod).position].converters->data[i]);
				{
					...
					T8_ = (NIM_BOOL)0;
					T8_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU64)(((NI) ((*xX60gensym72_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym72_).Sup.itemId.item))));
					if (!!(T8_)) goto LA9_;
					loadPackedSym__modulegraphs_8940((*c).graph, it);
					{
						if (!(((*(*it).sym).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 1))&63U)))!=0)) goto LA13_;
						addConverter__semdata_653(c, (*it));
					}
					LA13_: ;
				}
	...
	}
	{
		...
		it_2 = (tyObject_LazySym__rhF4Xi6CELPmWy539c1l6fA*)0;
		i_2 = ((NI) 0);
		T16_ = ((*(*c).graph).ifaces->data[(*fromMod).position].patterns ? (*(*c).graph).ifaces->data[(*fromMod).position].patterns->Sup.len : 0);
		L_2 = T16_;
		{
			while (1) {
				...
				it_2 = (&(*(*c).graph).ifaces->data[(*fromMod).position].patterns->data[i_2]);
				{
					tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym75_;
					NIM_BOOL T21_;
					xX60gensym75_ = (*it_2).sym;
					T21_ = (NIM_BOOL)0;
					T21_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU64)(((NI) ((*xX60gensym75_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym75_).Sup.itemId.item))));
					if (!!(T21_)) goto LA22_;
					loadPackedSym__modulegraphs_8940((*c).graph, it_2);
					{
						if (!(((*(*it_2).sym).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 1))&63U)))!=0)) goto LA26_;
						addPattern__semdata_692(c, (*it_2));
					}
					LA26_: ;
				}
	...
	}
	{
		...
		it_3 = (tyObject_LazySym__rhF4Xi6CELPmWy539c1l6fA*)0;
		i_3 = ((NI) 0);
		T29_ = ((*(*c).graph).ifaces->data[(*fromMod).position].pureEnums ? (*(*c).graph).ifaces->data[(*fromMod).position].pureEnums->Sup.len : 0);
		L_3 = T29_;
		{
			while (1) {
				...
				it_3 = (&(*(*c).graph).ifaces->data[(*fromMod).position].pureEnums->data[i_3]);
				{
					tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* xX60gensym78_;
					NIM_BOOL T34_;
					xX60gensym78_ = (*it_3).sym;
					T34_ = (NIM_BOOL)0;
					T34_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU64)(((NI) ((*xX60gensym78_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym78_).Sup.itemId.item))));
					if (!!(T34_)) goto LA35_;
					loadPackedSym__modulegraphs_8940((*c).graph, it_3);
					importPureEnumFields__importer_77(c, (*it_3).sym, (*(*it_3).sym).typ);
				}
...
N_LIB_PRIVATE N_NIMCALL(void, readExceptSet__importer_17)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* Result) {
	initIntSet__pureZcollectionsZintsets_238(Result);
	{
		NI i;
		NI colontmp_;
		NI i_2;
		...
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				if (!(i_2 < colontmp_)) goto LA3;
				i = i_2;
				ident = considerQuotedIdent__lookups_28(c, (*n)._kind_6.sons->data[i], ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL));
				incl__pureZcollectionsZintsets_55(Result, (*ident).id);
				i_2 += ((NI) 1);
			} LA3: ;
		}
	}
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalImportExcept__importer_3935)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m;
	result = NIM_NIL;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 116), (*n).info);
	checkMinSonsLen__semdata_1084(n, ((NI) 2), (*(*c).graph).config);
	m = myImportModule__importer_3555(c, &(*n)._kind_6.sons->data[((NI) 0)], result);
	{
		tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA T5_;
		if (!!((m == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA3_;
		asgnRef((void**) (&(*n)._kind_6.sons->data[((NI) 0)]), newSymNode__ast_3716(m));
		addDecl__lookups_841(c, m, (*n).info);
		nimZeroMem((void*)(&T5_), sizeof(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA));
		readExceptSet__importer_17(c, n, (&T5_));
		importAllSymbolsExcept__importer_1825(c, m, (&T5_));
		afterImport__importer_3615(c, m);
	}
	LA3_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, rawImportSymbol__importer_119)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* origin, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* importSet) {
	...
	xX60gensym15_ = s;
	incl__pureZcollectionsZintsets_55(importSet, (NI)((NI)((NU64)(((NI) ((*xX60gensym15_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym15_).Sup.itemId.item))));
	{
				...
				i = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n)._kind_6.sons->data[j])._kind_4.sym;
						{
							...
							internalErrorImpl__msgs_1430((*(*c).graph).config, (*s).info, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_26), TM__NsDkQfDe2CjzDqtBRW9bqQg_32);
						}
						LA14_: ;
						{
							tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* check;
						...
						} LA16: ;
						{
							if (!!((e == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA30_;
							{
								...
								rawImportSymbol__importer_119(c, e, origin, importSet);
							}
							goto LA32_;
							LA34_: ;
							{
	...
	{
		{
			...
			nimZeroMem((void*)(&T42_), sizeof(tyObject_LazySym__rhF4Xi6CELPmWy539c1l6fA));
			T42_.sym = s;
			addConverter__semdata_653(c, T42_);
		}
		LA40_: ;
		{
			NIM_BOOL T45_;
	...
	LA1_: ;
	{
		...
		incl__importer_240((&(*c).exportIndirections), T53_);
	}
	LA51_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, importSymbol__importer_1422)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromMod, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* importSet) {
	...
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s;
	nimZeroMem((void*)(&T1_), sizeof(tyTuple__gl9aBynoPugGpNG5ucPu9cFw));
	splitPragmas__importer_1365(c, n, (&T1_));
	n_2 = NIM_NIL;
	n_2 = T1_.Field0;
	kws = NIM_NIL;
	kws = T1_.Field1;
	{
		...
		liMessage__msgs_1117((*(*c).graph).config, (*n_2).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_28), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__NsDkQfDe2CjzDqtBRW9bqQg_29, NIM_FALSE);
	}
	LA5_: ;
	ident = considerQuotedIdent__lookups_28(c, n_2, ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL));
	s = someSym__modulegraphs_2817((*c).graph, fromMod, ident);
	{
		if (!(s == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL))) goto LA9_;
		errorUndeclaredIdentifier__lookups_1199(c, (*n_2).info, (*ident).s, ((NimStringDesc*) NIM_NIL));
	}
	goto LA7_;
	LA9_: ;
	{
		...
		multiImport = T12_;
		{
			...
			e = initModuleIter__modulegraphs_2735((&it), (*c).graph, fromMod, (*s).name);
			{
				while (1) {
					if (!!((e == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA19;
					{
						if (!!(((*(*e).name).id == (*(*s).name).id))) goto LA22_;
						internalErrorImpl__msgs_1430((*(*c).graph).config, (*n_2).info, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_30), TM__NsDkQfDe2CjzDqtBRW9bqQg_31);
					}
					LA22_: ;
					{
						if (!((43513728 &((NU32)1<<((NU)((*s).kind)&31U)))!=0)) goto LA26_;
						rawImportSymbol__importer_119(c, e, fromMod, importSet);
					}
					LA26_: ;
					e = nextModuleIter__modulegraphs_2763((&it), (*c).graph);
				} LA19: ;
			}
		}
		goto LA14_;
		LA16_: ;
		{
			rawImportSymbol__importer_119(c, s, fromMod, importSet);
		}
		LA14_: ;
		suggestSym__sigmatch_5375((*c).graph, (*n_2).info, s, &(*(*c).graph).usageSym, NIM_FALSE);
	}
	LA7_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalFrom__importer_3909)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m;
	result = NIM_NIL;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 116), (*n).info);
	...
	m = myImportModule__importer_3555(c, &(*n)._kind_6.sons->data[((NI) 0)], result);
	{
		...
		initIntSet__pureZcollectionsZintsets_238((&im._mode_2.imported));
		{
			NI i;
			NI colontmp_;
			NI i_2;
			...
			i_2 = ((NI) 1);
			{
				while (1) {
					...
					i = i_2;
					{
						...
						importSymbol__importer_1422(c, (*n)._kind_6.sons->data[i], m, (&im._mode_2.imported));
					}
					LA10_: ;
					i_2 += ((NI) 1);
				} LA7: ;
