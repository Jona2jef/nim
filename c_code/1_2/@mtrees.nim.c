...
static N_INLINE(NIM_BOOL, sameFloatIgnoreNan__trees_52)(NF a, NF b);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, cyclicTreeAux__trees_4)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tySequence__ehmV9bTklH2Gt9cXHV9c0HLeQ** visited);
...
N_LIB_PRIVATE N_NIMCALL(void, unnestStmts__trees_339)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result);
...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		...
		{
			result = sameFloatIgnoreNan__trees_52((*a)._kind_2.floatVal, (*b)._kind_2.floatVal);
		}
		break;
		...
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 125):
		{
			...
			NimStringDesc* T24_;
			T23_ = NIM_NIL;
			T23_ = comment__ast_993(a);
			T24_ = NIM_NIL;
			T24_ = comment__ast_993(b);
		...
		{
			{
				...
				NI T30_;
				T29_ = (NI)0;
				T29_ = len__ast_3198(a);
				T30_ = (NI)0;
				T30_ = len__ast_3198(b);
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							i = i_2;
							{
								NIM_BOOL T38_;
								T38_ = (NIM_BOOL)0;
								T38_ = exprStructuralEquivalent__trees_56((*a)._kind_6.sons->data[i], (*b)._kind_6.sons->data[i], strictSymEquality);
								if (!!(T38_)) goto LA39_;
								goto BeforeRet_;
							}
							LA39_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw, whichPragma__trees_244)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 2):
	{
		result = whichKeyword__idents_214((*key)._kind_5.ident);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		result = whichKeyword__idents_214((*(*key)._kind_4.sym).name);
	}
	break;
	...
	{
		result = whichPragma__trees_244((*key)._kind_6.sons->data[((NI) 0)]);
	}
	break;
	default:
	{
			...
			while (1) {
				...
				it = (*n)._kind_6.sons->data[i];
				{
					...
					result = (*it)._kind_6.sons->data[((NI) 1)];
					{
						...
						result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 39), (*result).info);
						add__ast_4797(result, (*it)._kind_6.sons->data[((NI) 1)]);
					}
					LA13_: ;
					goto BeforeRet_;
				}
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = isCaseObj__trees_158((*n)._kind_6.sons->data[i]);
					if (!T10_) goto LA11_;
					result = NIM_TRUE;
					goto BeforeRet_;
				}
			...
			L_2 = T19_;
			{
				while (1) {
					...
					nSon = &colontmp_->data[i_2];
					{
						NIM_BOOL T24_;
						T24_ = (NIM_BOOL)0;
						T24_ = cyclicTreeAux__trees_4((*nSon), visited);
						if (!T24_) goto LA25_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
			...
			x = NIM_NIL;
			{
				...
				i_2 = ((NI) 0);
				{
					while (1) {
						...
						unnestStmts__trees_339(x, result);
						i_2 += ((NI) 1);
					} LA8: ;
				}
			}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, flattenStmts__trees_355)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	unnestStmts__trees_339(n, result);
	{
		NI T3_;
		T3_ = (NI)0;
		T3_ = len__ast_3198(result);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, extractRange__trees_362)(tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw k, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NI a, NI b) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	result = NIM_NIL;
	result = newNodeI__ast_3360(k, (*n).info, (NI)((NI)(b - a) + ((NI) 1)));
	{
		NI i;
		NI colontmp_;
		NI res;
...
{	result = (NIM_BOOL)0;
	...
	{
		result = isDeepConstExpr__trees_171((*n)._kind_6.sons->data[((NI) 1)], preventInheritance);
	}
	break;
			...
			i_2 = colontmp_;
			{
				while (1) {
					...
					i = i_2;
					{
						NIM_BOOL T9_;
						T9_ = (NIM_BOOL)0;
						T9_ = isDeepConstExpr__trees_171((*n)._kind_6.sons->data[i], preventInheritance);
						if (!!(T9_)) goto LA10_;
						result = NIM_FALSE;
						goto BeforeRet_;
					}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isNoSideEffectPragma__trees_257)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = (NIM_BOOL)0;
	k = whichPragma__trees_244(n);
	{
		if (!(k == ((tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw) 9))) goto LA3_;
		k = whichPragma__trees_244((*n)._kind_6.sons->data[((NI) 1)]);
	}
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getRoot__trees_390)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	{
		result = getRoot__trees_390((*n)._kind_6.sons->data[((NI) 0)]);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 58):
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 59):
	...
	{
		result = getRoot__trees_390((*n)._kind_6.sons->data[((NI) 1)]);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 26) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 32):
	{
				...
				i_2 = ((NI) 0);
				{
					while (1) {
						...
						son = (*n)._kind_6.sons->data[i];
						{
							...
							T11_ = whichPragma__trees_244(son);
