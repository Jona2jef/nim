...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains__vmprofiler_82)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vmprofiler_118)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vmprofiler_217)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___vmprofiler_270)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key, tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw val);
...
static N_INLINE(void, pluseq___pureZstrutils_2112)(NF* x, NF y);
N_LIB_PRIVATE N_NIMCALL(tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*, X5BX5D___vmprofiler_428)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
N_LIB_PRIVATE N_NIMCALL(tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*, X5BX5D___vmprofiler_540)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
N_LIB_PRIVATE N_NOINLINE(void, raiseKeyError__vmprofiler_607)(tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) __attribute__((noreturn));
...
N_LIB_PRIVATE N_NIMCALL(NI, len__vmprofiler_758)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t);
...
N_LIB_PRIVATE N_NIMCALL(void, del__vmprofiler_1033)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
N_LIB_PRIVATE N_NIMCALL(void, del__vmprofiler_1131)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vmprofiler_217)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	...
	hc = (NI)0;
	T1_ = (NI)0;
	T1_ = rawGet__options_860(t, key, (&hc));
	result = (((NI) 0) <= T1_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__vmprofiler_118)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = hasKey__vmprofiler_217((*t), key);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains__vmprofiler_82)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	NIM_BOOL result;
{	result = (NIM_BOOL)0;
	result = hasKey__vmprofiler_118(t, key);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___vmprofiler_270)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key, tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw val) {
	X5BX5Deq___options_788(t, key, val);
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
	T1_ = (void*)0;
...
N_LIB_PRIVATE N_NOINLINE(void, raiseKeyError__vmprofiler_607)(tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*, X5BX5D___vmprofiler_540)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	...
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__options_860((*t), key, (&hcX60gensym22_));
	{
	...
	LA3_: ;
	{
		raiseKeyError__vmprofiler_607(key);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*, X5BX5D___vmprofiler_428)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw* result;
	result = (tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*)0;
	result = X5BX5D___vmprofiler_540(t, key);
	return result;
}
N_LIB_PRIVATE N_NOINLINE(void, leaveImpl__vmprofiler_25)(tyObject_Profiler__X5SfC6PDEhDFna4qLF0vtg* prof, tyObject_TCtx__S3Av1Ng7MBWGEZZBhfDYCw* c) {
	...
	tyObject_TStackFrame__DYXeymOyKb0OnIuD1ihEpQ* tos;
	tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* data;
	tLeave = cpuTime__pureZtimes_3636();
	tos = (*prof).tos;
		...
		while (1) {
			if (!!((tos == ((tyObject_TStackFrame__DYXeymOyKb0OnIuD1ihEpQ*) NIM_NIL)))) goto LA2;
			{
				...
				li = (*(*tos).prc).info;
				{
					...
					T9_ = (NIM_BOOL)0;
					T9_ = contains__vmprofiler_82(data, li);
					if (!!(T9_)) goto LA10_;
					nimZeroMem((void*)(&T12_), sizeof(tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw));
					X5BX5Deq___vmprofiler_270(data, li, T12_);
				}
				LA10_: ;
				T13_ = (tyObject_ProfileInfo__le1imru0p6WwvUctTtOlIw*)0;
				T13_ = X5BX5D___vmprofiler_428(data, li);
				pluseq___pureZstrutils_2112((&(*T13_).time), ((NF)(tLeave) - (NF)((*prof).tEnter)));
				{
					...
					T18_ = X5BX5D___vmprofiler_428(data, li);
					(*T18_).count += ((NI) 1);
				}
				LA16_: ;
			}
...
N_LIB_PRIVATE N_NIMCALL(void, del__vmprofiler_1131)(tyObject_Table__l6AB9cIrSdEYtCGu5YO9b61Q* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q key) {
	...
	NI T1_;
	hc = (NI)0;
	i = rawGet__options_860((*t), key, (&hc));
	...
	echoBinSafe(TM__I0wckmaPYx4om2FQ6YfxMA_3, 1);
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
						...
						res = ((NI) 0);
						{
							while (1) {
								...
								h = res;
								{
									NIM_BOOL T11_;
									T11_ = (NIM_BOOL)0;
									T11_ = isFilled__pureZcollectionsZtables_31((*data).data->data[h].Field0);
									if (!T11_) goto LA12_;
				...
				T22_ = NIM_NIL;
				T23_ = NIM_NIL;
				T23_ = dollar___systemZdollars_3(((NI) (((NF)(infoMax.time) * (NF)(1000000.0)))));
				T24_ = NIM_NIL;
				T24_ = nsuAlignString(T23_, ((NI) 10), 32);
				T25_ = NIM_NIL;
				T25_ = dollar___systemZdollars_3(infoMax.count);
				T26_ = NIM_NIL;
				T26_ = nsuAlignString(T25_, ((NI) 10), 32);
				T27_ = NIM_NIL;
				T27_ = toFileLineCol__msgs_619(conf, flMax);
...
appendString(result, T22_);
				del__vmprofiler_1033(data, flMax);
				i_2 += ((NI) 1);
			} LA3: ;
		}
	} LA1: ;
