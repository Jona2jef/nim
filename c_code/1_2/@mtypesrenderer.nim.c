...
N_LIB_PRIVATE N_NIMCALL(void, renderParamTypes__typesrenderer_123)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ** found, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderType__typesrenderer_15)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderPlainSymbolName__typesrenderer_6)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 53):
	{
		...
		T2_ = (NI)0;
		T2_ = len__ast_3198(n);
		result = renderPlainSymbolName__typesrenderer_6((*n)._kind_6.sons->data[(NI)(T2_ - ((NI) 1))]);
	}
	break;
	...
	{
		result = renderDefinitionName__renderer_88((*n)._kind_4.sym, NIM_TRUE);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 43):
	{
		result = renderPlainSymbolName__typesrenderer_6((*n)._kind_6.sons->data[((NI) 0)]);
	}
	break;
	default:
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderType__typesrenderer_15)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		result = typeToString__types_50((*(*n)._kind_4.sym).typ, ((tyEnum_TPreferedDesc__tnd4qt9c4xddV8oKV5zyusw) 0));
	}
	break;
	...
	{
		{
			...
			result = renderType__typesrenderer_15((*n)._kind_6.sons->data[((NI) 0)]);
		}
		goto LA4_;
		LA7_: ;
		{
	...
	{
		{
			...
			T16_ = NIM_NIL;
			T17_ = NIM_NIL;
			T17_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[((NI) 0)]);
	...
	{
		{
			...
			T25_ = NIM_NIL;
			T26_ = NIM_NIL;
			T26_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[((NI) 0)]);
			...
			result = copyString(((NimStringDesc*) &TM__SgHDIVcSir4dkKoe0Xsi0A_7));
			{
				...
				i_2 = ((NI) 1);
				{
					while (1) {
						...
						T37_ = NIM_NIL;
						T38_ = NIM_NIL;
						T38_ = renderType__typesrenderer_15((*params)._kind_6.sons->data[i]);
...
appendString(result, T37_);
			...
			X5BX5Deq___system_7442((&result), ((NI) 1), 41);
		}
		goto LA29_;
		LA32_: ;
		{
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 35):
	{
		...
		T41_ = (NI)0;
		T41_ = len__ast_3198(n);
		typePos = (NI)(T41_ - ((NI) 2));
		typeStr = renderType__typesrenderer_15((*n)._kind_6.sons->data[typePos]);
		...
		result = copyString(((NimStringDesc*) &TM__SgHDIVcSir4dkKoe0Xsi0A_9));
		{
			...
			i_6 = ((NI) 0);
			{
				while (1) {
					...
					T50_ = NIM_NIL;
					T51_ = NIM_NIL;
					T51_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[i_5]);
...
appendString(result, T50_);
		...
		X5BX5Deq___system_7442((&result), ((NI) 1), 93);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 42):
	{
		...
		T53_ = NIM_NIL;
		T54_ = NIM_NIL;
		T54_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[((NI) 0)]);
		...
		result = T53_;
		{
			...
			i_8 = ((NI) 1);
			{
				while (1) {
					...
					T58_ = NIM_NIL;
					T59_ = NIM_NIL;
					T59_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[i_7]);
...
appendString(result, ((NimStringDesc*) &TM__SgHDIVcSir4dkKoe0Xsi0A_10));
					...
					LA66_: ;
					T68_ = NIM_NIL;
					T68_ = renderType__typesrenderer_15((*n)._kind_6.sons->data[i_9]);
...
{	switch ((*n).kind) {
	...
	{
		{
			...
			i_2 = ((NI) 1);
			{
				while (1) {
					...
					i = i_2;
					renderParamTypes__typesrenderer_123(found, (*n)._kind_6.sons->data[i]);
					i_2 += ((NI) 1);
				} LA4: ;
			}
		}
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 35):
	{
		...
		typeStr = renderType__typesrenderer_15((*n)._kind_6.sons->data[typePos]);
		{
			...
			{
				if (!!((typ == 0))) goto LA15_;
				typeStr = typeToString__types_50(typ, ((tyEnum_TPreferedDesc__tnd4qt9c4xddV8oKV5zyusw) 2));
			}
			LA15_: ;
			{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderParamTypes__typesrenderer_167)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* sep) {
	...
	result = ((NimStringDesc*) NIM_NIL);
	found = NIM_NIL;
	renderParamTypes__typesrenderer_123((&found), n);
	{
		NI T3_;
