...
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_4, "/home/runner/work/nightlies/nightlies/nim/compiler/plugins/itersgen.nim", 71);
...
{	result = NIM_NIL;
	...
	iter = (*n)._kind_6.sons->data[((NI) 1)];
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		liMessage__msgs_1117((*(*c).graph).config, (*iter).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_2), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_3, NIM_FALSE);
		goto BeforeRet_;
	}
	LA5_: ;
	{
		if (!((*(*n)._kind_6.sons->data[((NI) 2)]).typ == 0)) goto LA9_;
		liMessage__msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_6, NIM_FALSE);
		goto BeforeRet_;
	}
	LA9_: ;
	{
		if (!!(((*(*n)._kind_6.sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		liMessage__msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 3)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_7), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_8, NIM_FALSE);
		goto BeforeRet_;
	}
	LA13_: ;
	t = skipTypes__ast_3735((*(*n)._kind_6.sons->data[((NI) 2)]).typ, TM__fVT8Frbe1eY8sI6VOwxZZg_9);
	{
		...
		if (T17_) goto LA18_;
		T19_ = NIM_NIL;
		T19_ = lastSon__ast_3743(t);
		T17_ = !(((*T19_).kind == ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 17)));
		LA18_: ;
		if (!T17_) goto LA20_;
		liMessage__msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_10), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_11, NIM_FALSE);
		goto BeforeRet_;
	}
	LA20_: ;
	T22_ = NIM_NIL;
	T22_ = getBody__modulegraphs_11241((*c).graph, (*iter)._kind_4.sym);
	body = liftIterToProc__lambdalifting_5051((*c).graph, (*iter)._kind_4.sym, T22_, t, (*c).Sup.idgen);
	T23_ = nextSymId__ast_3132((*c).Sup.idgen);
	prc = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), (*(*n)._kind_6.sons->data[((NI) 3)])._kind_5.ident, T23_, (*(*iter)._kind_4.sym).owner, (*(*iter)._kind_4.sym).info, 0);
	T24_ = nextTypeId__ast_3151((*c).Sup.idgen);
	asgnRef((void**) (&(*prc).typ), copyType__ast_4046((*(*iter)._kind_4.sym).typ, T24_, prc));
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag__x2m5g1NpbmDig4wLT3Ylhw) 12)) & 63));
	T25_ = NIM_NIL;
	T25_ = getEnvParam__lambdalifting_131((*iter)._kind_4.sym);
	T26_ = NIM_NIL;
	T26_ = newSymNode__ast_3716(T25_);
	add__ast_4797((*(*prc).typ).n, T26_);
	rawAddSon__ast_4288((*prc).typ, t, NIM_TRUE);
	orig = (*(*iter)._kind_4.sym).ast;
	T27_ = NIM_NIL;
	T27_ = newSymNode__ast_3716(prc);
	asgnRef((void**) (&(*prc).ast), newProcNode__ast_3821(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, (*orig)._kind_6.sons->data[((NI) 3)], T27_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig)._kind_6.sons->data[((NI) 4)], (*(*c).graph).emptyNode));
	add__ast_4797((*prc).ast, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons->data[((NI) 7)]);
	addInterfaceDecl__lookups_879(c, prc);
	}BeforeRet_: ;
	return result;
}
