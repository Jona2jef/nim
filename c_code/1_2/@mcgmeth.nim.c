...
N_LIB_PRIVATE N_NIMCALL(tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag, sameMethodBucket__cgmeth_88)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* b, NIM_BOOL multiMethods);
...
N_LIB_PRIVATE N_NIMCALL(void, attachDispatcher__cgmeth_188)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* dispatcher);
...
N_LIB_PRIVATE N_NIMCALL(void, fixupDispatcher__cgmeth_240)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* meth, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* disp, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, createDispatcher__cgmeth_206)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getDispatcher__cgmeth_42)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s);
N_LIB_PRIVATE N_NIMCALL(void, failedAssertImpl__systemZassertions_56)(NimStringDesc* msg);
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genConv__cgmeth_13)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TType__facALICuu8zUj0hjvbTLFg* d, NIM_BOOL downcast, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, relevantCol__cgmeth_329)(tySequence__eHqUwlHGGaPw0TDPDeL79cQ* methods, NI col);
N_LIB_PRIVATE N_NIMCALL(void, incl__pureZcollectionsZintsets_55)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(void, sortBucket__cgmeth_377)(tySequence__eHqUwlHGGaPw0TDPDeL79cQ** a, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
N_LIB_PRIVATE N_NIMCALL(NI, cmpSignatures__cgmeth_349)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* b, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, contains__astalgo_3496)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genDispatcher__cgmeth_392)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tySequence__eHqUwlHGGaPw0TDPDeL79cQ* methods, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols);
...
STRING_LITERAL(TM__zwdrTKOAAM6OvWnXdBD4GQ_5, "/home/runner/work/nightlies/nightlies/nim/compiler/cgmeth.nim", 61);
...
{	result = (tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag)0;
	...
	LA3_: ;
	{
		...
		NI T8_;
		T7_ = (NI)0;
		T7_ = len__ast_4002((*a).typ);
		T8_ = (NI)0;
		T8_ = len__ast_4002((*b).typ);
		...
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				bb = (*(*b).typ).sons->data[i];
				{
					while (1) {
						...
						bb = skipTypes__ast_3735(bb, TM__zwdrTKOAAM6OvWnXdBD4GQ_2);
						{
							...
							LA19_: ;
							if (!T18_) goto LA20_;
							aa = lastSon__ast_3743(aa);
							bb = lastSon__ast_3743(bb);
						}
						goto LA16_;
						LA20_: ;
						{
				...
				} LA14: ;
				{
					NIM_BOOL T25_;
					T25_ = (NIM_BOOL)0;
					T25_ = sameType__types_1824((*(*a).typ).sons->data[i], (*(*b).typ).sons->data[i], 0);
					if (!T25_) goto LA26_;
					{
						NIM_BOOL T30_;
						T30_ = (NIM_BOOL)0;
				...
				LA26_: ;
				{
					...
					LA38_: ;
					if (!T35_) goto LA41_;
					diff = inheritanceDiff__types_2685(bb, aa);
					{
	...
	}
	{
		if (!(result == ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2))) goto LA61_;
		{
			NIM_BOOL T65_;
			T65_ = (NIM_BOOL)0;
			T65_ = sameTypeOrNil__types_1848((*(*a).typ).sons->data[((NI) 0)], (*(*b).typ).sons->data[((NI) 0)], 0);
			if (!!(T65_)) goto LA66_;
			{
				NIM_BOOL T70_;
				T70_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, attachDispatcher__cgmeth_188)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* dispatcher) {
	...
	LA4_: ;
	{
		asgnRef((void**) (&(*(*s).ast)._kind_6.sons), (tySequence__ehmV9bTklH2Gt9cXHV9c0HLeQ*) setLengthSeqV2(&((*(*s).ast)._kind_6.sons)->Sup, (&NTItnodeseq__ehmV9bTklH2Gt9cXHV9c0HLeQ_), ((NI) 9)));
		{
			...
			asgnRef((void**) (&(*(*s).ast)._kind_6.sons->data[((NI) 7)]), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*s).info));
		}
		LA9_: ;
		asgnRef((void**) (&(*(*s).ast)._kind_6.sons->data[((NI) 8)]), dispatcher);
	}
...
N_LIB_PRIVATE N_NIMCALL(void, fixupDispatcher__cgmeth_240)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* meth, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* disp, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	{
		...
		T4_ = (NIM_BOOL)0;
		T5_ = (NI)0;
		T5_ = len__ast_3198((*disp).ast);
		T4_ = (((NI) 7) < T5_);
		if (!(T4_)) goto LA6_;
		T7_ = (NI)0;
		T7_ = len__ast_3198((*meth).ast);
		T4_ = (((NI) 7) < T7_);
		LA6_: ;
		T3_ = T4_;
		if (!(T3_)) goto LA8_;
		...
		LA8_: ;
		if (!T3_) goto LA9_;
		asgnRef((void**) (&(*(*disp).ast)._kind_6.sons->data[((NI) 7)]), copyTree__ast_4431((*(*meth).ast)._kind_6.sons->data[((NI) 7)]));
	}
	LA9_: ;
	{
	...
	LA13_: ;
	{
		...
		T20_[0] = dollar___ast_3858((*(*meth).typ).lockLevel);
		T20_[1] = dollar___ast_3858((*(*disp).typ).lockLevel);
		T21_ = NIM_NIL;
		T21_ = nsuFormatOpenArray(((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_3), T20_, 2);
		liMessage__msgs_1117(conf, (*meth).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 52), T21_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_4, NIM_FALSE);
		{
...
{	result = NIM_NIL;
	...
	asgnRef((void**) (&(*disp).typ), copyType__ast_4046((*disp).typ, T2_, (*(*disp).typ).owner));
	copyTypeProps__modulegraphs_8872(g, ((NI) ((*idgen).module)), (*disp).typ, old);
	{
	...
	LA5_: ;
	asgnRef((void**) (&(*disp).ast), copyTree__ast_4431((*s).ast));
	asgnRef((void**) (&(*(*disp).ast)._kind_6.sons->data[((NI) 6)]), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*s).info));
	asgnRef((void**) (&(*disp).loc.r), ((tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*) NIM_NIL));
	{
		if (!!(((*(*s).typ).sons->data[((NI) 0)] == ((tyObject_TType__facALICuu8zUj0hjvbTLFg*) NIM_NIL)))) goto LA9_;
		{
			...
			T13_ = (NI)0;
			T13_ = len__ast_3198((*disp).ast);
			if (!(((NI) 7) < T13_)) goto LA14_;
			T16_ = nextSymId__ast_3132(idgen);
			asgnRef((void**) (&(*(*(*disp).ast)._kind_6.sons->data[((NI) 7)])._kind_4.sym), copySym__ast_4054((*(*(*s).ast)._kind_6.sons->data[((NI) 7)])._kind_4.sym, T16_));
		}
		goto LA11_;
		LA14_: ;
		{
			...
			T18_ = NIM_NIL;
			T18_ = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*s).info);
			add__ast_4797((*disp).ast, T18_);
		}
		LA11_: ;
	}
	LA9_: ;
	T19_ = NIM_NIL;
	T19_ = newSymNode__ast_3716(disp);
	attachDispatcher__cgmeth_188(s, T19_);
	T20_ = NIM_NIL;
	T20_ = newSymNode__ast_3716(disp);
	attachDispatcher__cgmeth_188(disp, T20_);
	result = disp;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, methodDef__cgmeth_263)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s) {
...
{	witness = NIM_NIL;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				T5_ = sameMethodBucket__cgmeth_88(disp, s, (((*(*g).config).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 43))&63U)))!=0));
				switch (T5_) {
				case ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2):
				{
					...
					attachDispatcher__cgmeth_188(s, (*(*disp).ast)._kind_6.sons->data[((NI) 8)]);
					fixupDispatcher__cgmeth_240(s, disp, (*g).config);
					checkMethodEffects__sempass50_4507(g, disp, s);
					{
						NIM_BOOL T10_;
						T10_ = (NIM_BOOL)0;
						...
						LA11_: ;
						if (!T10_) goto LA12_;
						liMessage__msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_7, NIM_FALSE);
					}
					LA12_: ;
					goto BeforeRet_;
				}
	...
	T20_.Field1 = createDispatcher__cgmeth_206(s, g, idgen);
	...
	asgnRef((void**) (&(*g).methods->data[T21_].Field1), T20_.Field1);
	{
		...
		T26_ = NIM_NIL;
		T27_ = NIM_NIL;
		T27_ = dollar___msgs_624((*g).config, (*witness).info);
...
appendString(T26_, T27_);
		liMessage__msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T26_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_10, NIM_FALSE);
	}
	goto LA22_;
	LA24_: ;
	{
		if (!!((((*s).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 20))&63U)))!=0))) goto LA29_;
		liMessage__msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 33), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_11, NIM_FALSE);
	}
	goto LA22_;
	LA29_: ;
	LA22_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getDispatcher__cgmeth_42)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s) {
	...
	result = NIM_NIL;
	{
		...
		result = (*(*(*s).ast)._kind_6.sons->data[((NI) 8)])._kind_4.sym;
		{
			...
			failedAssertImpl__systemZassertions_56(((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_12));
		}
		LA8_: ;
	}
	LA4_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genConv__cgmeth_13)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TType__facALICuu8zUj0hjvbTLFg* d, NIM_BOOL downcast, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	source = skipTypes__ast_3735((*n).typ, TM__zwdrTKOAAM6OvWnXdBD4GQ_13);
	{
		...
		LA9_: ;
		{
			...
			result = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 67), (*n).info, d);
			add__ast_4797(result, n);
			{
				if (!downcast) goto LA16_;
				internalErrorImpl__msgs_1430(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_14), TM__zwdrTKOAAM6OvWnXdBD4GQ_15);
			}
			LA16_: ;
		}
		goto LA7_;
		LA12_: ;
		{
			...
			result = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 66), (*n).info, d);
			add__ast_4797(result, n);
			{
				if (!!(downcast)) goto LA23_;
				internalErrorImpl__msgs_1430(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_16), TM__zwdrTKOAAM6OvWnXdBD4GQ_17);
			}
			LA23_: ;
		}
		goto LA7_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, methodCall__cgmeth_58)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	result = NIM_NIL;
	result = n;
	disp = getDispatcher__cgmeth_42((*(*result)._kind_6.sons->data[((NI) 0)])._kind_4.sym);
	{
		...
		asgnRef((void**) (&(*(*result)._kind_6.sons->data[((NI) 0)])._kind_4.sym), disp);
		{
			...
			i = (NI)0;
			colontmp_ = (NI)0;
			colontmp_ = len__ast_3198(result);
			i_2 = ((NI) 1);
			{
				while (1) {
					if (!(i_2 < colontmp_)) goto LA7;
					i = i_2;
					asgnRef((void**) (&(*result)._kind_6.sons->data[i]), genConv__cgmeth_13((*result)._kind_6.sons->data[i], (*(*disp).typ).sons->data[i], NIM_TRUE, conf));
					i_2 += ((NI) 1);
				} LA7: ;
			}
		}
	...
	LA3_: ;
	{
		...
		T9_ = NIM_NIL;
		T10_ = NIM_NIL;
		T10_ = dollar___renderer_2106((*result)._kind_6.sons->data[((NI) 0)]);
...
appendString(T9_, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_19));
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T9_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_20, NIM_FALSE);
	}
	LA1_: ;
	return result;
}
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					t2 = skipTypes__ast_3735((*(*methods->data[i]).typ).sons->data[col], TM__zwdrTKOAAM6OvWnXdBD4GQ_21);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = sameType__types_1824(t2, t, 0);
						if (!!(T11_)) goto LA12_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
		...
		i = ((NI) 1);
		{
			while (1) {
				...
				col = i;
				{
					...
					NI d;
					T6_ = (NIM_BOOL)0;
					T6_ = contains__astalgo_3496(relevantCols, col);
					if (!T6_) goto LA7_;
					...
					d = inheritanceDiff__types_2685(aa, bb);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
					...
					while (1) {
						...
						j = i;
						{
							while (1) {
								NI T15_;
								T15_ = (NI)0;
								T15_ = cmpSignatures__cgmeth_349((*a)->data[(NI)(j - h)], v, relevantCols);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genDispatcher__cgmeth_392)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tySequence__eHqUwlHGGaPw0TDPDeL79cQ* methods, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols) {
	...
	result = base;
	paramLen = len__ast_4002((*base).typ);
	nilchecks = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*base).info);
	disp = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 92), (*base).info);
	ands = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_280, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_22), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 109));
	iss = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_280, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_23), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 15));
	boolType = getSysType__magicsys_60(g, unknownLineInfo__lineinfos_280, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 1));
	{
		NI col;
		NI i;
		col = (NI)0;
			...
			while (1) {
				...
				col = i;
				{
					...
					param = (*(*(*(*base).typ).n)._kind_6.sons->data[col])._kind_4.sym;
					{
						...
						T15_ = NIM_NIL;
						T15_ = getCompilerProc__magicsys_145(g, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_25));
						T14_[0] = newSymNode__ast_3716(T15_);
						T14_[1] = newSymNode__ast_3716(param);
						T16_ = NIM_NIL;
						T16_ = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 27), T14_, 2);
						add__ast_4797(nilchecks, T16_);
					}
					LA12_: ;
				}
				LA7_: ;
	...
	}
	{
		...
		res = ((NI) 0);
		{
			while (1) {
					...
					i_2 = ((NI) 1);
					{
						while (1) {
							...
							col_2 = i_2;
							{
								...
								T26_ = (NIM_BOOL)0;
								T26_ = contains__astalgo_3496(relevantCols, col_2);
								if (!T26_) goto LA27_;
								isn = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 27), (*base).info, boolType);
								T29_ = NIM_NIL;
								T29_ = newSymNode__ast_3716(iss);
								add__ast_4797(isn, T29_);
								param_2 = (*(*(*(*base).typ).n)._kind_6.sons->data[col_2])._kind_4.sym;
								T30_ = NIM_NIL;
								T30_ = newSymNode__ast_3716(param_2);
								add__ast_4797(isn, T30_);
								T31_ = NIM_NIL;
								T31_ = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 4), (*base).info, (*(*curr).typ).sons->data[col_2]);
								add__ast_4797(isn, T31_);
								{
									...
									a = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 27), (*base).info, boolType);
									T36_ = NIM_NIL;
									T36_ = newSymNode__ast_3716(ands);
									add__ast_4797(a, T36_);
									add__ast_4797(a, cond);
									add__ast_4797(a, isn);
									cond = a;
								}
								goto LA32_;
				...
				call = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 27), (*base).info, retTyp);
				T38_ = NIM_NIL;
				T38_ = newSymNode__ast_3716(curr);
				add__ast_4797(call, T38_);
				{
					NI col_3;
					NI i_3;
					col_3 = (NI)0;
					i_3 = ((NI) 1);
					{
						while (1) {
							...
							col_3 = i_3;
							T42_ = NIM_NIL;
							T42_ = newSymNode__ast_3716((*(*(*(*base).typ).n)._kind_6.sons->data[col_3])._kind_4.sym);
							T43_ = NIM_NIL;
							T43_ = genConv__cgmeth_13(T42_, (*(*curr).typ).sons->data[col_3], NIM_FALSE, (*g).config);
							add__ast_4797(call, T43_);
							i_3 += ((NI) 1);
						} LA41: ;
					}
				}
				ret = NIM_NIL;
				{
					...
					a_2 = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 74), (*base).info);
					T48_ = NIM_NIL;
					T48_ = newSymNode__ast_3716((*(*(*base).ast)._kind_6.sons->data[((NI) 7)])._kind_4.sym);
					add__ast_4797(a_2, T48_);
					add__ast_4797(a_2, call);
					ret = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 109), (*base).info);
					add__ast_4797(ret, a_2);
				}
				goto LA44_;
				LA46_: ;
				{
				...
				LA44_: ;
				{
					...
					a_3 = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 86), (*base).info);
					add__ast_4797(a_3, cond);
					add__ast_4797(a_3, ret);
					add__ast_4797(disp, a_3);
				}
				goto LA50_;
				LA52_: ;
				{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, generateMethodDispatchers__cgmeth_546)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	result = NIM_NIL;
	result = newNode__ast_3332(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115));
	{
		NI bucket;
		NI colontmp_;
		NI T2_;
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				initIntSet__pureZcollectionsZintsets_238((&relevantCols));
				{
					NI col;
					NI colontmp__2;
					NI i_2;
					col = (NI)0;
					colontmp__2 = (NI)0;
					colontmp__2 = len__ast_4002((*(*g).methods->data[bucket].Field0->data[((NI) 0)]).typ);
					i_2 = ((NI) 1);
					{
						while (1) {
							...
							col = i_2;
							{
								NIM_BOOL T10_;
								T10_ = (NIM_BOOL)0;
								T10_ = relevantCol__cgmeth_329((*g).methods->data[bucket].Field0, col);
								if (!T10_) goto LA11_;
								incl__pureZcollectionsZintsets_55((&relevantCols), col);
							}
							LA11_: ;
							{
				...
				sortBucket__cgmeth_377((&(*g).methods->data[bucket].Field0), (&relevantCols));
				T17_ = NIM_NIL;
				T17_ = genDispatcher__cgmeth_392(g, (*g).methods->data[bucket].Field0, (&relevantCols));
				T18_ = NIM_NIL;
				T18_ = newSymNode__ast_3716(T17_);
