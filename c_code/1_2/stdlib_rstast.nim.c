...
N_LIB_PRIVATE N_NIMCALL(tyObject_RstNode__22EYjMYlm9cWcheQxrewdHQ*, newRstLeaf__packagesZdocutilsZrstast_187)(NimStringDesc* s) {
	...
	T1_ = NIM_NIL;
	T1_ = NIM_NIL;
	result = newRstNode__packagesZdocutilsZrstast_109(((tyEnum_RstNodeKind__DNoJcMFu9cjq4EGXsLl82CQ) 73), T1_, ((NimStringDesc*) NIM_NIL));
	T2_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(void, add__packagesZdocutilsZrstast_203)(tyObject_RstNode__22EYjMYlm9cWcheQxrewdHQ* father, NimStringDesc* s) {
	...
	NI T2_;
	T1_ = NIM_NIL;
	T1_ = newRstLeaf__packagesZdocutilsZrstast_187(s);
	asgnRef((void**) (&(*father).sons), (tySequence__V9cBl110bSARQ3Xk9bVaXHDw*) incrSeqV3((TGenericSeq*)((*father).sons), (&NTIrstnodeseq__V9cBl110bSARQ3Xk9bVaXHDw_)));
...
N_LIB_PRIVATE N_NIMCALL(void, addIfNotNil__packagesZdocutilsZrstast_210)(tyObject_RstNode__22EYjMYlm9cWcheQxrewdHQ* father, tyObject_RstNode__22EYjMYlm9cWcheQxrewdHQ* son) {
	{
		...
		add__packagesZdocutilsZrstast_196(father, son);
	}
	LA3_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					{
						...
						LA20_: ;
						T22_ = NIM_NIL;
						T22_ = renderRstToText__packagesZdocutilsZrstast_452((*node).sons->data[i]);
