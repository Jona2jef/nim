...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalTemplateArgs__evaltempl_197)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NIM_BOOL fromHlo);
...
N_LIB_PRIVATE N_NIMCALL(void, evalTemplateAux__evaltempl_24)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* templ, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* actual, tyObject_TemplCtx__og0XwfDLUlsX2HzoVx0s3Q* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, copyNode__evaltempl_19)(tyObject_TemplCtx__og0XwfDLUlsX2HzoVx0s3Q* ctx, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, wrapInComesFrom__evaltempl_260)(tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* sym, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* res);
...
STRING_LITERAL(TM__N0xGjswvcjwwH43PvVNJAg_4, "/home/runner/work/nightlies/nightlies/nim/compiler/evaltempl.nim", 64);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalTemplateArgs__evaltempl_197)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NIM_BOOL fromHlo) {
	...
	LA6_: ;
	{
		genericParams = len__ast_3198((*(*s).ast)._kind_6.sons->data[((NI) 2)]);
	}
	LA4_: ;
	T9_ = (NI)0;
	T9_ = len__ast_4002((*s).typ);
	...
	LA12_: ;
	{
		...
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_6, NIM_FALSE);
	}
	LA16_: ;
	{
		NimStringDesc* T22_;
		...
		T22_ = NIM_NIL;
		T22_ = renderTree__renderer_46(n, 0);
		T23_ = NIM_NIL;
		T23_ = nsuFormatSingleElem(((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_7), T22_);
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T23_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_8, NIM_FALSE);
	}
	LA20_: ;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152), (*n).info);
	{
		NI i;
		NI res;
		i = (NI)0;
		...
		res_2 = colontmp_;
		{
			while (1) {
				...
				default_1 = (*(*(*(*(*s).typ).n)._kind_6.sons->data[i_2])._kind_4.sym).ast;
				{
					...
					LA33_: ;
					if (!T32_) goto LA34_;
					liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__N0xGjswvcjwwH43PvVNJAg_9, NIM_FALSE);
					T36_ = NIM_NIL;
					T36_ = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*n).info);
					add__ast_4797(result, T36_);
				}
				goto LA30_;
				LA34_: ;
				{
					...
					T38_ = NIM_NIL;
					T38_ = copyTree__ast_4431(default_1);
	...
	}
	{
		...
		res_3 = ((NI) 1);
		{
			while (1) {
				...
				i_3 = res_3;
				add__ast_4797(result, (*n)._kind_6.sons->data[(NI)(givenRegularParams + i_3)]);
				res_3 += ((NI) 1);
			} LA41: ;
		}
	}
		...
		s = (*templ)._kind_4.sym;
		{
			...
			if (!T4_) goto LA8_;
			{
				...
				xX60gensym0_ = (*actual)._kind_6.sons->data[(*s).position];
				{
					if (!((*xX60gensym0_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA18_;
					{
						...
						yX60gensym0_ = NIM_NIL;
						{
							...
							i = (NI)0;
							colontmp_ = (NI)0;
							colontmp_ = safeLen__ast_3191(xX60gensym0_);
							i_2 = ((NI) 0);
							{
								while (1) {
									...
									add__ast_4797(result, yX60gensym0_);
									i_2 += ((NI) 1);
								} LA23: ;
							}
						}
				...
				LA18_: ;
				{
					...
					T25_ = NIM_NIL;
					T25_ = copyTree__ast_4431(xX60gensym0_);
			...
			LA14_: ;
			{
				...
				if (!T27_) goto LA35_;
				T37_ = (NI)0;
				T37_ = len__ast_4002((*(*s).owner).typ);
				xX60gensym4_ = (*actual)._kind_6.sons->data[(NI)((NI)(T37_ + (*s).position) - ((NI) 1))];
				{
					if (!((*xX60gensym4_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA40_;
					{
						...
						yX60gensym4_ = NIM_NIL;
						{
							...
							i_3 = (NI)0;
							colontmp__2 = (NI)0;
							colontmp__2 = safeLen__ast_3191(xX60gensym4_);
							i_4 = ((NI) 0);
							{
								while (1) {
									...
									add__ast_4797(result, yX60gensym4_);
									i_4 += ((NI) 1);
								} LA45: ;
							}
						}
				...
				LA40_: ;
				{
					...
					T47_ = NIM_NIL;
					T47_ = copyTree__ast_4431(xX60gensym4_);
			...
			LA35_: ;
			{
				...
				RootObj* T55_;
				{
					...
					LA52_: ;
					if (!!(T51_)) goto LA53_;
					argX60gensym7_ = toFileLineCol__msgs_615(TM__N0xGjswvcjwwH43PvVNJAg_13);
					internalErrorImpl__msgs_1430((*c).config, unknownLineInfo__lineinfos_280, argX60gensym7_, TM__N0xGjswvcjwwH43PvVNJAg_13);
				}
				LA53_: ;
				T55_ = NIM_NIL;
				T55_ = idTableGet__astalgo_64((*c).mapping, (*((tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w**) (&(s)))));
				x = ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) (T55_));
				{
					...
					T60_ = nextSymId__ast_3132((*c).idgen);
					x = copySym__ast_4054(s, T60_);
					asgnRef((void**) (&(*x).owner), ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL));
					idTablePut__astalgo_70((&(*c).mapping), (*((tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w**) (&(s)))), (*((RootObj**) (&(x)))));
				}
				LA58_: ;
				{
					NimStringDesc* T65_;
					...
					T65_ = NIM_NIL;
					T66_ = NIM_NIL;
					T66_ = dollar___systemZdollars_3((*c).instID);
...
appendString(T65_, T66_);
					T67_ = NIM_NIL;
					T67_ = getIdent__idents_143((*c).ic, T65_);
					{
					...
					LA69_: ;
					T74_ = NIM_NIL;
					T74_ = newIdentNode__ast_3712(T67_, T68_);
					add__ast_4797(result, T74_);
				}
				goto LA61_;
				LA63_: ;
				{
					...
					LA77_: ;
					T82_ = NIM_NIL;
					T82_ = newSymNode__ast_3719(x, T76_);
					add__ast_4797(result, T82_);
				}
				LA61_: ;
			}
			LA10_: ;
		...
		LA8_: ;
		{
			...
			T84_ = NIM_NIL;
			T84_ = copyNode__evaltempl_19((&(*c)), templ, actual);
			add__ast_4797(result, T84_);
		}
		LA2_: ;
	}
	break;
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 4) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 23):
	{
		...
		T86_ = NIM_NIL;
		T86_ = copyNode__evaltempl_19((&(*c)), templ, actual);
	...
	{
		{
			...
			res = copyNode__evaltempl_19((&(*c)), templ, actual);
			{
				...
				i_5 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__3 = len__ast_3198(templ);
				i_6 = ((NI) 0);
				{
					while (1) {
						if (!(i_6 < colontmp__3)) goto LA94;
						i_5 = i_6;
						evalTemplateAux__evaltempl_24((*templ)._kind_6.sons->data[i_5], actual, c, res);
						i_6 += ((NI) 1);
					} LA94: ;
				}
			}
			add__ast_4797(result, res);
		}
		goto LA88_;
		LA90_: ;
		{
			...
			T96_ = NIM_NIL;
			T96_ = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*templ).info);
			add__ast_4797(result, T96_);
		}
		LA88_: ;
	}
	break;
	default:
	{
		...
		LA102_: ;
		{
			...
			T106_ = isRunnableExamples__ast_4698((*templ)._kind_6.sons->data[((NI) 0)]);
			LA109_: ;
		...
		LA110_: ;
		{
			...
			res_2 = copyNode__evaltempl_19((&(*c)), templ, actual);
			{
				...
				i_7 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__4 = len__ast_3198(templ);
				i_8 = ((NI) 0);
				{
					while (1) {
						if (!(i_8 < colontmp__4)) goto LA115;
						i_7 = i_8;
						evalTemplateAux__evaltempl_24((*templ)._kind_6.sons->data[i_7], actual, c, res_2);
						i_8 += ((NI) 1);
					} LA115: ;
				}
			}
			add__ast_4797(result, res_2);
		}
		LA104_: ;
		{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalTemplate__evaltempl_275)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* tmpl, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* genSymOwner, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* ic, NI* instID, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, NIM_BOOL fromHlo) {
	...
	(*conf).evalTemplateCounter += ((NI) 1);
	{
		...
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_2), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_3, NIM_FALSE);
		result = n;
	}
	LA3_: ;
	...
	ctx.config = conf;
	ctx.ic = ic;
	initIdTable__ast_4096((&ctx.mapping));
	ctx.instID = (*instID);
	ctx.idgen = idgen;
	body = (*(*tmpl).ast)._kind_6.sons->data[((NI) 6)];
	{
		NIM_BOOL T7_;
		T7_ = (NIM_BOOL)0;
		T7_ = isAtom__ast_4768(body);
		if (!T7_) goto LA8_;
		result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 37), (*body).info);
		evalTemplateAux__evaltempl_24(body, args, (&ctx), result);
		{
			NI T12_;
			T12_ = (NI)0;
			T12_ = len__ast_3198(result);
		...
		LA13_: ;
		{
			...
			T16_ = NIM_NIL;
			T17_ = NIM_NIL;
			T17_ = renderTree__renderer_46(result, 4);
...
appendString(T16_, T17_);
			liMessage__msgs_1117(conf, (*result).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T16_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__N0xGjswvcjwwH43PvVNJAg_17, NIM_FALSE);
		}
		LA10_: ;
	}
	goto LA5_;
	LA8_: ;
	{
		result = copyNode__ast_4336(body);
		...
		LA21_: ;
		{
			...
			i = (NI)0;
			colontmp_ = (NI)0;
			colontmp_ = safeLen__ast_3191(body);
			i_2 = ((NI) 0);
			{
				while (1) {
					if (!(i_2 < colontmp_)) goto LA25;
					i = i_2;
					evalTemplateAux__evaltempl_24((*body)._kind_6.sons->data[i], args, (&ctx), result);
					i_2 += ((NI) 1);
				} LA25: ;
			}
		}
	...
	result = wrapInComesFrom__evaltempl_260((*n).info, tmpl, result);
	(*conf).evalTemplateCounter -= ((NI) 1);
	(*instID) += ((NI) 1);
	return result;
}
