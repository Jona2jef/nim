...
N_LIB_PRIVATE N_NIMCALL(NI, parseHex__pureZstrutils_895)(NimStringDesc* s, NI* number, NI start, NI maxLen);
...
static N_INLINE(void, X5BX5Deq___system_7442)(NimStringDesc** s, NI i, NIM_CHAR x);
N_LIB_PRIVATE N_NIMCALL(void, trimZeros__pureZstrutils_1951)(NimStringDesc** x, NIM_CHAR decimalSep);
...
N_LIB_PRIVATE NIM_CONST tyArray__17w6ns39bmjfAZ429aQpCFUA collPrefixes__pureZstrutils_1978 = {((NimStringDesc*) NIM_NIL),
...
N_LIB_PRIVATE NIM_CONST tyArray__17w6ns39bmjfAZ429aQpCFUA iecPrefixes__pureZstrutils_1977 = {((NimStringDesc*) NIM_NIL),
...
;
N_LIB_PRIVATE NIM_CONST tyArray__vB7L5YKNrMfbzoUubCEcYg floatFormatToChar__pureZstrutils_1864 = {103,
102,
101}
;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toHex__pureZstrutils_1792)(NI x, NI len) {
	NimStringDesc* result;
	result = NIM_NIL;
	result = toHexImpl__pureZstrutils_711(((NU64) (x)), len, (x < ((NI) 0)));
	return result;
}
static N_INLINE(NIM_CHAR, toLowerAscii__stdZprivateZstrimpl_1)(NIM_CHAR c) {
	NIM_CHAR result;
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						NimStringDesc* T69_;
						T69_ = NIM_NIL;
						T69_ = substr__system_7809(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = NIM_NIL;
					T82_ = substr__system_7809(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(NI, nsuCountString)(NimStringDesc* s, NimStringDesc* sub, NIM_BOOL overlapping) {
	...
	result = (NI)0;
	{
		...
		failedAssertImpl__systemZassertions_56(((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_4));
	}
	LA3_: ;
	result = ((NI) 0);
	i = ((NI) 0);
		...
		while (1) {
			...
			LA12_: ;
			{
				...
				case 120:
				{
					...
					c = ((NI) 0);
					T23_ = (NI)0;
					T23_ = parseHex__pureZstrutils_895(s, (&c), i, ((NI) 2));
					i += T23_;
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym34_ = maxsplit;
		{
			while (1) {
				...
				LA10_: ;
				xX60gensym67_ = substr__system_7809(s, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				xX60gensym76_ = substr__system_7809(s, first, T25_);
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T31_ = result->Sup.len++;
				T32_ = NIM_NIL;
	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				LA12_: ;
				T14_ = NIM_NIL;
				T14_ = substr__system_7809(s, i, (NI)(j - ((NI) 1)));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA21_: ;
				T23_ = NIM_NIL;
				T23_ = substr__system_7809(s, i_2, (NI)(j_2 - ((NI) 1)));
...
appendString(result, by);
		...
		T24_ = NIM_NIL;
		T24_ = substr__system_7821(s, i_2);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuStrip)(NimStringDesc* s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	LA11_: ;
	result = substr__system_7809(s, first, last);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitString)(NimStringDesc* s, NimStringDesc* sep, NI maxsplit) {
	...
	result = NIM_NIL;
	{
		...
		failedAssertImpl__systemZassertions_56(((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_23));
	}
	LA3_: ;
	result = NIM_NIL;
	{
		...
		splitsX60gensym41_ = maxsplit;
		{
			while (1) {
				...
				LA15_: ;
				xX60gensym72_ = substr__system_7809(s, firstX60gensym41_, (NI)(lastX60gensym41_ - ((NI) 1)));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T17_ = result->Sup.len++;
				T18_ = NIM_NIL;
...
appendString(result, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_24));
					T5_ = NIM_NIL;
					T5_ = toHex__pureZstrutils_1792(((NU8)(c)), ((NI) 2));
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				line = substr__system_7809(s, first, T25_);
				{
...
appendString(result, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_28));
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							indentCount += ((NI) 1);
							{
								...
								if (T40_) goto LA41_;
								T42_ = dotdot___pureZunicode_840(j, (NI)((NI)(j + (padding ? padding->Sup.len : 0)) - ((NI) 1)));
								T43_ = NIM_NIL;
								T43_ = X5BX5D___pureZunicode_865(line, T42_);
				...
				T46_ = dotdot___stdZenumutils_80((NI)(indentCount * (padding ? padding->Sup.len : 0)), ((NI) 1));
				T47_ = NIM_NIL;
				T47_ = X5BX5D___pureZunicode_3215(line, T46_);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuCapitalizeAscii)(NimStringDesc* s) {
	...
	LA3_: ;
	{
		...
		T8_ = NIM_NIL;
		T8_ = substr__system_7821(s, ((NI) 1));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, tyEnum_FloatFormatMode__pNvEoaqwoxKyoASD11vSgQ format, NI precision, NIM_CHAR decimalSep) {
	...
	frmtstr[(((NI) 0))- 0] = 37;
	{
		...
		frmtstr[(((NI) 2))- 0] = 46;
		frmtstr[(((NI) 3))- 0] = 42;
		frmtstr[(((NI) 4))- 0] = floatFormatToChar__pureZstrutils_1864[(format)- 0];
		frmtstr[(((NI) 5))- 0] = 0;
	...
	LA3_: ;
	{
		frmtstr[(((NI) 1))- 0] = floatFormatToChar__pureZstrutils_1864[(format)- 0];
		frmtstr[(((NI) 2))- 0] = 0;
	...
	}
	{
		...
		if (!(T17_)) goto LA18_;
		T19_ = (NIM_CHAR*)0;
		T19_ = X5BX5D___system_7427((&result), ((NI) 4));
		T17_ = ((NU8)((*T19_)) == (NU8)(43));
		LA18_: ;
		T16_ = T17_;
		if (!(T16_)) goto LA20_;
		T21_ = (NIM_CHAR*)0;
		T21_ = X5BX5D___system_7427((&result), ((NI) 3));
		T16_ = ((NU8)((*T21_)) == (NU8)(48));
		LA20_: ;
		if (!T16_) goto LA22_;
		T24_ = (NIM_CHAR*)0;
		T24_ = X5BX5D___system_7427((&result), ((NI) 2));
		X5BX5Deq___system_7442((&result), ((NI) 3), (*T24_));
		T25_ = (NIM_CHAR*)0;
		T25_ = X5BX5D___system_7427((&result), ((NI) 1));
		X5BX5Deq___system_7442((&result), ((NI) 2), (*T25_));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, formatSize__pureZstrutils_1971)(NI64 bytes, NIM_CHAR decimalSep, tyEnum_BinaryPrefixMode__nDtrM19b3byM8T9ab2m7BwvA prefix, NIM_BOOL includeSpace) {
	...
	nimZeroMem((void*)prefixes, sizeof(tyArray__17w6ns39bmjfAZ429aQpCFUA));
	{
		...
		genericAssign((void*)prefixes, (void*)collPrefixes__pureZstrutils_1978, (&NTIarrayL48OO56_stringT__17w6ns39bmjfAZ429aQpCFUA_));
	}
	goto LA1_;
	LA3_: ;
	{
		genericAssign((void*)prefixes, (void*)iecPrefixes__pureZstrutils_1977, (&NTIarrayL48OO56_stringT__17w6ns39bmjfAZ429aQpCFUA_));
	}
	LA1_: ;
	{
		NI index;
	...
	trimZeros__pureZstrutils_1951((&result), decimalSep);
	{
