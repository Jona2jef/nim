...
N_LIB_PRIVATE N_NIMCALL(void, nav__icZnavigator_316)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g);
...
N_LIB_PRIVATE N_NIMCALL(NI, searchForIncludeFile__icZnavigator_275)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NimStringDesc* fullPath);
...
N_LIB_PRIVATE N_NIMCALL(NU32, getKeyId__icZnavigator_327)(tyObject_BiTable__SMd2CpsYscvX1veKoGcqmg t, NimStringDesc* v);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g, search__icZnavigator_60)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchLocalSym__icZnavigator_24)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedSym__XjVn21MwvH8ij6CfopYZWw* s, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isTracked__icZnavigator_18)(tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg current, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg trackPos, NI tokenLen);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchForeignSym__icZnavigator_41)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g s, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info);
...
N_LIB_PRIVATE N_NIMCALL(void, list__icZnavigator_244)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g sym);
N_LIB_PRIVATE N_NIMCALL(void, usage__icZnavigator_113)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info, NIM_BOOL isDecl);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsOrIncl__icZnavigator_143)(tyObject_HashSet__CD8Dpv0WGmASelVaNSo6zg* s, NimStringDesc* key);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDecl__icZnavigator_100)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n);
static N_INLINE(tyObject_PackedNode__7lDGAZiNp4zbO65GEpoKow*, X5BX5D___icZpacked95ast_299)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw* tree, NI i);
N_LIB_PRIVATE N_NIMCALL(NI, parentImpl__icZpacked95ast_431)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n);
...
STRING_LITERAL(TM__uKdnhBV2kyIqxt9av3iBrww_4, "/home/runner/work/nightlies/nightlies/nim/compiler/ic/navigator.nim", 67);
...
N_LIB_PRIVATE NIM_CONST tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g EmptyItemId__icZnavigator_59 = {((NI32) -1), ((NI32) -1)}
;
					...
					res_2 = ((NI) 1);
					{
						while (1) {
							...
							k = res_2;
							{
								...
								T11_ = X5BX5D___icZic_5597((&(*g).packed_0->data[i].fromDisk.strings), (*g).packed_0->data[i].fromDisk.includes->data[k].Field0);
								T12_ = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchLocalSym__icZnavigator_24)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedSym__XjVn21MwvH8ij6CfopYZWw* s, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info) {
	...
	if (!(T1_)) goto LA2_;
	T3_ = (NimStringDesc**)0;
	T3_ = X5BX5D___icZic_5597((&(*(*c).g).packed_0->data[(*c).thisModule].fromDisk.strings), (*s).name);
	T1_ = isTracked__icZnavigator_18(info, (*c).trackPos, ((*T3_) ? (*T3_)->Sup.len : 0));
	LA2_: ;
	result = T1_;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, searchForeignSym__icZnavigator_41)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g s, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info) {
	...
	if (!(T1_)) goto LA2_;
	T3_ = (NimStringDesc**)0;
	T3_ = X5BX5D___icZic_5597((&(*(*c).g).packed_0->data[s.module].fromDisk.strings), name);
	T1_ = isTracked__icZnavigator_18(info, (*c).trackPos, ((*T3_) ? (*T3_)->Sup.len : 0));
	LA2_: ;
	result = T1_;
	return result;
...
{	nimZeroMem((void*)(&result), sizeof(tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g));
			...
			while (1) {
				...
				case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
				{
					...
					item = tree.nodes->data[i].operand;
					{
						NIM_BOOL T8_;
						T8_ = (NIM_BOOL)0;
						T8_ = searchLocalSym__icZnavigator_24(c, (&(*(*c).g).packed_0->data[(*c).thisModule].fromDisk.syms->data[item]), tree.nodes->data[i].info);
						if (!T8_) goto LA9_;
						nimZeroMem((void*)(&result), sizeof(tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g));
				...
				{
					{
						...
						LA15_: ;
						if (!T14_) goto LA16_;
						T18_ = sons2__icZpacked95ast_498(tree, i);
						n1 = T18_.Field0;
						n2 = T18_.Field1;
						...
						itemId = translateId__icZic_8432(pId, (*(*c).g).packed_0, ((NI) ((*c).thisModule)), (*(*c).g).config);
						{
							NIM_BOOL T21_;
							T21_ = (NIM_BOOL)0;
							T21_ = searchForeignSym__icZnavigator_41(c, itemId, tree.nodes->data[i].info);
							if (!T21_) goto LA22_;
							result = itemId;
							goto BeforeRet_;
						}
	...
	result = EmptyItemId__icZnavigator_59;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsOrIncl__icZnavigator_143)(tyObject_HashSet__CD8Dpv0WGmASelVaNSo6zg* s, NimStringDesc* key) {
	...
	result = (NIM_BOOL)0;
	{
		...
		if (!(T3_ == ((NI) 0))) goto LA4_;
		correctSizeX60gensym15_ = slotsNeeded__pureZcollectionsZsets_49(((NI) 64));
		(*s).counter = ((NI) 0);
	...
	{
		{
			NIM_BOOL T13_;
			T13_ = (NIM_BOOL)0;
			T13_ = mustRehash__options_2861((*s));
			if (!T13_) goto LA14_;
...
N_LIB_PRIVATE N_NIMCALL(void, usage__icZnavigator_113)(tyObject_NavContext__kFS46OAOZqnPAn0QCSpBnQ* c, tyObject_PackedLineInfo__Q9bbXLBurHo2r5TyF6UBshg info, NIM_BOOL isDecl) {
	...
	T1_ = (NimStringDesc**)0;
	T1_ = X5BX5D___icZic_5597((&(*(*c).g).packed_0->data[(*c).thisModule].fromDisk.strings), info.file);
	file = copyString((*T1_));
	{
...
appendString(m, ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_10));
		addInt__stdZprivateZdigitsutils_189((&m), ((NI) (info.line)));
		{
			if (!(((NI) 0) < (NI)(((NI) (info.col)) + ((NI) 1)))) goto LA12_;
			m = resizeString(m, 2);
appendString(m, ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_11));
			addInt__stdZprivateZdigitsutils_189((&m), (NI)(((NI) (info.col)) + ((NI) 1)));
		}
		LA12_: ;
		m = resizeString(m, 1);
appendString(m, ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_12));
	...
	LA8_: ;
	{
		...
		NimStringDesc* T20_;
		T16_ = (NIM_BOOL)0;
		T16_ = containsOrIncl__icZnavigator_143((&(*c).alreadyEmitted), m);
		if (!!(T16_)) goto LA17_;
		T19_ = NIM_NIL;
		T20_ = NIM_NIL;
		{
...
appendString(T19_, m);
		msgWriteln__msgs_647((*(*c).g).config, T19_, 0);
	}
	LA17_: ;
}
static N_INLINE(tyObject_PackedNode__7lDGAZiNp4zbO65GEpoKow*, X5BX5D___icZpacked95ast_299)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw* tree, NI i) {
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDecl__icZnavigator_100)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n) {
	...
	T3_ = X5BX5D___icZpacked95ast_299((&tree), n);
			...
			while (1) {
				...
				case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
				{
					...
					item = tree.nodes->data[i].operand;
					{
						...
						if (!T8_) goto LA10_;
						T12_ = (NI)0;
						T12_ = parentImpl__icZpacked95ast_431(tree, i);
						T13_ = (NIM_BOOL)0;
						T13_ = isDecl__icZnavigator_100(tree, T12_);
						usage__icZnavigator_113(c, tree.nodes->data[i].info, T13_);
					}
					LA10_: ;
				}
				break;
				case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 162):
				{
					...
					tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ pId;
					tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g itemId;
					T15_ = sons2__icZpacked95ast_498(tree, i);
					n1 = T15_.Field0;
					n2 = T15_.Field1;
					nimZeroMem((void*)(&pId), sizeof(tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ));
					pId.module = ((NU32) (tree.nodes->data[n1].operand));
					...
					itemId = translateId__icZic_8432(pId, (*(*c).g).packed_0, ((NI) ((*c).thisModule)), (*(*c).g).config);
					{
						...
						if (!T18_) goto LA20_;
						T22_ = (NI)0;
						T22_ = parentImpl__icZpacked95ast_431(tree, i);
						T23_ = (NIM_BOOL)0;
						T23_ = isDecl__icZnavigator_100(tree, T22_);
						usage__icZnavigator_113(c, tree.nodes->data[i].info, T23_);
					}
					LA20_: ;
				}
				break;
...
{	unpacked = (*(*g).config).m.trackPos;
	...
	fullPath = toFullPath__msgs_538((*g).config, unpacked.fileIndex);
	{
		if (!((*g).packed_0->data[mid].status == ((tyEnum_ModuleStatus__MgSLMPwZ4GVYYz7Kn9bmm6Q) 0))) goto LA3_;
		mid = searchForIncludeFile__icZnavigator_275(g, fullPath);
	}
	LA3_: ;
	{
		NimStringDesc* T9_;
...
appendString(T9_, fullPath);
		liMessage__msgs_1117((*g).config, unpacked, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T9_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__uKdnhBV2kyIqxt9av3iBrww_3, NIM_FALSE);
		goto BeforeRet_;
	}
	LA7_: ;
	fileId = getKeyId__icZnavigator_327((*g).packed_0->data[mid].fromDisk.strings, fullPath);
	{
		if (!(fileId == ((NU32) 0))) goto LA12_;
		internalErrorImpl__msgs_1430((*g).config, unpacked, ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_5), TM__uKdnhBV2kyIqxt9av3iBrww_6);
		goto BeforeRet_;
	}
	LA12_: ;
	...
	c.trackPos.file = fileId;
	{
		NIM_BOOL T16_;
		T16_ = (NIM_BOOL)0;
		T16_ = isDefined__options_2279((*g).config, ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_7));
		if (!T16_) goto LA17_;
		c.outputSep = 32;
	}
	goto LA14_;
	...
	LA14_: ;
	symId = search__icZnavigator_60((&c), (*g).packed_0->data[mid].fromDisk.topLevel);
	{
		NIM_BOOL T22_;
		T22_ = (NIM_BOOL)0;
		T22_ = eqeq___ast_773(symId, EmptyItemId__icZnavigator_59);
		if (!T22_) goto LA23_;
		symId = search__icZnavigator_60((&c), (*g).packed_0->data[mid].fromDisk.bodies);
	}
	LA23_: ;
	{
		NIM_BOOL T27_;
		T27_ = (NIM_BOOL)0;
		T27_ = eqeq___ast_773(symId, EmptyItemId__icZnavigator_59);
		if (!T27_) goto LA28_;
		liMessage__msgs_1117((*g).config, unpacked, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__uKdnhBV2kyIqxt9av3iBrww_8), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__uKdnhBV2kyIqxt9av3iBrww_9, NIM_FALSE);
		goto BeforeRet_;
	}
	LA28_: ;
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				{
					c.thisModule = ((NI32) (i));
					list__icZnavigator_244((&c), (*g).packed_0->data[i].fromDisk.topLevel, symId);
					list__icZnavigator_244((&c), (*g).packed_0->data[i].fromDisk.bodies, symId);
				}
				break;
				}
				res += ((NI) 1);
