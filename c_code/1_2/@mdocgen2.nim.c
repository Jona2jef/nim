...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, shouldProcess__docgen50_14)(tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg* g);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpenTex__docgen50_91)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	T1_ = NIM_NIL;
	T1_ = toFullPath__msgs_538((*graph).config, ((NI32) ((*module).position)));
	d = newDocumentor__docgen_352(T1_, (*graph).cache, (*graph).config, ((NimStringDesc*) &TM__87tQLGE73DKq5cz9cph1IqQ_3), module, NIM_FALSE);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, shouldProcess__docgen50_14)(tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg* g) {
	...
	if (!(T3_)) goto LA4_;
	T5_ = (NI)0;
	T5_ = getnimblePkgId__ast_3161((*g).module);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processNode__docgen50_60)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	g = ((tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*) (c));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = shouldProcess__docgen50_14(g);
		if (!T3_) goto LA4_;
		generateDoc__docgen_5366((*g).doc, n, n, ((tyEnum_DocFlags__n80LVfoJIDYz0UaY4RmOog) 0));
	}
	LA4_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, close__docgen50_27)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	groupedToc = NIM_TRUE;
	{
		...
		T3_ = shouldProcess__docgen50_14(g);
		if (!T3_) goto LA4_;
		finishGenerateDoc__docgen_5479(&(*g).doc);
		writeOutput__docgen_7175((*g).doc, useWarning, groupedToc);
		...
		generateIndex__docgen_7153((*g).doc);
		popSafePoint();
		}
		else {
			popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpenJson__docgen50_101)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	T1_ = NIM_NIL;
	T1_ = toFullPath__msgs_538((*graph).config, ((NI32) ((*module).position)));
	d = newDocumentor__docgen_352(T1_, (*graph).cache, (*graph).config, ((NimStringDesc*) &TM__87tQLGE73DKq5cz9cph1IqQ_5), module, NIM_FALSE);
	(*d).Sup.hasToc = NIM_TRUE;
	asgnRef((void**) (&(*g).doc), d);
	result = &g->Sup;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processNodeJson__docgen50_65)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	g = ((tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*) (c));
	{
		...
		T3_ = shouldProcess__docgen50_14(g);
		if (!T3_) goto LA4_;
		generateJson__docgen_5813((*g).doc, n, NIM_FALSE);
	}
	LA4_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, closeJson__docgen50_48)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	groupedToc = NIM_TRUE;
	{
		...
		if (!T3_) goto LA4_;
		finishGenerateDoc__docgen_5479(&(*g).doc);
		writeOutputJson__docgen_7201((*g).doc, useWarning);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpen__docgen50_72)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	T1_ = NIM_NIL;
	T1_ = toFullPath__msgs_538((*graph).config, ((NI32) ((*module).position)));
	d = newDocumentor__docgen_352(T1_, (*graph).cache, (*graph).config, ((NimStringDesc*) &TM__87tQLGE73DKq5cz9cph1IqQ_7), module, NIM_FALSE);
	(*d).Sup.hasToc = NIM_TRUE;
	asgnRef((void**) (&(*g).doc), d);
	result = &g->Sup;
	return result;
