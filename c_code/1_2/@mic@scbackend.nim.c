...
N_LIB_PRIVATE N_NIMCALL(tySequence__0a6ZbC0zPSfUDYzqPnO68A*, computeAliveSyms__icZdce_1785)(tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
N_LIB_PRIVATE N_NIMCALL(void, setupBackendModule__icZcbackend_24)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_LoadedModule__14iJKkvOiWT62KF2D8f9c5w* m);
N_LIB_PRIVATE N_NIMCALL(tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA*, newModuleList__cgendata_374)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TCGen__9cG6VsX22pOhho6kxyhFVow*, newModule__cgen_28277)(tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA* g, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, aliveSymsChanged__icZcbackend_337)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config, NI position, tySequence__0a6ZbC0zPSfUDYzqPnO68A* alive);
...
N_LIB_PRIVATE N_NIMCALL(void, sort__icZcbackend_232)(NI32* a, NI aLen_0, tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA order);
N_LIB_PRIVATE N_NIMCALL(void, sort__icZcbackend_242)(NI32* a, NI aLen_0, tyProc__CBoNLvw7Pjo72NRN8hQDEA cmp, tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA order);
N_LIB_PRIVATE N_NIMCALL(tySequence__48JTohSgTy339bRxHzUD8KA*, newSeq__icZic_3545)(NI len);
N_LIB_PRIVATE N_NIMCALL(void, mergeAlt__icZcbackend_260)(NI32* a, NI aLen_0, NI32* b, NI bLen_0, NI lo, NI m, NI hi, tyProc__CBoNLvw7Pjo72NRN8hQDEA cmp, tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA order);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqeq___icZcbackend_416)(tySequence__48JTohSgTy339bRxHzUD8KA* x, tySequence__48JTohSgTy339bRxHzUD8KA* y);
static N_INLINE(void*, seqToPtr__icZcbackend_431)(tySequence__48JTohSgTy339bRxHzUD8KA* x);
N_LIB_PRIVATE N_NIMCALL(void, storeAliveSymsImpl__icZcbackend_158)(NimStringDesc* asymFile, tySequence__48JTohSgTy339bRxHzUD8KA* s);
...
N_LIB_PRIVATE N_NIMCALL(void, genPackedModule__icZcbackend_452)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NI i, tySequence__0a6ZbC0zPSfUDYzqPnO68A** alive);
N_LIB_PRIVATE N_NIMCALL(void, storeAliveSyms__icZcbackend_167)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config, NI position, tySequence__0a6ZbC0zPSfUDYzqPnO68A* alive);
N_LIB_PRIVATE N_NIMCALL(void, generateCodeForModule__icZcbackend_39)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_LoadedModule__14iJKkvOiWT62KF2D8f9c5w* m, tySequence__0a6ZbC0zPSfUDYzqPnO68A** alive);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, unpackTree__icZcbackend_17)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NI thisModule, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n);
...
N_LIB_PRIVATE N_NIMCALL(void, genTopLevelStmt__cgen_28402)(tyObject_TCGen__9cG6VsX22pOhho6kxyhFVow* m, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
N_LIB_PRIVATE N_NIMCALL(void, finalCodegenActions__cgen_28455)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TCGen__9cG6VsX22pOhho6kxyhFVow* m, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
N_LIB_PRIVATE N_NIMCALL(tySet_tyEnum_ModuleBackendFlag__fgnyOEZ7Q9aYVj8O59afcT4g, whichInitProcs__cgen_27249)(tyObject_TCGen__9cG6VsX22pOhho6kxyhFVow* m);
...
N_LIB_PRIVATE N_NIMCALL(void, addFileToLink__icZcbackend_142)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m);
...
N_LIB_PRIVATE N_NIMCALL(void, replayTypeInfo__icZcbackend_64)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_LoadedModule__14iJKkvOiWT62KF2D8f9c5w* m, NI32 origin);
...
N_LIB_PRIVATE N_NIMCALL(void, registerInitProcs__cgen_27207)(tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA* g, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m, tySet_tyEnum_ModuleBackendFlag__fgnyOEZ7Q9aYVj8O59afcT4g flags);
...
N_LIB_PRIVATE N_NIMCALL(void, setupBackendModule__icZcbackend_24)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_LoadedModule__14iJKkvOiWT62KF2D8f9c5w* m) {
	tyObject_TCGen__9cG6VsX22pOhho6kxyhFVow* bmod;
	{
		...
		T5_ = NIM_NIL;
		T5_ = newModuleList__cgendata_374(g);
		asgnRef((void**) (&(*g).backend), &T5_->Sup);
	}
	LA3_: ;
	bmod = newModule__cgen_28277((*((tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA**) (&((*g).backend)))), (*m).module, (*g).config);
	asgnRef((void**) (&(*bmod).Sup.idgen), idgenFromLoadedModule__icZic_9150((&(*m))));
}
static N_INLINE(NI, len__nilcheck_1772)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s) {
	NI result;
	result = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(void, sort__icZcbackend_242)(NI32* a, NI aLen_0, tyProc__CBoNLvw7Pjo72NRN8hQDEA cmp, tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA order) {
	...
	NI s;
	n = aLen_0;
	b = newSeq__icZic_3545(((NI) ((NI)(n / ((NI) 2)))));
	s = ((NI) 1);
	{
		while (1) {
			NI m;
			...
			m = (NI)((NI)(n - ((NI) 1)) - s);
			{
				while (1) {
					if (!(((NI) 0) <= m)) goto LA4;
					mergeAlt__icZcbackend_260(a, aLen_0, b->data, (b ? b->Sup.len : 0), (((NI)((NI)(m - s) + ((NI) 1)) >= ((NI) 0)) ? (NI)((NI)(m - s) + ((NI) 1)) : ((NI) 0)), m, (NI)(m + s), cmp, order);
					m -= (NI)(s * ((NI) 2));
				} LA4: ;
			}
			s = (NI)(s * ((NI) 2));
...
N_LIB_PRIVATE N_NIMCALL(void, sort__icZcbackend_232)(NI32* a, NI aLen_0, tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA order) {
	...
	T1_.ClP_0 = ((TM__4mviS22ZpOxj1cka2xgDmg_5) (cmp__int495056_283)); T1_.ClE_0 = NIM_NIL;
	sort__icZcbackend_242(a, aLen_0, T1_, order);
}
static N_INLINE(void*, seqToPtr__icZcbackend_431)(tySequence__48JTohSgTy339bRxHzUD8KA* x) {
	void* result;
	result = (void*)0;
...
{	result = (NIM_BOOL)0;
	{
		...
		void* T4_;
		T3_ = (void*)0;
		T3_ = seqToPtr__icZcbackend_431(x);
		T4_ = (void*)0;
		T4_ = seqToPtr__icZcbackend_431(y);
...
N_LIB_PRIVATE N_NIMCALL(void, storeAliveSymsImpl__icZcbackend_158)(NimStringDesc* asymFile, tySequence__48JTohSgTy339bRxHzUD8KA* s) {
	...
	f = create__icZrodfiles_281(asymFile);
	storeHeader__icZrodfiles_109((&f));
	storeSection__icZrodfiles_198((&f), ((tyEnum_RodSection__UqBXi9atUziBvBoi1Bm6kuA) 27));
	storeSeq__icZic_4739((&f), s);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, aliveSymsChanged__icZcbackend_337)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config, NI position, tySequence__0a6ZbC0zPSfUDYzqPnO68A* alive) {
	...
	result = (NIM_BOOL)0;
	T1_ = NIM_NIL;
	T1_ = toFullPath__msgs_538(config, ((NI32) (position)));
	asymFile = toRodFile__options_4242(config, T1_, ((NimStringDesc*) &TM__4mviS22ZpOxj1cka2xgDmg_2));
	T2_ = (NI)0;
	T2_ = len__nilcheck_1772((&alive->data[position]));
							...
							j = ((NI) 0);
							{
								while (1) {
									if (!!((w == ((NU) 0)))) goto LA18;
									{
										...
										T23_ = (NI)0;
										T23_ = pluspercent___system_696((NI)((NU64)(i_3) << (NU64)(((NI) 6))), j);
	...
	sort__icZcbackend_232(s->data, (s ? s->Sup.len : 0), ((tyEnum_SortOrder__8iBc6wlNqBa9cju9cUAhUAxA) 1));
	f2 = open__icZrodfiles_286(asymFile);
	loadHeader__icZrodfiles_138((&f2));
	loadSection__icZrodfiles_247((&f2), ((tyEnum_RodSection__UqBXi9atUziBvBoi1Bm6kuA) 27));
	oldData = NIM_NIL;
	loadSeq__icZic_3530((&f2), (&oldData));
	close__icZrodfiles_284((&f2));
	{
		NIM_BOOL T27_;
		T27_ = (NIM_BOOL)0;
		T27_ = (f2.err == ((tyEnum_RodFileError__0ZHDewZuAfbVKILlFg9cYCQ) 0));
		if (!(T27_)) goto LA28_;
		T27_ = eqeq___icZcbackend_416(oldData, s);
		LA28_: ;
		if (!T27_) goto LA29_;
		result = NIM_FALSE;
	}
	...
	{
		result = NIM_TRUE;
		storeAliveSymsImpl__icZcbackend_158(asymFile, s);
	}
	LA25_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, unpackTree__icZcbackend_17)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NI thisModule, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n) {
	...
	initPackedDecoder__icZic_5834((*g).config, (*g).cache, (&decoder));
	result = loadNodes__icZic_5528((&decoder), (&(*g).packed_0), thisModule, tree, n);
	return result;
}
static N_INLINE(NIM_BOOL, isAtom__icZpacked95ast_206)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI pos) {
	NIM_BOOL result;
	...
	}
	{
		...
		p_2 = ((NI) 0);
		{
			while (1) {
				...
				NI s;
				T5_ = (NI)0;
				T5_ = len__icZpacked95ast_293((*m).fromDisk.topLevel);
				if (!(p_2 < T5_)) goto LA4;
				p = p_2;
				n = unpackTree__icZcbackend_17(g, (*(*m).module).position, (*m).fromDisk.topLevel, p);
				genTopLevelStmt__cgen_28402(bmod, n);
				s = span__icZpacked95ast_494((*m).fromDisk.topLevel, p_2);
				p_2 += s;
			} LA4: ;
		}
	}
	T6_ = NIM_NIL;
	T6_ = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*(*m).module).info);
	finalCodegenActions__cgen_28455(g, bmod, T6_);
	(*m).fromDisk.backendFlags = whichInitProcs__cgen_27249(bmod);
}
N_LIB_PRIVATE N_NIMCALL(void, addFileToLink__icZcbackend_142)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m) {
	NimStringDesc* filename;
	NimStringDesc* ext;
	...
	NimStringDesc* T11_;
	filename = toFullPath__msgs_538(config, ((NI32) ((*m).position)));
	{
	...
	LA1_: ;
	T9_ = NIM_NIL;
	T9_ = withPackageName__options_4164(config, filename);
	T10_ = NIM_NIL;
	T10_ = completeCfilePath__extccomp_713(config, T9_, NIM_TRUE);
	cfile = noschangeFileExt(T10_, ext);
	T11_ = NIM_NIL;
	T11_ = toObjFile__extccomp_718(config, cfile);
	objFile = completeCfilePath__extccomp_713(config, T11_, NIM_TRUE);
	{
		NIM_BOOL T14_;
		...
		cf.flags = 1;
		addFileToCompile__extccomp_722(config, (&cf));
	}
	LA15_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, replayTypeInfo__icZcbackend_64)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_LoadedModule__14iJKkvOiWT62KF2D8f9c5w* m, NI32 origin) {
	{
		...
		L = T2_;
		{
			while (1) {
				...
				X5BX5Deq___lineinfos_387((&(*g).emittedTypeInfo), (*x), origin);
				i += ((NI) 1);
			} LA4: ;
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(void, genPackedModule__icZcbackend_452)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NI i, tySequence__0a6ZbC0zPSfUDYzqPnO68A** alive) {
	...
	{
		storeAliveSyms__icZcbackend_167((*g).config, (*(*g).packed_0->data[i].module).position, (*alive));
		generateCodeForModule__icZcbackend_39(g, (&(*g).packed_0->data[i]), alive);
		closeRodFile__modulegraphs_9427(g, (*g).packed_0->data[i].module);
	}
	break;
	case ((tyEnum_ModuleStatus__MgSLMPwZ4GVYYz7Kn9bmm6Q) 3):
	{
		...
		LA7_: ;
		{
			addFileToLink__icZcbackend_142((*g).config, (*g).packed_0->data[i].module);
			replayTypeInfo__icZcbackend_64(g, (&(*g).packed_0->data[i]), ((NI32) (i)));
			{
				tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA* T14_;
				if (!((*g).backend == ((RootObj*) NIM_NIL))) goto LA12_;
				T14_ = NIM_NIL;
				T14_ = newModuleList__cgendata_374(g);
				asgnRef((void**) (&(*g).backend), &T14_->Sup);
			}
			LA12_: ;
			registerInitProcs__cgen_27207((*((tyObject_BModuleListcolonObjectType___CpP4eJLbv5ZwofQXpESuGA**) (&((*g).backend)))), (*g).packed_0->data[i].module, (*g).packed_0->data[i].fromDisk.backendFlags);
		}
		LA5_: ;
	}
	break;
...
N_LIB_PRIVATE N_NIMCALL(void, generateCode__icZcbackend_463)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g) {
	...
	NI mainModuleIdx;
	resetForBackend__modulegraphs_265(g);
	alive = computeAliveSyms__icZdce_1785((*g).packed_0, (*g).config);
	{
		NI i;
		NI colontmp_;
		NI T2_;
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				case ((tyEnum_ModuleStatus__MgSLMPwZ4GVYYz7Kn9bmm6Q) 4):
				{
					setupBackendModule__icZcbackend_24(g, (&(*g).packed_0->data[i]));
				}
				break;
				case ((tyEnum_ModuleStatus__MgSLMPwZ4GVYYz7Kn9bmm6Q) 3):
				{
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = aliveSymsChanged__icZcbackend_337((*g).config, (*(*g).packed_0->data[i].module).position, alive);
						if (!T11_) goto LA12_;
		...
		res_2 = ((NI) 0);
		{
			while (1) {
				...
				i_2 = res_2;
				{
					...
					genPackedModule__icZcbackend_452(g, i_2, (&alive));
				}
				LA20_: ;
				res_2 += ((NI) 1);
			} LA17: ;
	...
	}
	{
		...
		genPackedModule__icZcbackend_452(g, mainModuleIdx, (&alive));
	}
	LA24_: ;
}
