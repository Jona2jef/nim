...
static N_INLINE(NIM_BOOL, stopCompile__modulegraphs_8999)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g);
static N_INLINE(void, nimZeroMem)(void* p, NI size);
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size);
N_LIB_PRIVATE N_NIMCALL(void, objectInit)(void* dest, TNimType* typ);
N_LIB_PRIVATE N_NIMCALL(void, prepareConfigNotes__passes_199)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module);
N_LIB_PRIVATE N_NIMCALL(NI, getnimblePkgId__ast_3161)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* a);
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size);
static N_INLINE(int, nimCmpMem)(void* a, void* b, NI size);
N_LIB_PRIVATE N_NIMCALL(void, openPasses__passes_85)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w** a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen);
...
N_LIB_PRIVATE N_NIMCALL(NI32, resolveMod__passes_160)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* module, NimStringDesc* relativeTo);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, processTopLevelStmt__passes_138)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w** a);
...
N_LIB_PRIVATE N_NIMCALL(void, closePasses__passes_121)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w** a);
...
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_6, "/home/runner/work/nightlies/nightlies/nim/compiler/passes.nim", 61);
...
N_LIB_PRIVATE N_NIMCALL(NI32, resolveMod__passes_160)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* module, NimStringDesc* relativeTo) {
	...
	NimStringDesc* fullPath;
	result = (NI32)0;
	fullPath = findModule__options_4501(conf, module, relativeTo);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty__options_4486(fullPath);
		if (!T3_) goto LA4_;
		result = ((NI32) -1);
	}
	goto LA1_;
	LA4_: ;
	{
		result = fileInfoIdx__msgs_376(conf, fullPath);
	}
	LA1_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, processImplicits__passes_169)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tySequence__sM4lkSb7zS6F7OVMvW9cffQ* implicits, tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw nodeKind, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w** a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m) {
	...
	relativeTo = toFullPath__msgs_538((*graph).config, (*m).info.fileIndex);
	{
		...
		L = T2_;
		{
			while (1) {
				...
				module = (&implicits->data[i]);
				{
					...
					T7_ = (NI32)0;
					T7_ = resolveMod__passes_160((*graph).config, (*module), relativeTo);
					if (!!(((*m).position == ((NI) (T7_))))) goto LA8_;
					importStmt = newNodeI__ast_3356(nodeKind, (*m).info);
					str = newStrNode__ast_3813(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 20), (*module));
					(*str).info = (*m).info;
					add__ast_4797(importStmt, str);
					{
						NIM_BOOL T12_;
						T12_ = (NIM_BOOL)0;
						T12_ = processTopLevelStmt__passes_138(graph, importStmt, a);
						if (!!(T12_)) goto LA13_;
						goto LA1;
					}
					LA13_: ;
...
{	result = (NIM_BOOL)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = stopCompile__modulegraphs_8999(graph);
		if (!T3_) goto LA4_;
		result = NIM_TRUE;
		goto BeforeRet_;
	}
	...
	prepareConfigNotes__passes_199(graph, module);
	openPasses__passes_85(graph, a, module, idgen);
	{
		NimStringDesc* filename;
		if (!(stream == ((tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*) NIM_NIL))) goto LA8_;
		filename = toFullPathConsiderDirty__msgs_571((*graph).config, fileIdx);
		s = llStreamOpen__llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
		{
			if (!(s == ((tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*) NIM_NIL))) goto LA12_;
			liMessage__msgs_1117((*graph).config, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 4), filename, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Tko7U9cii9bC6Kt2otnwMmCg_5, NIM_FALSE);
			result = NIM_FALSE;
			goto BeforeRet_;
		}
		LA12_: ;
	...
	{
		while (1) {
			openParser__syntaxes_189((&p), fileIdx, s, (*graph).cache, (*graph).config);
			{
				NIM_BOOL T19_;
				NIM_BOOL T20_;
				T19_ = (NIM_BOOL)0;
				T20_ = (NIM_BOOL)0;
				T20_ = partOfStdlib__passes_211(module);
				T19_ = !(T20_);
				if (T19_) goto LA21_;
				...
				if (!T19_) goto LA22_;
				{
					...
					processImplicits__passes_169(graph, (*(*graph).config).implicitImports, ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 116), a, module);
					processImplicits__passes_169(graph, (*(*graph).config).implicitIncludes, ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 121), a, module);
				}
				LA26_: ;
			}
			LA22_: ;
			{
				while (1) {
					tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n;
					{
						NIM_BOOL T32_;
						T32_ = (NIM_BOOL)0;
						T32_ = stopCompile__modulegraphs_8999(graph);
						if (!T32_) goto LA33_;
						goto LA28;
					}
					LA33_: ;
					n = parseTopLevelStmt__parser_41((&p));
					{
					...
					LA37_: ;
					{
						...
						LA42_: ;
						if (!T41_) goto LA45_;
						sl = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*n).info);
						add__ast_4797(sl, n);
						{
							while (1) {
								tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n_2;
								n_2 = parseTopLevelStmt__parser_41((&p));
								{
									if (!((*n_2).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1))) goto LA51_;
									goto LA47;
								}
								LA51_: ;
								add__ast_4797(sl, n_2);
							}
						} LA47: ;
						{
							NIM_BOOL T55_;
							...
							LA56_: ;
							if (!T55_) goto LA57_;
							sl = reorder__reorder_930(graph, sl, module);
						}
						LA57_: ;
						T59_ = (NIM_BOOL)0;
						T59_ = processTopLevelStmt__passes_138(graph, sl, a);
						(void)(T59_);
						goto LA28;
					}
					goto LA39_;
					LA45_: ;
					{
						...
						sl_2 = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*n).info);
						add__ast_4797(sl_2, n);
						rest = ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL);
						{
							while (1) {
								tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n_3;
								n_3 = parseTopLevelStmt__parser_41((&p));
								{
									NIM_BOOL T67_;
									T67_ = (NIM_BOOL)0;
								...
								LA69_: ;
								add__ast_4797(sl_2, n_3);
							}
						} LA63: ;
						{
							NIM_BOOL T73_;
							T73_ = (NIM_BOOL)0;
							T73_ = processTopLevelStmt__passes_138(graph, sl_2, a);
							if (!!(T73_)) goto LA74_;
							goto LA28;
						}
						LA74_: ;
						{
							if (!!((rest == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA78_;
							{
								NIM_BOOL T82_;
								T82_ = (NIM_BOOL)0;
								T82_ = processTopLevelStmt__passes_138(graph, rest, a);
								if (!!(T82_)) goto LA83_;
								goto LA28;
							}
							LA83_: ;
					...
					{
						{
							NIM_BOOL T88_;
							T88_ = (NIM_BOOL)0;
							T88_ = processTopLevelStmt__passes_138(graph, n, a);
							if (!!(T88_)) goto LA89_;
							goto LA28;
						}
						LA89_: ;
	...
	closePasses__passes_121(graph, a);
	{
		if (!!(((22 &((NU8)1<<((NU)((*(*graph).config).backend)&7U)))!=0))) goto LA97_;
		closeRodFile__modulegraphs_9427(graph, module);
	}
	LA97_: ;
	result = NIM_TRUE;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, registerPass__passes_61)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyTuple__4o9cW9aUwdGqgZI9bSHHYnbaQ* p) {
	NI T6_;
	{
		...
		argX60gensym1_ = toFileLineCol__msgs_615(TM__Tko7U9cii9bC6Kt2otnwMmCg_13);
		internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_280, argX60gensym1_, TM__Tko7U9cii9bC6Kt2otnwMmCg_13);
	}
	LA4_: ;
