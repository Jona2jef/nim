...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genEnumToStrProc__enumtostr_6)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	result = NIM_NIL;
	T1_ = NIM_NIL;
	T1_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_2));
	T2_ = nextSymId__ast_3132(idgen);
	result = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), T1_, T2_, (*t).owner, info, 0);
	T3_ = NIM_NIL;
	T3_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_3));
	T4_ = nextSymId__ast_3132(idgen);
	dest = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 3), T3_, T4_, result, info, 0);
	asgnRef((void**) (&(*dest).typ), t);
	T5_ = NIM_NIL;
	T5_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_4));
	T6_ = nextSymId__ast_3132(idgen);
	res = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 11), T5_, T6_, result, info, 0);
	asgnRef((void**) (&(*res).typ), getSysType__magicsys_60(g, info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 28)));
	T7_ = nextTypeId__ast_3151(idgen);
	asgnRef((void**) (&(*result).typ), newType__ast_3896(((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 25), T7_, (*t).owner));
	asgnRef((void**) (&(*(*result).typ).n), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 76), info));
	rawAddSon__ast_4288((*result).typ, (*res).typ, NIM_TRUE);
	T8_ = NIM_NIL;
	T8_ = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152), info);
	add__ast_4797((*(*result).typ).n, T8_);
	addParam__ast_5065((*result).typ, dest);
	body = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), info);
	caseStmt = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 97), info);
	T9_ = NIM_NIL;
	T9_ = newSymNode__ast_3716(dest);
	add__ast_4797(caseStmt, T9_);
	{
		NI i;
		NI colontmp_;
		NI i_2;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				T18_[0] = newSymNode__ast_3716(field);
				...
				T20_[0] = newSymNode__ast_3716(res);
				T20_[1] = newStrNode__ast_3817(val, info);
				T19_[0] = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 74), T20_, 2);
				T18_[1] = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), T19_, 1);
				T21_ = NIM_NIL;
				T21_ = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 85), T18_, 2);
				add__ast_4797(caseStmt, T21_);
				i_2 += ((NI) 1);
			} LA12: ;
		}
	}
	add__ast_4797(body, caseStmt);
	n = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), info, ((NI) 8));
	{
		NI i_3;
		NI colontmp__2;
		NI i_4;
		...
		i_4 = ((NI) 0);
		{
			while (1) {
				...
				i_3 = i_4;
				asgnRef((void**) (&(*n)._kind_6.sons->data[i_3]), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), info));
				i_4 += ((NI) 1);
			} LA24: ;
		}
	}
	...
	asgnRef((void**) (&(*n)._kind_6.sons->data[((NI) 7)]), newSymNode__ast_3716(res));
