...
break;
		...
		LA28_: ;
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				liMessage__msgs_1117((*p).config, (*p).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__paI0W78l0CRDBLjAHJxn6w_36), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__paI0W78l0CRDBLjAHJxn6w_37, NIM_FALSE);
			}
			LA35_: ;
			T40_ = NIM_NIL;
		...
		LA29_: ;
		{
			...
			T43_ = NIM_NIL;
			T43_ = substr__system_7821((*p).x, d);
		...
		LA30_: ;
		{
			...
			T46_ = NIM_NIL;
			T46_ = substr__system_7821((*p).x, d);
		...
		LA31_: ;
		{
			...
			T49_ = NIM_NIL;
			T49_ = substr__system_7821((*p).x, d);
		...
		LA32_: ;
		{
			...
			T57_ = NIM_NIL;
			T57_ = substr__system_7821((*p).x, d);
				...
				{
					{
						...
						case 123:
						{
							...
							} LA76: ;
							{
								...
								liMessage__msgs_1117((*p).config, (*p).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__paI0W78l0CRDBLjAHJxn6w_47), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__paI0W78l0CRDBLjAHJxn6w_48, NIM_FALSE);
								goto LA63;
							}
							LA91_: ;
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								liMessage__msgs_1117((*p).config, (*p).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__paI0W78l0CRDBLjAHJxn6w_49), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__paI0W78l0CRDBLjAHJxn6w_50, NIM_FALSE);
							}
							LA99_: ;
						}
						break;
