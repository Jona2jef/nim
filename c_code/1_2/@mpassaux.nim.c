...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___passaux_38)(tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q x);
...
N_LIB_PRIVATE N_NIMCALL(void, addQuoted__passaux_91)(NimStringDesc** s, NIM_BOOL x);
...
STRING_LITERAL(TM__WN2DmcgfohRZOHm9avzMtLw_11, "/home/runner/work/nightlies/nightlies/nim/compiler/passaux.nim", 62);
...
appendString(result, ((NimStringDesc*) &TM__WN2DmcgfohRZOHm9avzMtLw_5));
	count += ((NI) 1);
	addQuoted__modulegraphs_3437((&result), x.symId);
	{
...
appendString(result, ((NimStringDesc*) &TM__WN2DmcgfohRZOHm9avzMtLw_5));
	count += ((NI) 1);
	addQuoted__modulegraphs_3437((&result), x.typeId_0);
	{
...
appendString(result, ((NimStringDesc*) &TM__WN2DmcgfohRZOHm9avzMtLw_5));
	count += ((NI) 1);
	addQuoted__passaux_91((&result), x.sealed);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, verboseProcess__passaux_33)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* context, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	T1_ = NIM_NIL;
	T1_ = dollar___passaux_38((*(*v).Sup.idgen));
	liMessage__msgs_1117((*v).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 80), T1_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__WN2DmcgfohRZOHm9avzMtLw_10, NIM_FALSE);
	return result;
}
