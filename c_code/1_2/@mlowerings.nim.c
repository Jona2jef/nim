...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, indirectAccess__lowerings_492)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g b, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, lookupInRecord__lowerings_371)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g id);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newTupleAccessRaw__lowerings_189)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* tup, NI i);
...
STRING_LITERAL(TM__mTxj9crs9bTRS87wn5yEjeFA_12, "/home/runner/work/nightlies/nightlies/nim/compiler/lowerings.nim", 64);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__facALICuu8zUj0hjvbTLFg*, createObj__lowerings_288)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* owner, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, NIM_BOOL final) {
	...
	result = newType__ast_3896(((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 17), T1_, owner);
	{
		if (!final) goto LA4_;
	...
	LA4_: ;
	{
		...
		T7_ = NIM_NIL;
		T7_ = getCompilerProc__magicsys_145(g, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_2));
		rawAddSon__ast_4288(result, (*T7_).typ, NIM_TRUE);
	}
	LA2_: ;
	asgnRef((void**) (&(*result).n), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 138), info));
	T8_ = NIM_NIL;
	T9_ = NIM_NIL;
	{
		NIM_BOOL T12_;
...
appendString(T8_, (*(*owner).name).s);
	T22_ = NIM_NIL;
	T22_ = getIdent__idents_143((*g).cache, T8_);
	T23_ = nextSymId__ast_3132(idgen);
	s = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 7), T22_, T23_, owner, info, (*owner).options);
...
N_LIB_PRIVATE N_NIMCALL(void, rawAddField__lowerings_309)(tyObject_TType__facALICuu8zUj0hjvbTLFg* obj, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* field) {
	...
	(*field).position = len__ast_3198((*obj).n);
	T1_ = NIM_NIL;
	T1_ = newSymNode__ast_3716(field);
	add__ast_4797((*obj).n, T1_);
	propagateToOwner__ast_4219(obj, (*field).typ, NIM_TRUE);
}
static N_INLINE(tyObject_TType__facALICuu8zUj0hjvbTLFg*, skipIntLit__magicsys_124)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* id) {
	tyObject_TType__facALICuu8zUj0hjvbTLFg* result;
	result = NIM_NIL;
...
appendString(T1_, T3_);
	T4_ = NIM_NIL;
	T4_ = getIdent__idents_143(cache, T1_);
	T5_ = nextSymId__ast_3132(idgen);
	field = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 19), T4_, T5_, (*s).owner, (*s).info, (*s).options);
	...
	t = skipIntLit__magicsys_124((*s).typ, idgen);
	asgnRef((void**) (&(*field).typ), t);
	propagateToOwner__ast_4219(obj, t, NIM_TRUE);
	(*field).position = len__ast_3198((*obj).n);
	(*field).flags = ((*s).flags & IL64(2199023255552));
	T7_ = NIM_NIL;
	T7_ = newSymNode__ast_3716(field);
	add__ast_4797((*obj).n, T7_);
}
N_LIB_PRIVATE N_NIMCALL(void, addVar__lowerings_63)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* father, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* v) {
	...
	vpart = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 35), (*v).info, ((NI) 3));
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 0)]), v);
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 1)]), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*v).info));
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 2)]), (*vpart)._kind_6.sons->data[((NI) 1)]);
	add__ast_4797(father, vpart);
}
N_LIB_PRIVATE N_NIMCALL(void, addVar__lowerings_75)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* father, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* v, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* value) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* vpart;
	vpart = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 35), (*v).info, ((NI) 3));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newIntLit__lowerings_695)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, NI64 value) {
	...
	result = NIM_NIL;
	result = newIntNode__ast_3723(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 6), value);
	asgnRef((void**) (&(*result).typ), getSysType__magicsys_60(g, info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 31)));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genLen__lowerings_710)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = NIM_NIL;
	{
		...
		T7_ = lastOrd__types_1470((*g).config, T6_);
		T8_ = plus___int495056_794(T7_, IL64(1));
		T9_ = (NI64)0;
		T9_ = toInt64__int495056_88(T8_);
		result = newIntLit__lowerings_695(g, (*n).info, T9_);
	}
	goto LA1_;
	LA4_: ;
	{
		...
		asgnRef((void**) (&(*result).typ), getSysType__magicsys_60(g, (*n).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 31)));
		T11_ = NIM_NIL;
		T11_ = getSysMagic__magicsys_29(g, (*n).info, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_8), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 39));
		asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 0)]), newSymNode__ast_3716(T11_));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genDeref__lowerings_626)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw k) {
	...
	result = newNodeIT__ast_3378(k, (*n).info, (*T1_).sons->data[((NI) 0)]);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, callCodegenProc__lowerings_635)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NimStringDesc* name, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* arg1, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* arg2, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* arg3, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* optionalArgs) {
	...
	sym = getCompilerProc__magicsys_145(g, name);
	{
		NimStringDesc* T5_;
...
appendString(T5_, name);
		liMessage__msgs_1117((*g).config, info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T5_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__mTxj9crs9bTRS87wn5yEjeFA_11, NIM_FALSE);
	}
	goto LA1_;
	LA3_: ;
	{
		...
		LA18_: ;
		{
			if (!!((optionalArgs == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA22_;
			{
				...
				colontmp_ = (NI)0;
				T25_ = (NI)0;
				T25_ = len__ast_3198(optionalArgs);
				...
				i_2 = ((NI) 1);
				{
					while (1) {
						...
						i = i_2;
						add__ast_4797(result, (*optionalArgs)._kind_6.sons->data[i]);
						i_2 += ((NI) 1);
					} LA27: ;
				}
			}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genAddrOf__lowerings_620)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag typeKind) {
	...
	tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g T1_;
	result = NIM_NIL;
	result = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 63), (*n).info, ((NI) 1));
	asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 0)]), n);
	T1_ = nextTypeId__ast_3151(idgen);
	asgnRef((void**) (&(*result).typ), newType__ast_3896(typeKind, T1_, (*(*n).typ).owner));
	rawAddSon__ast_4288((*result).typ, (*n).typ, NIM_TRUE);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, lookupInRecord__lowerings_371)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g id) {
...
{	result = NIM_NIL;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					result = lookupInRecord__lowerings_371((*n)._kind_6.sons->data[i], id);
					{
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 139):
	{
		...
		LA12_: ;
		result = lookupInRecord__lowerings_371((*n)._kind_6.sons->data[((NI) 0)], id);
		{
			...
			i_4 = ((NI) 1);
			{
				while (1) {
					...
					case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 88):
					{
						...
						result = lookupInRecord__lowerings_371(T22_, id);
						{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, indirectAccess__lowerings_492)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g b, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	result = NIM_NIL;
	deref = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 65), info);
	T1_ = NIM_NIL;
	...
	{
		while (1) {
			field = lookupInRecord__lowerings_371((*t).n, b);
			{
	...
	add__ast_4797(deref, a);
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 45), info);
	add__ast_4797(result, deref);
	T12_ = NIM_NIL;
	T12_ = newSymNode__ast_3716(field);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, indirectAccess__lowerings_610)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* b, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	result = NIM_NIL;
	result = indirectAccess__lowerings_492(a, (*b).Sup.itemId, info);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, rawIndirectAccess__lowerings_326)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* field, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	add__ast_4797(result, deref);
	T2_ = NIM_NIL;
	T2_ = newSymNode__ast_3716(field);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, addUniqueField__lowerings_443)(tyObject_TType__facALICuu8zUj0hjvbTLFg* obj, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	result = NIM_NIL;
	result = lookupInRecord__lowerings_371((*obj).n, (*s).Sup.itemId);
	{
		tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* field;
		NimStringDesc* T5_;
		NI T6_;
		...
		T5_ = NIM_NIL;
		T6_ = (NI)0;
		T6_ = len__ast_3198((*obj).n);
		T7_ = NIM_NIL;
		T7_ = dollar___systemZdollars_3(T6_);
		T5_ = rawNewString(((*(*s).name).s ? (*(*s).name).s->Sup.len : 0) + (T7_ ? T7_->Sup.len : 0) + 0);
appendString(T5_, (*(*s).name).s);
appendString(T5_, T7_);
		T8_ = NIM_NIL;
		T8_ = getIdent__idents_143(cache, T5_);
		T9_ = nextSymId__ast_3132(idgen);
		field = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 19), T8_, T9_, (*s).owner, (*s).info, (*s).options);
		...
		(*field).position = len__ast_3198((*obj).n);
		T11_ = NIM_NIL;
		T11_ = newSymNode__ast_3716(field);
		add__ast_4797((*obj).n, T11_);
		result = field;
	}
	LA3_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getFieldFromObj__lowerings_582)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* v) {
	...
	{
		while (1) {
			result = lookupInRecord__lowerings_371((*t_2).n, (*v).Sup.itemId);
			{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newTupleAccess__lowerings_19)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* tup, NI i) {
	...
	result = NIM_NIL;
	{
		...
		result = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 64), (*tup).info, T5_);
		T6_ = NIM_NIL;
		T6_ = skipTypes__ast_3735((*tup).typ, TM__mTxj9crs9bTRS87wn5yEjeFA_14);
		T7_ = NIM_NIL;
		T7_ = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 42), (*tup).info, (*T6_).sons->data[i]);
		add__ast_4797(result, T7_);
		add__ast_4797((*result)._kind_6.sons->data[((NI) 0)], (*tup)._kind_6.sons->data[((NI) 0)]);
		T8_ = NIM_NIL;
		T8_ = getSysType__magicsys_60(g, (*tup).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 31));
		lit = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 6), (*tup).info, T8_);
		(*lit)._kind_1.intVal = ((NI64) (i));
		add__ast_4797((*result)._kind_6.sons->data[((NI) 0)], lit);
	}
	goto LA1_;
	LA3_: ;
	{
		...
		result = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 42), (*tup).info, (*T10_).sons->data[i]);
		T11_ = NIM_NIL;
		T11_ = copyTree__ast_4431(tup);
		add__ast_4797(result, T11_);
		T12_ = NIM_NIL;
		T12_ = getSysType__magicsys_60(g, (*tup).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 31));
		lit_2 = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 6), (*tup).info, T12_);
		(*lit_2)._kind_1.intVal = ((NI64) (i));
		add__ast_4797(result, lit_2);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newFastAsgnStmt__lowerings_93)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* le, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* ri) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	result = NIM_NIL;
	result = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 74), (*le).info, ((NI) 2));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, lowerSwap__lowerings_246)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* owner) {
	...
	T1_ = NIM_NIL;
	T1_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_15));
	T2_ = nextSymId__ast_3132(idgen);
	temp = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 8), T1_, T2_, owner, (*n).info, (*owner).options);
	...
	T3_ = NIM_NIL;
	T3_ = newFastAsgnStmt__lowerings_93((*n)._kind_6.sons->data[((NI) 1)], (*n)._kind_6.sons->data[((NI) 2)]);
	add__ast_4797(result, T3_);
	T4_ = NIM_NIL;
	T4_ = newFastAsgnStmt__lowerings_93((*n)._kind_6.sons->data[((NI) 2)], tempAsNode);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, lowerTupleUnpacking__lowerings_116)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* owner) {
	...
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* tempAsNode;
	result = NIM_NIL;
	value = lastSon__ast_4832(n);
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*n).info);
	T1_ = NIM_NIL;
	T1_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_15));
	T2_ = nextSymId__ast_3132(idgen);
	temp = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 5), T1_, T2_, owner, (*value).info, (*(*g).config).options);
	asgnRef((void**) (&(*temp).typ), skipTypes__ast_3735((*value).typ, TM__mTxj9crs9bTRS87wn5yEjeFA_9));
	(*temp).flags |= ((NU64)1)<<((((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 2)) & 63);
	v = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 99), (*value).info);
	tempAsNode = newSymNode__ast_3716(temp);
	addVar__lowerings_75(v, tempAsNode, value);
	add__ast_4797(result, v);
	{
		NI i;
		NI colontmp_;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				val = newTupleAccess__lowerings_19(g, tempAsNode, i);
				{
					if (!((*(*n)._kind_6.sons->data[i]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3))) goto LA9_;
					addVar__lowerings_75(v, (*n)._kind_6.sons->data[i], val);
				}
				goto LA7_;
				LA9_: ;
				{
					tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* T12_;
					T12_ = NIM_NIL;
					T12_ = newAsgnStmt__lowerings_87((*n)._kind_6.sons->data[i], val);
					add__ast_4797(result, T12_);
				}
				LA7_: ;
				i_2 += ((NI) 1);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newTupleAccessRaw__lowerings_189)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* tup, NI i) {
	...
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* lit;
	result = NIM_NIL;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 42), (*tup).info);
	T1_ = NIM_NIL;
	T1_ = copyTree__ast_4431(tup);
	add__ast_4797(result, T1_);
	lit = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 6), (*tup).info);
	(*lit)._kind_1.intVal = ((NI64) (i));
	add__ast_4797(result, lit);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, lowerTupleUnpackingForAsgn__lowerings_206)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* owner) {
	...
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), (*n).info);
	T1_ = NIM_NIL;
	T1_ = getIdent__idents_143((*g).cache, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_6));
	T2_ = nextSymId__ast_3132(idgen);
	temp = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 5), T1_, T2_, owner, (*value).info, (*owner).options);
	v = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 100), (*value).info);
	tempAsNode = newSymNode__ast_3716(temp);
	vpart = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 35), (*tempAsNode).info, ((NI) 3));
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 0)]), tempAsNode);
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 1)]), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), (*value).info));
	asgnRef((void**) (&(*vpart)._kind_6.sons->data[((NI) 2)]), value);
	add__ast_4797(v, vpart);
	add__ast_4797(result, v);
	lhs = (*n)._kind_6.sons->data[((NI) 0)];
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				T6_ = NIM_NIL;
				T6_ = newTupleAccessRaw__lowerings_189(tempAsNode, i);
				T7_ = NIM_NIL;
				T7_ = newAsgnStmt__lowerings_87((*lhs)._kind_6.sons->data[i], T6_);
				add__ast_4797(result, T7_);
				i_2 += ((NI) 1);
			} LA5: ;
		}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newTryFinally__lowerings_202)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* body, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* final) {
	...
	T2_[0] = final;
	T1_[1] = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 107), T2_, 1);
	result = newTree__ast_3392(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 154), T1_, 2);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newDotExpr__lowerings_472)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* obj, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* b) {
	...
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* T2_;
	result = NIM_NIL;
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 45), (*obj).info);
	field = lookupInRecord__lowerings_371((*(*obj).typ).n, (*b).Sup.itemId);
	T1_ = NIM_NIL;
	T1_ = newSymNode__ast_3716(obj);
	add__ast_4797(result, T1_);
	T2_ = NIM_NIL;
	T2_ = newSymNode__ast_3716(field);
	add__ast_4797(result, T2_);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, newFastMoveStmt__lowerings_99)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* le, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* ri) {
	...
	result = newNodeI__ast_3360(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 74), (*le).info, ((NI) 2));
	asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 0)]), le);
	asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 1)]), newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 27), (*ri).info, (*ri).typ));
	T1_ = NIM_NIL;
	T1_ = getSysMagic__magicsys_29(g, (*ri).info, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_16), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 148));
	T2_ = NIM_NIL;
	T2_ = newSymNode__ast_3716(T1_);
	add__ast_4797((*result)._kind_6.sons->data[((NI) 1)], T2_);
	add__ast_4797((*result)._kind_6.sons->data[((NI) 1)], ri);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genHigh__lowerings_700)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = NIM_NIL;
	{
		...
		T7_ = lastOrd__types_1470((*g).config, T6_);
		T8_ = (NI64)0;
		T8_ = toInt64__int495056_88(T7_);
		result = newIntLit__lowerings_695(g, (*n).info, T8_);
	}
	goto LA1_;
	LA4_: ;
	{
		...
		asgnRef((void**) (&(*result).typ), getSysType__magicsys_60(g, (*n).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 31)));
		T10_ = NIM_NIL;
		T10_ = getSysMagic__magicsys_29(g, (*n).info, ((NimStringDesc*) &TM__mTxj9crs9bTRS87wn5yEjeFA_17), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 9));
		asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 0)]), newSymNode__ast_3716(T10_));
		asgnRef((void**) (&(*result)._kind_6.sons->data[((NI) 1)]), n);
	}
	LA1_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, indirectAccess__lowerings_536)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, NimStringDesc* b, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache) {
	...
	t = skipTypes__ast_3735((*deref).typ, TM__mTxj9crs9bTRS87wn5yEjeFA_9);
	field = NIM_NIL;
	bb = getIdent__idents_143(cache, b);
	{
		while (1) {
			field = getSymFromList__astalgo_245((*t).n, bb, ((NI) 0));
			{
				if (!!((field == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA6_;
				goto LA2;
			}
