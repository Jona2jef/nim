...
STRING_LITERAL(TM__BxyDeRCaUtiykBhMyyq9cqA_14, "/home/runner/work/nightlies/nightlies/nim/compiler/cmdlinehelper.nim", 68);
...
N_LIB_PRIVATE N_NIMCALL(void, initDefinesProg__cmdlinehelper_28)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* name) {
	...
	defineSymbol__condsyms_4((*conf).symbols, name, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_6));
}
static N_INLINE(int, nimCmpMem)(void* a, void* b, NI size) {
	int result;
	result = (int)0;
...
N_LIB_PRIVATE N_NIMCALL(void, processCmdLineAndProjectPath__cmdlinehelper_32)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	(*self).processCmdLine.ClE_0? (*self).processCmdLine.ClP_0(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 0), ((NimStringDesc*) NIM_NIL), conf, (*self).processCmdLine.ClE_0):((TM__BxyDeRCaUtiykBhMyyq9cqA_7)((*self).processCmdLine.ClP_0))(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 0), ((NimStringDesc*) NIM_NIL), conf);
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		handleCmdInput__commands_812(conf);
	}
	goto LA1_;
	LA5_: ;
	{
	...
	LA10_: ;
	{
		...
		setFromProjectName__options_4079(conf, (*conf).projectName);
	}
	goto LA1_;
	LA13_: ;
	{
		...
		asgnRef((void**) (&(*conf).projectPath), canonicalizePath__options_4075(conf, T16_));
	}
	LA1_: ;
}
...
{	result = (NIM_BOOL)0;
	{
		...
		setCmd__commands_829(conf, ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 11));
	}
	LA3_: ;
	{
	...
	LA7_: ;
	loadConfigs__nimconf_258(((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_9), cache, conf, (*graph).idgen);
	{
		...
		scriptFile = noschangeFileExt((*conf).projectFull, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_10));
		{
			...
			if (!(T15_)) goto LA16_;
			T15_ = eqeq___nimconf_421(scriptFile, (*conf).projectFull);
			LA16_: ;
			if (!T15_) goto LA17_;
			{
	...
	(*self).processCmdLine.ClE_0? (*self).processCmdLine.ClP_0(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1), ((NimStringDesc*) NIM_NIL), conf, (*self).processCmdLine.ClE_0):((TM__BxyDeRCaUtiykBhMyyq9cqA_11)((*self).processCmdLine.ClP_0))(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1), ((NimStringDesc*) NIM_NIL), conf);
	{
		...
		liMessage__msgs_1117(conf, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_12), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__BxyDeRCaUtiykBhMyyq9cqA_13, NIM_FALSE);
	}
	LA29_: ;
