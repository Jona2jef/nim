...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, ithField__semmacrosanity_53)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, NI* field);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, ithField__semmacrosanity_5)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NI* field);
...
N_LIB_PRIVATE N_NIMCALL(void, annotateType__semmacrosanity_69)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
STRING_LITERAL(TM__gkmEeaIyT0wHpJzs9ciIEJg_7, "/home/runner/work/nightlies/nightlies/nim/compiler/semmacrosanity.nim", 69);
...
{	result = NIM_NIL;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					result = ithField__semmacrosanity_5((*n)._kind_6.sons->data[i], field);
					{
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 139):
	{
		...
		LA12_: ;
		result = ithField__semmacrosanity_5((*n)._kind_6.sons->data[((NI) 0)], field);
		{
			...
			i_4 = ((NI) 1);
			{
				while (1) {
					...
					case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 88):
					{
						...
						result = ithField__semmacrosanity_5(T22_, field);
						{
...
{	result = NIM_NIL;
	base = (*t).sons->data[((NI) 0)];
	{
		while (1) {
			...
			result = ithField__semmacrosanity_5((*b).n, field);
			{
		...
		asgnRef((void**) (&(*n).typ), t);
		{
			...
			i_2 = ((NI) 1);
			{
				while (1) {
					...
					i = i_2;
					j = (NI)(i - ((NI) 1));
					field = ithField__semmacrosanity_53(x_2, (&j));
					{
						NimStringDesc* T9_;
						NimStringDesc* T10_;
...
appendString(T9_, T10_);
						liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T9_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_6, NIM_FALSE);
					}
					goto LA5_;
					LA7_: ;
					{
						{
							...
							argX60gensym16_ = toFileLineCol__msgs_615(TM__gkmEeaIyT0wHpJzs9ciIEJg_11);
							internalErrorImpl__msgs_1430(conf, unknownLineInfo__lineinfos_280, argX60gensym16_, TM__gkmEeaIyT0wHpJzs9ciIEJg_11);
						}
						LA14_: ;
						annotateType__semmacrosanity_69((*(*n)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 1)], (*field).typ, conf);
					}
					LA5_: ;
					i_2 += ((NI) 1);
				} LA4: ;
				...
				i_4 = ((NI) 0);
				{
					while (1) {
						...
						i_3 = i_4;
						{
							...
							NimStringDesc* T30_;
							T26_ = (NI)0;
							T26_ = len__ast_4002(x);
							if (!(T26_ <= i_3)) goto LA27_;
							T29_ = NIM_NIL;
							T30_ = NIM_NIL;
							T30_ = dollar___systemZdollars_3(i_3);
...
appendString(T29_, T30_);
							liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T29_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_12, NIM_FALSE);
						}
						goto LA24_;
						LA27_: ;
						{
							annotateType__semmacrosanity_69((*n)._kind_6.sons->data[i_3], (*x).sons->data[i_3], conf);
						}
						LA24_: ;
						i_4 += ((NI) 1);
					} LA23: ;
		...
		LA35_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_13), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_14, NIM_FALSE);
		}
		LA17_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 41):
	{
				...
				m = NIM_NIL;
				{
					...
					i_6 = ((NI) 0);
					{
						while (1) {
							...
							T47_ = NIM_NIL;
							T47_ = elemType__types_263(x);
							annotateType__semmacrosanity_69(m, T47_, conf);
							i_6 += ((NI) 1);
						} LA46: ;
					}
				}
		...
		LA41_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_15), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_16, NIM_FALSE);
		}
		LA39_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 39):
	{
				...
				m_2 = NIM_NIL;
				{
					...
					i_8 = ((NI) 0);
					{
						while (1) {
							...
							T58_ = NIM_NIL;
							T58_ = elemType__types_263(x);
							annotateType__semmacrosanity_69(m_2, T58_, conf);
							i_8 += ((NI) 1);
						} LA57: ;
					}
				}
		...
		LA52_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_17), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_18, NIM_FALSE);
		}
		LA50_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 16) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 19):
	{
		...
		LA63_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_19), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_20, NIM_FALSE);
		}
		LA61_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 5) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 15):
	{
		...
		LA69_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_21), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_22, NIM_FALSE);
		}
		LA67_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 20) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 22):
	{
		...
		LA75_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_23), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_24, NIM_FALSE);
		}
		LA73_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 23):
	{
		...
		LA81_: ;
		{
			liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__gkmEeaIyT0wHpJzs9ciIEJg_25), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__gkmEeaIyT0wHpJzs9ciIEJg_26, NIM_FALSE);
		}
		LA79_: ;
	}
	break;
