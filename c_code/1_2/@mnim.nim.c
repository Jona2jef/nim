...
N_LIB_PRIVATE N_NIMCALL(void, handleCmdLine__nim_41)(tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
N_LIB_PRIVATE N_NOINLINE(void*, newObj)(TNimType* typ, NI size);
N_LIB_PRIVATE N_NIMCALL(void, processCmdLine__nim_16)(tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA pass, NimStringDesc* cmd, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config);
...
N_LIB_PRIVATE N_NIMCALL(void, addCmdPrefix__cmdlinehelper_16)(NimStringDesc** result, tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA kind);
...
N_LIB_PRIVATE N_NIMCALL(void, initDefinesProg__cmdlinehelper_28)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* name);
...
N_LIB_PRIVATE N_NIMCALL(void, processCmdLineAndProjectPath__cmdlinehelper_32)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, loadConfigsAndProcessCmdLine__cmdlinehelper_43)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getNimRunExe__nim_38)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf);
...
STRING_LITERAL(TM__6xNBOpPeN0DsJ34t7RoSng_8, "/home/runner/work/nightlies/nightlies/nim/compiler/nim.nim", 58);
...
((NI) 16)}
;
N_LIB_PRIVATE tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf__nim_106;
extern tyObject_GcHeap__1TRH1TZMaVZTnLNcIHuNFQ gch__system_5281;
static N_NIMCALL(void, TM__6xNBOpPeN0DsJ34t7RoSng_2)(void) {
	nimGCvisit((void*)conf__nim_106, 0);
}
static N_INLINE(NI, pluspercent___system_696)(NI x, NI y) {
	NI result;
	result = (NI)0;
...
appendString((*config).commandLine, ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_4));
				addCmdPrefix__cmdlinehelper_16((&(*config).commandLine), p.kind);
				T6_ = NIM_NIL;
...
appendString((*config).commandLine, T11_);
				...
				LA9_: ;
				{
					...
					p.key = copyString(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_5));
					{
						NIM_BOOL T18_;
						T18_ = (NIM_BOOL)0;
						T18_ = processArgument__commands_1508(pass, (&p), (&argsCount), config);
						if (!T18_) goto LA19_;
						goto LA2;
					}
					LA19_: ;
				...
				LA14_: ;
				{
					processSwitch__commands_1501(pass, (&p), config);
				}
				LA12_: ;
			}
			break;
...
appendString((*config).commandLine, T23_);
				{
					NIM_BOOL T26_;
					T26_ = (NIM_BOOL)0;
					T26_ = processArgument__commands_1508(pass, (&p), (&argsCount), config);
					if (!T26_) goto LA27_;
					goto LA2;
				}
				LA27_: ;
	...
	} LA2: ;
	{
		if (!(pass == ((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1))) goto LA31_;
		{
			...
			LA38_: ;
			if (!T35_) goto LA39_;
			liMessage__msgs_1117(config, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_7, NIM_FALSE);
		}
		LA39_: ;
	}
	LA31_: ;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getNimRunExe__nim_38)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	result = NIM_NIL;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isDefined__options_2279(conf, ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_11));
		if (!T3_) goto LA4_;
		{
			NIM_BOOL T8_;
			T8_ = (NIM_BOOL)0;
			T8_ = isDefined__options_2279(conf, ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_12));
			if (!T8_) goto LA9_;
		...
		LA9_: ;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = isDefined__options_2279(conf, ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_14));
			if (!T12_) goto LA13_;
...
static N_INLINE(NimStringDesc*, findNodeJs__nodejs_2)(void) {
	NimStringDesc* result;
	result = NIM_NIL;
	result = findExe__pureZos_794(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts__pureZos_793, 3);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe__pureZos_794(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts__pureZos_793, 3);
	}
	LA3_: ;
	{
...
{	T1_ = NIM_NIL;
	...
	T2_.ClP_0 = ((TM__6xNBOpPeN0DsJ34t7RoSng_9) (processCmdLine__nim_16)); T2_.ClE_0 = NIM_NIL;
	asgnRef((void**) (&(*T1_).processCmdLine.ClE_0), T2_.ClE_0);
	(*T1_).processCmdLine.ClP_0 = T2_.ClP_0;
	self = T1_;
	initDefinesProg__cmdlinehelper_28(self, conf, ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_10));
	{
		NI T5_;
		T5_ = (NI)0;
		T5_ = nosparamCount();
		if (!(T5_ == ((NI) 0))) goto LA6_;
		writeCommandLineUsage__commands_169(conf);
		goto BeforeRet_;
	}
	LA6_: ;
	processCmdLineAndProjectPath__cmdlinehelper_32(self, conf);
	graph = newModuleGraph__modulegraphs_9074(cache, conf);
	{
		NIM_BOOL T10_;
		T10_ = (NIM_BOOL)0;
		T10_ = loadConfigsAndProcessCmdLine__cmdlinehelper_43(self, cache, conf, graph);
		if (!!(T10_)) goto LA11_;
		goto BeforeRet_;
	}
	LA11_: ;
	mainCommand__main_500(graph);
	{
		NIM_BOOL T15_;
		tyArray__nHXaesL0DJZHyVS07ARPRA T18_;
		T15_ = (NIM_BOOL)0;
		T15_ = hasHint__options_517(conf, ((tyEnum_TMsgKind__7VIi6mabc7hDxpCmSMYIug) 95));
		if (!T15_) goto LA16_;
		nimZeroMem((void*)T18_, sizeof(tyArray__nHXaesL0DJZHyVS07ARPRA));
		T18_[0] = GC_getStatistics__system_2268();
		echoBinSafe(T18_, 1);
	}
	LA16_: ;
	{
	...
	LA21_: ;
	{
		...
		output = absOutFile__options_4038(conf);
		switch ((*conf).cmd) {
		...
		case ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 7):
		{
			...
			NimStringDesc* T50_;
			NimStringDesc* T51_;
			nimRunExe = getNimRunExe__nim_38(conf);
			cmdPrefix = NIM_NIL;
			{
				NimStringDesc* T32_;
...
appendString(T45_, reprEnum((NI)(*conf).backend, (&NTItbackend__4OBsgZ9cscH2JLUE5Wcz01g_)));
					failedAssertImpl__systemZassertions_56(T45_);
				}
				LA43_: ;
			}
			break;
...
appendString(T50_, (*conf).arguments);
			execExternalProgram__extccomp_808(conf, T50_, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 89));
		}
		break;
		...
		case ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 18) ... ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 21):
		{
			NimStringDesc* T59_;
			{
				...
				liMessage__msgs_1117(conf, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T58_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_24, NIM_FALSE);
			}
			LA55_: ;
			T59_ = NIM_NIL;
			T59_ = dollar___options_4364(output);
			openDefaultBrowser__pureZbrowsers_13(T59_);
		}
		break;
		default:
		{
			...
			liMessage__msgs_1117(conf, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T62_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_26, NIM_FALSE);
		}
		break;
		}
	}
...
}/* preInitProc end */
{
	...
	GC_disableMarkAndSweep__system_2267();
	asgnRef((void**) (&conf__nim_106), newConfigRef__options_2320());
	T1_ = NIM_NIL;
	T1_ = newIdentCache__idents_152();
	handleCmdLine__nim_41(T1_, conf__nim_106);
	msgQuit__msgs_442(((NI8) ((((NI) 0) < (*conf__nim_106).errorCounter))));
}
}
