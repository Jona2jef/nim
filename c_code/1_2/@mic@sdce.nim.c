...
N_LIB_PRIVATE N_NIMCALL(tySequence__0a6ZbC0zPSfUDYzqPnO68A*, newSeq__icZdce_1797)(NI len);
...
N_LIB_PRIVATE N_NIMCALL(void, aliveCode__icZdce_1720)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n);
N_LIB_PRIVATE N_NIMCALL(void, followLater__icZdce_1505)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NI module, NI32 item);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsOrIncl__astalgo_402)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* s, NI key);
N_LIB_PRIVATE N_NIMCALL(NI, ithSon__icZpacked95ast_535)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n, NI i);
...
N_LIB_PRIVATE N_NIMCALL(void, rangeCheckAnalysis__icZdce_1700)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n);
...
static N_INLINE(tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ, X5BX5D___icZdce_1692)(tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ* s, NI sLen_0, NI i);
static N_INLINE(NI, firstSon__icZpacked95ast_561)(NI n);
N_LIB_PRIVATE N_NIMCALL(void, requestCompilerProc__icZdce_1533)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NimStringDesc* name);
N_LIB_PRIVATE N_NIMCALL(tyTuple__Ll5iolPASSzOEheeSNjmiw*, X5BX5D___icZdce_1594)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t, NimStringDesc* key);
static N_INLINE(NI, rawGet__icZdce_216)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA t, NimStringDesc* key, NI* hc);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isExportedToC__icZdce_25)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NI32 symId);
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___icZdce_153)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t, NimStringDesc* key, tyTuple__Ll5iolPASSzOEheeSNjmiw val);
...
static N_INLINE(NIM_BOOL, mustRehash__icZdce_581)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__icZdce_740)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__icZdce_1071)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t, tySequence__UuiPn6QjIiUTdSVwX2PZ6w** data, NimStringDesc* key, tyTuple__Ll5iolPASSzOEheeSNjmiw val, NI hc, NI h);
...
static N_INLINE(NI, rawGetKnownHC__icZdce_1252)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA t, NimStringDesc* key, NI hc);
...
N_LIB_PRIVATE N_NIMCALL(void, followNow__icZdce_1763)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g);
static N_INLINE(tyTuple__cMFateeY74rz3xht2OQsgw, pop__icZdce_1770)(tySequence__lv3e1dBLzs1OTRMFv9aL3JA** s);
...
N_LIB_PRIVATE N_NIMCALL(void, followLater__icZdce_1505)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NI module, NI32 item) {
	{
		...
		NI32 body;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl__astalgo_402((&(*c).alive->data[module]), ((NI) (item)));
		if (!!(T3_)) goto LA4_;
		body = g->data[module].fromDisk.syms->data[item].ast;
		{
			...
			opt = g->data[module].fromDisk.syms->data[item].options;
			{
				...
				T14_ = (NI)0;
				T14_ = ithSon__icZpacked95ast_535(g->data[module].fromDisk.bodies, ((NI) (body)), ((NI) 6));
				body = ((NI32) (T14_));
			}
			LA12_: ;
			T15_.Field0 = module;
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag, loadTypeKind__icZdce_1679)(tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ t, tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tySet_tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag toSkip) {
	...
	t2 = translateId__icZic_8432(t, g, (*c).thisModule, (*c).decoder.config);
	result = g->data[t2.module].fromDisk.types->data[t2.item].kind;
	{
		while (1) {
			...
			T3_ = X5BX5D___icZdce_1692(g->data[t2.module].fromDisk.types->data[t2.item].types->data, (g->data[t2.module].fromDisk.types->data[t2.item].types ? g->data[t2.module].fromDisk.types->data[t2.item].types->Sup.len : 0), ((NI) 1));
			t2 = translateId__icZic_8432(T3_, g, ((NI) (t2.module)), (*c).decoder.config);
			result = g->data[t2.module].fromDisk.types->data[t2.item].kind;
		} LA2: ;
	}
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__Ll5iolPASSzOEheeSNjmiw*, X5BX5D___icZdce_1594)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t, NimStringDesc* key) {
	...
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__icZdce_216((*t), key, (&hcX60gensym22_));
	{
...
N_LIB_PRIVATE N_NIMCALL(void, requestCompilerProc__icZdce_1533)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NimStringDesc* name) {
	...
	T1_ = X5BX5D___icZdce_1594((&(*c).compilerProcs), name);
	module = (*T1_).Field0;
	item = (*T1_).Field1;
	followLater__icZdce_1505(c, g, module, item);
}
N_LIB_PRIVATE N_NIMCALL(void, rangeCheckAnalysis__icZdce_1700)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n) {
	...
	LA5_: ;
	{
		...
		NI T8_;
		T8_ = (NI)0;
		T8_ = firstSon__icZpacked95ast_561(n);
		n0t = loadTypeKind__icZdce_1679(tree.nodes->data[T8_].typeId_0, (&(*c)), g, TM__uErKJhkx70jmGDNtVJTUvA_4);
		{
			...
			requestCompilerProc__icZdce_1533(c, g, ((NimStringDesc*) &TM__uErKJhkx70jmGDNtVJTUvA_5));
		}
		goto LA9_;
		LA11_: ;
		{
			...
			requestCompilerProc__icZdce_1533(c, g, raiser);
		}
		LA9_: ;
	}
	LA1_: ;
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				eh = n->data[i].Field0;
				{
					...
					rawInsert__icZdce_1071(t, (&(*t).data), T17_, T18_, eh, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___icZdce_153)(tyObject_Table__DA3V9a9b2HIIuj8hylZa2mSA* t, NimStringDesc* key, tyTuple__Ll5iolPASSzOEheeSNjmiw val) {
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__icZdce_216((*t), key, (&hc));
	{
	...
	LA8_: ;
	{
		...
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__icZdce_581((*t));
			if (!T18_) goto LA19_;
			enlarge__icZdce_740(t);
			index = rawGetKnownHC__icZdce_1252((*t), key, hc);
		}
		LA19_: ;
		index = (NI)(((NI) -1) - index);
		rawInsert__icZdce_1071(t, (&(*t).data), key, val, hc, index);
		(*t).counter += ((NI) 1);
	}
	LA6_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isExportedToC__icZdce_25)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, NI32 symId) {
	...
	flags = (*symPtr).flags;
	{
		...
		LA9_: ;
		{
			...
			T15_ = X5BX5D___icZic_152((&g->data[(*c).thisModule].fromDisk.strings), (*symPtr).name);
			T16_.Field0 = (*c).thisModule;
			T16_.Field1 = symId;
			X5BX5Deq___icZdce_153((&(*c).compilerProcs), (*T15_), T16_);
		}
		LA13_: ;
	}
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, aliveCode__icZdce_1720)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n) {
	...
	{
		followLater__icZdce_1505(c, g, (*c).thisModule, tree.nodes->data[n].operand);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 162):
	{
		...
		NI otherModule;
		NI32 T5_;
		T4_ = sons2__icZpacked95ast_498(tree, n);
		n1 = T4_.Field0;
		n2 = T4_.Field1;
		m = ((NU32) (tree.nodes->data[n1].operand));
		item = tree.nodes->data[n2].operand;
		T5_ = (NI32)0;
		T5_ = toFileIndexCached__icZic_5508((&(*c).decoder), g, (*c).thisModule, m);
		otherModule = ((NI) (T5_));
		followLater__icZdce_1505(c, g, otherModule, item);
	}
	break;
	...
	{
		{
			...
			pos += ((NI) 1);
			{
				while (1) {
					...
					son = pos;
					aliveCode__icZdce_1720(c, g, tree, son);
	...
	{
		rangeCheckAnalysis__icZdce_1700(c, g, tree, n);
	}
	break;
	...
	{
		{
			...
			T15_ = (NIM_BOOL)0;
			T16_ = (NI)0;
			T16_ = firstSon__icZpacked95ast_561(n);
			T15_ = (tree.nodes->data[T16_].kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3));
			if (!(T15_)) goto LA17_;
			T18_ = (NI)0;
			T18_ = ithSon__icZpacked95ast_535(tree, n, ((NI) 2));
			T15_ = (tree.nodes->data[T18_].kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1));
			LA17_: ;
			if (!T15_) goto LA19_;
			T21_ = (NI)0;
			T21_ = firstSon__icZpacked95ast_561(n);
			item_2 = tree.nodes->data[T21_].operand;
			{
				NIM_BOOL T24_;
				T24_ = (NIM_BOOL)0;
				T24_ = isExportedToC__icZdce_25(c, g, item_2);
				if (!T24_) goto LA25_;
				followLater__icZdce_1505(c, g, (*c).thisModule, item_2);
			}
			LA25_: ;
		}
		LA19_: ;
	...
	{
		{
			...
			pos_2 += ((NI) 1);
			{
				while (1) {
					...
					son_2 = pos_2;
					aliveCode__icZdce_1720(c, g, tree, son_2);
					nextChild__icZpacked95ast_312(tree, (&pos_2));
				} LA30: ;
			}
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(void, followNow__icZdce_1763)(tyObject_AliveContext__3gIefFIPpbeQ6DpRGxDBCg* c, tySequence__rQHmYk1HzcwNxKBymIFHpA* g) {
	{
		while (1) {
			...
			T4_ = pop__icZdce_1770((&(*c).stack));
			modId = T4_.Field0;
			opt = T4_.Field1;
			ast = T4_.Field2;
			(*c).thisModule = modId;
			(*c).options = opt;
			aliveCode__icZdce_1720(c, g, g->data[modId].fromDisk.bodies, ast);
		} LA2: ;
	}
}
N_LIB_PRIVATE N_NIMCALL(tySequence__0a6ZbC0zPSfUDYzqPnO68A*, computeAliveSyms__icZdce_1785)(tySequence__rQHmYk1HzcwNxKBymIFHpA* g, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	c.thisModule = ((NI) -1);
	T1_ = (g ? g->Sup.len : 0);
	c.alive = newSeq__icZdce_1797(((NI) (T1_)));
					...
					c.thisModule = i;
					{
						...
						p_2 = ((NI) 0);
						{
							while (1) {
								...
								NI s;
								T13_ = (NI)0;
								T13_ = len__icZpacked95ast_293(colontmp__2);
								if (!(p_2 < T13_)) goto LA12;
								p = p_2;
								aliveCode__icZdce_1720((&c), g, g->data[i].fromDisk.topLevel, p);
								s = span__icZpacked95ast_494(colontmp__2, p_2);
								p_2 += s;
							} LA12: ;
						}
					}
