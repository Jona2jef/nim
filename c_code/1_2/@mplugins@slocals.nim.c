...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, semLocals__pluginsZlocals_7)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = NIM_NIL;
	counter = ((NI) 0);
	tupleType = newTypeS__semdata_733(((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 18), c);
	result = newNodeIT__ast_3378(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 37), (*n).info, tupleType);
	asgnRef((void**) (&(*tupleType).n), newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 138), (*n).info));
	owner = getCurrOwner__semdata_315(c);
	{
			...
			current = (*c).currentScope;
			{
				while (1) {
					...
					scope = s;
					{
						...
						s_2 = initTabIter__astalgo_3777((&it_2), (*scope).symbols);
						{
							while (1) {
								...
								it = s_2;
								{
									...
									if (!T14_) goto LA17_;
									{
										...
										field = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 19), (*it).name, T23_, owner, (*n).info, 0);
										asgnRef((void**) (&(*field).typ), skipTypes__ast_3735((*it).typ, TM__tdBuY2ZF9bI7pxZ6PYkeTmw_3));
										(*field).position = counter;
										counter += ((NI) 1);
										T24_ = NIM_NIL;
										T24_ = newSymNode__ast_3716(field);
										add__ast_4797((*tupleType).n, T24_);
										addSonSkipIntLit__magicsys_136(tupleType, (*field).typ, (*c).Sup.idgen);
										a = newSymNode__ast_3719(it, (*result).info);
										{
								...
								LA17_: ;
								s_2 = nextIter__astalgo_3762((&it_2), (*scope).symbols);
							} LA11: ;
						}
					}
