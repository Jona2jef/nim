...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux__depends_17)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___depends_21)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___depends_75)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___depends_21)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0) {
	...
	result = NIM_NIL;
	result = runtimeFormat__ropes_271(((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_3), args, argsLen_0);
	return result;
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux__depends_17)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported) {
	...
	T1_[0] = rope__ropes_109(importing);
	T1_[1] = rope__ropes_109(imported);
	T2_ = NIM_NIL;
	T2_ = percent___depends_21(T1_, 2);
	add__ropes_159(&(*b).dotGraph, T2_);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, addDotDependency__depends_26)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					imported = getModuleName__modulepaths_10((*g).config, (*n)._kind_6.sons->data[i]);
					addDependencyAux__depends_17(b, (*(*(*g).module).name).s, imported);
					i_2 += ((NI) 1);
				} LA4: ;
			}
		}
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 117):
	{
		...
		imported_2 = getModuleName__modulepaths_10((*g).config, (*n)._kind_6.sons->data[((NI) 0)]);
		addDependencyAux__depends_17(b, (*(*(*g).module).name).s, imported_2);
	}
	break;
	...
	{
		{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					i_3 = i_4;
					T10_ = NIM_NIL;
					T10_ = addDotDependency__depends_26(c, (*n)._kind_6.sons->data[i_3]);
					(void)(T10_);
					i_4 += ((NI) 1);
				} LA9: ;
			}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___depends_75)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0) {
	tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* result;
	result = NIM_NIL;
	result = runtimeFormat__ropes_271(((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_4), args, argsLen_0);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, generateDot__depends_71)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NimStringDesc* project) {
	...
	splitFile__pathutils_26(project, (&T2_));
	T1_[0] = rope__ropes_109(T2_.Field1);
	T1_[1] = (*b).dotGraph;
	T3_ = NIM_NIL;
	T3_ = percent___depends_75(T1_, 2);
	T4_ = NIM_NIL;
	T4_ = noschangeFileExt(project, ((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_5));
	T5_ = (NIM_BOOL)0;
	T5_ = writeRope__ropes_241(T3_, T4_);
	(void)(T5_);
}
