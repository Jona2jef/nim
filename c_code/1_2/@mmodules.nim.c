...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, includeModule__modules_2852)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NI32 fileIdx);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, importModule__modules_1760)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NI32 fileIdx);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, newModule__modules_1702)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isNimIdentifier__lexer_209)(NimStringDesc* s);
...
N_LIB_PRIVATE N_NIMCALL(void, partialInitModule__modules_414)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, NimStringDesc* filename);
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getPackage__modules_22)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx);
...
N_LIB_PRIVATE N_NIMCALL(void, getOrDefault__modules_102)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA* Result);
N_LIB_PRIVATE N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
static N_INLINE(NI, rawGet__modules_111)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, NI* hc);
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___modules_534)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA val);
...
static N_INLINE(NIM_BOOL, mustRehash__modules_707)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__modules_860)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__modules_1164)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t, tySequence__61s9cbAniKuBrdHwBhMDfQg** data, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__modules_1333)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, NI hc);
N_LIB_PRIVATE N_NIMCALL(void, newStrTable__ast_4094)(tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA* Result);
N_LIB_PRIVATE N_NIMCALL(tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA*, X5BX5D___modules_1623)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key);
...
N_LIB_PRIVATE N_NIMCALL(void, replayStateChanges__icZreplayer_15)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g);
N_LIB_PRIVATE N_NIMCALL(void, replayGenericCacheInformation__icZreplayer_977)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, NI module);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__48JTohSgTy339bRxHzUD8KA**, mgetOrPut__modules_1802)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA* t, NI32 key, tySequence__48JTohSgTy339bRxHzUD8KA* val);
static N_INLINE(NI, rawGet__cgen_27308)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA t, NI32 key, NI* hc);
...
static N_INLINE(NIM_BOOL, mustRehash__modules_1923)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__modules_2076)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__modules_2380)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA* t, tySequence__fdmz6VkIf1ewwrssKYqRFg** data, NI32 key, tySequence__48JTohSgTy339bRxHzUD8KA* val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__modules_2549)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA t, NI32 key, NI hc);
...
N_LIB_PRIVATE N_NIMCALL(void, resetSysTypes__magicsys_99)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g);
...
STRING_LITERAL(TM__M5T16KOkc0tDi9bZeKl6v1w_4, "/home/runner/work/nightlies/nightlies/nim/compiler/modules.nim", 62);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, includeModule__modules_2852)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NI32 fileIdx) {
	...
	result = NIM_NIL;
	result = parseFile__syntaxes_217(fileIdx, (*graph).cache, (*graph).config);
	addDep__modulegraphs_9449(graph, s, fileIdx);
	addIncludeDep__modulegraphs_9460(graph, ((NI32) ((*s).position)), fileIdx);
	return result;
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
...
N_LIB_PRIVATE N_NIMCALL(void, getOrDefault__modules_102)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA* Result) {
	...
	hcX60gensym3_ = (NI)0;
	indexX60gensym3_ = rawGet__modules_111(t, key, (&hcX60gensym3_));
	{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getPackage__modules_22)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx) {
	...
	result = NIM_NIL;
	filename = toFullPath__msgs_538((*graph).config, fileIdx);
	nimZeroMem((void*)(&T1_), sizeof(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg));
	splitFile__pathutils_26(filename, (&T1_));
	name = getIdent__idents_143((*graph).cache, T1_.Field1);
	info = newLineInfo__msgs_381(fileIdx, ((NI) 1), ((NI) 1));
	pck = getPackageName__options_4134((*graph).config, filename);
	{
	...
	LA2_: ;
	pack = getIdent__idents_143((*graph).cache, pck2);
	result = strTableGet__astalgo_3390((*graph).packageSyms, pack);
	{
		...
		T11_ = NIM_NIL;
		T11_ = getIdent__idents_143((*graph).cache, pck2);
		nimZeroMem((void*)(&T12_), sizeof(tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g));
		T12_.module = ((NI32) -3);
		T12_.item = fileIdx;
		result = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 24), T11_, T12_, ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL), info, 0);
		strTableAdd__astalgo_3332((&(*graph).packageSyms), result);
	}
	goto LA7_;
	LA9_: ;
	{
		...
		getOrDefault__modules_102((*graph).modulesPerPackage, (*result).Sup.itemId, (&T14_));
		...
		modules.data = T14_.data;
		{
			...
			existing = strTableGet__astalgo_3390(modules, name);
		}
		goto LA15_;
		LA18_: ;
		{
		...
		LA15_: ;
		{
			...
			LA24_: ;
			if (!T23_) goto LA25_;
			pck3 = fakePackageName__options_4139((*graph).config, filename);
			T27_ = NIM_NIL;
			T27_ = getIdent__idents_143((*graph).cache, pck3);
			nimZeroMem((void*)(&T28_), sizeof(tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g));
			T28_.module = ((NI32) -3);
			T28_.item = fileIdx;
			result = newSym__ast_3445(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 24), T27_, T28_, result, info, 0);
			strTableAdd__astalgo_3332((&(*graph).packageSyms), result);
		}
		LA25_: ;
	}
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				eh = n->data[i].Field0;
				{
					...
					rawInsert__modules_1164(t, (&(*t).data), T17_, T18_, eh, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___modules_534)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA val) {
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__modules_111((*t), key, (&hc));
	{
	...
	LA8_: ;
	{
		...
		LA14_: ;
		{
			NIM_BOOL T18_;
			T18_ = (NIM_BOOL)0;
			T18_ = mustRehash__modules_707((*t));
			if (!T18_) goto LA19_;
			enlarge__modules_860(t);
			index = rawGetKnownHC__modules_1333((*t), key, hc);
		}
		LA19_: ;
		index = (NI)(((NI) -1) - index);
		rawInsert__modules_1164(t, (&(*t).data), key, val, hc, index);
		(*t).counter += ((NI) 1);
	}
	LA6_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA*, X5BX5D___modules_1623)(tyObject_Table__hd3qB0wXU9bWPJR7fjShhbA* t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key) {
	...
	hcX60gensym22_ = (NI)0;
	indexX60gensym22_ = rawGet__modules_111((*t), key, (&hcX60gensym22_));
	{
...
N_LIB_PRIVATE N_NIMCALL(void, partialInitModule__modules_414)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, NimStringDesc* filename) {
	...
	packSym = getPackage__modules_22(graph, fileIdx);
	...
	(*result).position = ((NI) (fileIdx));
	{
		...
		getOrDefault__modules_102((*graph).modulesPerPackage, (*packSym).Sup.itemId, (&T3_));
		...
		newStrTable__ast_4094((&T7_));
		X5BX5Deq___modules_534((&(*graph).modulesPerPackage), (*packSym).Sup.itemId, T7_);
	}
	LA5_: ;
	T8_ = (tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA*)0;
	T8_ = X5BX5D___modules_1623((&(*graph).modulesPerPackage), (*packSym).Sup.itemId);
	strTableAdd__astalgo_3332(T8_, result);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, newModule__modules_1702)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	NimStringDesc* filename;
	...
	splitFile__pathutils_26(filename, (&T2_));
	asgnRef((void**) (&(*T1_).name), getIdent__idents_143((*graph).cache, T2_.Field1));
	(*T1_).info = newLineInfo__msgs_381(fileIdx, ((NI) 1), ((NI) 1));
	result = T1_;
	{
		NIM_BOOL T5_;
		NimStringDesc* T8_;
		T5_ = (NIM_BOOL)0;
		T5_ = isNimIdentifier__lexer_209((*(*result).name).s);
		if (!!(T5_)) goto LA6_;
		T8_ = NIM_NIL;
...
appendString(T8_, (*(*result).name).s);
		liMessage__msgs_1117((*graph).config, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T8_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_3, NIM_FALSE);
	}
	LA6_: ;
	partialInitModule__modules_414(result, graph, fileIdx, filename);
	registerModule__modulegraphs_9019(graph, result);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, compileModule__modules_1707)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, tySet_tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw flags, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fromModule) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	...
	LA3_: ;
	result = getModule__modulegraphs_9370(graph, fileIdx);
	{
		tySequence__48JTohSgTy339bRxHzUD8KA* cachedModules;
		NimStringDesc* filename;
		if (!(result == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL))) goto LA7_;
		cachedModules = NIM_NIL;
		result = moduleFromRodFile__modulegraphs_11262(graph, fileIdx, (&cachedModules));
		filename = toFullPath__msgs_538((*graph).config, fileIdx);
		{
			...
			result = newModule__modules_1702(graph, fileIdx);
			(*result).flags = ((*result).flags | flags_2);
			registerModule__modulegraphs_9019(graph, result);
			onProcessing__modulegraphs_11274(graph, fileIdx, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_6), fromModule);
			sX60gensym27_ = NIM_NIL;
			{
				if (!((flags_2 &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0)) goto LA15_;
				{
					...
					sX60gensym27_ = llStreamOpen__llstream_63(stdin);
				}
				goto LA17_;
				LA19_: ;
				{
					if (!(*(*graph).config).projectIsCmd) goto LA22_;
					sX60gensym27_ = llStreamOpen__llstream_30((*(*graph).config).cmdInput);
				}
				goto LA17_;
				LA22_: ;
				LA17_: ;
			...
			LA15_: ;
			T24_ = NIM_NIL;
			T24_ = idGeneratorFromModule__ast_3104(result);
			T25_ = (NIM_BOOL)0;
			T25_ = processModule__passes_231(graph, result, T24_, sX60gensym27_);
			(void)(T25_);
		}
		goto LA9_;
		LA11_: ;
		...
		LA9_: ;
		{
			...
			L = T32_;
			{
				while (1) {
					...
					registerModuleById__modulegraphs_9068(graph, (*m));
					replayStateChanges__icZreplayer_15((*graph).packed_0->data[(*m)].module, graph);
					replayGenericCacheInformation__icZreplayer_977(graph, ((NI) ((*m))));
					i += ((NI) 1);
				} LA34: ;
			}
		}
	...
	LA7_: ;
	{
		...
		NIM_BOOL T51_;
		T36_ = (NIM_BOOL)0;
		T36_ = isDirty__modulegraphs_11233(graph, result);
		if (!T36_) goto LA37_;
		(*result).flags &= ~(((NU64)1) << ((((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 11)) & 63));
		initStrTables__modulegraphs_2690(graph, result);
		asgnRef((void**) (&(*result).ast), ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL));
		onProcessing__modulegraphs_11274(graph, fileIdx, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_7), fromModule);
		sX60gensym30_ = NIM_NIL;
		{
			if (!((flags_2 &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0)) goto LA41_;
			{
				...
				sX60gensym30_ = llStreamOpen__llstream_63(stdin);
			}
			goto LA43_;
			LA45_: ;
			{
				if (!(*(*graph).config).projectIsCmd) goto LA48_;
				sX60gensym30_ = llStreamOpen__llstream_30((*(*graph).config).cmdInput);
			}
			goto LA43_;
			LA48_: ;
			LA43_: ;
		...
		LA41_: ;
		T50_ = NIM_NIL;
		T50_ = idGeneratorFromModule__ast_3104(result);
		T51_ = (NIM_BOOL)0;
		T51_ = processModule__passes_231(graph, result, T50_, sX60gensym30_);
		(void)(T51_);
		markClientsDirty__modulegraphs_11156(graph, fileIdx);
	}
	goto LA5_;
	LA37_: ;
	LA5_: ;
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				eh = n->data[i].Field0;
				{
					...
					rawInsert__modules_2380(t, (&(*t).data), T17_, T18_, eh, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(tySequence__48JTohSgTy339bRxHzUD8KA**, mgetOrPut__modules_1802)(tyObject_Table__fdKWDDO1P17zvuQPReVgRA* t, NI32 key, tySequence__48JTohSgTy339bRxHzUD8KA* val) {
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__cgen_27308((*t), key, (&hc));
	{
		...
		LA13_: ;
		{
			NIM_BOOL T17_;
			T17_ = (NIM_BOOL)0;
			T17_ = mustRehash__modules_1923((*t));
			if (!T17_) goto LA18_;
			enlarge__modules_2076(t);
			index = rawGetKnownHC__modules_2549((*t), key, hc);
		}
		LA18_: ;
		index = (NI)(((NI) -1) - index);
		rawInsert__modules_2380(t, (&(*t).data), key, val, hc, index);
		(*t).counter += ((NI) 1);
	}
	LA8_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, importModule__modules_1760)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NI32 fileIdx) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	result = NIM_NIL;
	result = compileModule__modules_1707(graph, fileIdx, 0, s);
	addDep__modulegraphs_9449(graph, s, fileIdx);
	{
		NIM_BOOL T3_;
		...
		NI T8_;
		T3_ = (NIM_BOOL)0;
		T3_ = hcrOn__options_569((*graph).config);
		if (!T3_) goto LA4_;
		T6_ = NIM_NIL;
		T6_ = NIM_NIL;
		T7_ = (tySequence__48JTohSgTy339bRxHzUD8KA**)0;
		T7_ = mgetOrPut__modules_1802((&(*graph).importDeps), ((NI32) ((*s).position)), T6_);
	...
	LA4_: ;
	{
		...
		T11_ = (NIM_BOOL)0;
		T12_ = (NI)0;
		T12_ = getnimblePkgId__ast_3161(s);
		T11_ = (T12_ == (*(*graph).config).mainPackageId);
		if (T11_) goto LA13_;
		T11_ = isDefined__options_2279((*graph).config, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_8));
		LA13_: ;
		if (!T11_) goto LA14_;
...
N_LIB_PRIVATE N_NIMCALL(void, connectCallbacks__modules_2857)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph) {
	(*graph).includeFileCallback = includeModule__modules_2852;
	(*graph).importModuleCallback = importModule__modules_1760;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, makeModule__modules_2899)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NimStringDesc* filename) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	NI32 T1_;
	result = NIM_NIL;
	T1_ = (NI32)0;
	T1_ = fileInfoIdx__msgs_376((*graph).config, filename);
	result = newModule__modules_1702(graph, T1_);
	registerModule__modulegraphs_9019(graph, result);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, compileSystemModule__modules_2877)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph) {
	{
		...
		T5_ = NIM_NIL;
		T5_ = slash___pathutils_89((*(*graph).config).libpath, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_9));
		(*(*graph).config).m.systemFileIdx = fileInfoIdx__msgs_376((*graph).config, T5_);
		T6_ = NIM_NIL;
		T6_ = compileModule__modules_1707(graph, (*(*graph).config).m.systemFileIdx, 32768, ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL));
		(void)(T6_);
	}
	LA3_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, wantMainModule__modules_2883)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	NimStringDesc* T6_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty__options_4486((*conf).projectFull);
		if (!T3_) goto LA4_;
		liMessage__msgs_1117(conf, gCmdLineInfo__msgs_404, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 1), ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_10), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_11, NIM_FALSE);
	}
	LA4_: ;
	T6_ = NIM_NIL;
	T6_ = nosaddFileExt((*conf).projectFull, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_12));
	(*conf).projectMainIdx = fileInfoIdx__msgs_376(conf, T6_);
}
N_LIB_PRIVATE N_NIMCALL(void, compileProject__modules_2888)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 projectFileIdx) {
	...
	connectCallbacks__modules_2857(graph);
	conf = (*graph).config;
	wantMainModule__modules_2883(conf);
	configComplete__modulegraphs_11271(graph);
	T1_ = NIM_NIL;
	T1_ = slash___pathutils_89((*conf).libpath, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_9));
	systemFileIdx = fileInfoIdx__msgs_376(conf, T1_);
	{
	...
	packSym = getPackage__modules_22(graph, projectFile);
	(*(*graph).config).mainPackageId = getnimblePkgId__ast_3161(packSym);
	...
	(*graph).importStack->data[T7_] = projectFile;
	{
		...
		T12_ = NIM_NIL;
		T12_ = compileModule__modules_1707(graph, projectFile, 49152, ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL));
		(void)(T12_);
	}
	goto LA8_;
	LA10_: ;
	{
		...
		T14_ = NIM_NIL;
		T14_ = compileModule__modules_1707(graph, projectFile, 16384, ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL));
		(void)(T14_);
	}
	LA8_: ;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, makeStdinModule__modules_2907)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph) {
	tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result;
	result = NIM_NIL;
	result = makeModule__modules_2899(graph, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_13));
	return result;
}
