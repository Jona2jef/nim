...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, searchForProcAux__procfind_49)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TScope__1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fn);
...
STRING_LITERAL(TM__UQi3TxvDqkoRVo8YKAWcxA_4, "/home/runner/work/nightlies/nightlies/nim/compiler/procfind.nim", 63);
...
{	result = NIM_NIL;
	...
	result = initIdentIter__astalgo_3427((&it), (*scope).symbols, (*fn).name);
	{
		while (1) {
			if (!!((result == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA2;
			{
				...
				T7_ = equalParams__types_96((*(*result).typ).n, (*(*fn).typ).n);
				switch (T7_) {
				...
				{
					{
						...
						T15_[0] = getProcHeader__types_222((*(*c).graph).config, result, ((tyEnum_TPreferedDesc__tnd4qt9c4xddV8oKV5zyusw) 0), NIM_FALSE);
						T15_[1] = dollar___msgs_624((*(*c).graph).config, (*result).info);
						message = nsuFormatOpenArray(((NimStringDesc*) &TM__UQi3TxvDqkoRVo8YKAWcxA_2), T15_, 2);
						liMessage__msgs_1117((*(*c).graph).config, (*fn).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), message, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__UQi3TxvDqkoRVo8YKAWcxA_3, NIM_FALSE);
					}
					LA13_: ;
					goto BeforeRet_;
				}
				...
				case ((tyEnum_TParamsEquality__fvN026oaoXOuZ9ajGPibaYQ) 2):
				{
					...
					liMessage__msgs_1117((*(*c).graph).config, (*fn).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T17_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__UQi3TxvDqkoRVo8YKAWcxA_6, NIM_FALSE);
					goto BeforeRet_;
				}
				break;
			...
			LA5_: ;
			result = nextIdentIter__astalgo_3408((&it), (*scope).symbols);
		} LA2: ;
	}
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, searchForProc__procfind_73)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TScope__1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* fn, tyTuple__7rlNEhvBksZh9a9asniQIl9aQ* Result) {
	tyObject_TScope__1cQRXW6aAknk7ywAwjH3nw* scope_2;
	unsureAsgnRef((void**)&(*Result).Field0, NIM_NIL);
	(*Result).Field1 = 0;
	scope_2 = scope;
	unsureAsgnRef((void**) (&(*Result).Field0), searchForProcAux__procfind_49(c, scope_2, fn));
	{
		while (1) {
			NIM_BOOL T3_;
			T3_ = (NIM_BOOL)0;
			...
			if (!(T3_)) goto LA4_;
			T3_ = isShadowScope__lookups_135(scope_2);
			LA4_: ;
			if (!T3_) goto LA2;
