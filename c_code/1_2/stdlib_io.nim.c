				...
				while (1) {
					{
						...
						T43_ = (NIM_BOOL)0;
						T43_ = eqeq___system_7789(T42_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T43_);
						{
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = readLine__systemZio_276(f, (&result->data[i]));
						if (!!(T11_)) goto LA12_;
						raiseEOF__systemZio_117();
					}
					LA12_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, setFilePos__systemZio_524)(FILE* f, NI64 pos, tyEnum_FileSeekPos__I9aQjuvWxs8BspGbxwsngWw relativeTo) {
	{
		...
		if (!!((T3_ == ((NI32) 0)))) goto LA4_;
		raiseEIO__systemZio_96(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_28));
	}
	LA4_: ;
}
N_LIB_PRIVATE N_NIMCALL(NI64, getFilePos__systemZio_537)(FILE* f) {
	...
	result = _ftelli64(f);
	{
		...
		raiseEIO__systemZio_96(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_29));
	}
	LA3_: ;
	return result;
}
