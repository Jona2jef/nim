...
N_LIB_PRIVATE N_NIMCALL(tySequence__6H5Oh5UUvVCLiakt9aTwtUQ*, toBitSet__nimsets_103)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* s);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, toTreeSet__nimsets_128)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tySequence__6H5Oh5UUvVCLiakt9aTwtUQ* s, tyObject_TType__facALICuu8zUj0hjvbTLFg* settype, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__6H5Oh5UUvVCLiakt9aTwtUQ*, toBitSet__nimsets_103)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* s) {
	...
	first = firstOrd__types_1353(conf, (*(*s).typ).sons->data[((NI) 0)]);
	T1_ = (NI64)0;
	T1_ = getSize__types_3336(conf, (*s).typ);
	bitSetInit__bitsets_10((&result), ((NI) (T1_)));
	{
		NI i;
		NI colontmp_;
		NI i_2;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				{
					...
					j = getOrdValue__types_161((*(*s)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 0)], first);
					{
						while (1) {
							...
							NI64 T14_;
							T11_ = getOrdValue__types_161((*(*s)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 1)], first);
							T12_ = (NIM_BOOL)0;
							T12_ = lteq___int495056_309(j, T11_);
							if (!T12_) goto LA10;
							T13_ = minus___int495056_474(j, first);
							T14_ = (NI64)0;
							T14_ = toInt64__int495056_88(T13_);
							bitSetIncl__bitsets_25((&result), T14_);
							inc__int495056_251((&j), ((NU32) 1));
						} LA10: ;
					}
				}
				goto LA5_;
				LA7_: ;
				{
					...
					NI64 T18_;
					T16_ = getOrdValue__types_161((*s)._kind_6.sons->data[i], Max__int495056_27);
					T17_ = minus___int495056_474(T16_, first);
					T18_ = (NI64)0;
					T18_ = toInt64__int495056_88(T17_);
					bitSetIncl__bitsets_25((&result), T18_);
				}
				LA5_: ;
				i_2 += ((NI) 1);
			} LA4: ;
...
N_LIB_PRIVATE N_NIMCALL(NI64, cardSet__nimsets_241)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a) {
	...
	result = (NI64)0;
	x = toBitSet__nimsets_103(conf, a);
	result = bitSetCard__bitsets_40(x);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsSets__nimsets_209)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	result = (NIM_BOOL)0;
	x = toBitSet__nimsets_103(conf, a);
	y = toBitSet__nimsets_103(conf, b);
	result = bitSetContains__bitsets_37(x, y);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, equalSets__nimsets_216)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	x = toBitSet__nimsets_103(conf, a);
	y = toBitSet__nimsets_103(conf, b);
	result = bitSetEquals__bitsets_34(x, y);
	return result;
}
static N_INLINE(NI, pluspercent___system_696)(NI x, NI y) {
	NI result;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, toTreeSet__nimsets_128)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tySequence__6H5Oh5UUvVCLiakt9aTwtUQ* s, tyObject_TType__facALICuu8zUj0hjvbTLFg* settype, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	T1_ = firstOrd__types_1353(conf, elemType);
	first = toInt64__int495056_88(T1_);
	result = newNodeI__ast_3356(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 39), info);
	...
	e = IL64(0);
	{
		while (1) {
			...
			if (!(e < ((NI64) ((NI)(T4_ * ((NI) 8)))))) goto LA3;
			{
				...
				b -= ((NI) 1);
				aa = newIntTypeNode__ast_3783((NI64)(a + first), elemType);
				(*aa).info = info;
				{
					if (!(a == b)) goto LA22_;
					add__ast_4797(result, aa);
				}
				goto LA20_;
				LA22_: ;
				{
					...
					add__ast_4797(n, aa);
					bb = newIntTypeNode__ast_3783((NI64)(b + first), elemType);
					(*bb).info = info;
					add__ast_4797(n, bb);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, intersectSets__nimsets_195)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	x = toBitSet__nimsets_103(conf, a);
	y = toBitSet__nimsets_103(conf, b);
	bitSetIntersect__bitsets_22((&x), y);
	result = toTreeSet__nimsets_128(conf, x, (*a).typ, (*a).info);
	return result;
}
			...
			while (1) {
				...
				i = i_2;
				{
					if (!((*(*s)._kind_6.sons->data[i]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 44))) goto LA10_;
					{
						NIM_BOOL T14_;
						T14_ = (NIM_BOOL)0;
						T14_ = leValue__astalgo_135((*(*s)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 0)], elem);
						if (!(T14_)) goto LA15_;
						T14_ = leValue__astalgo_135(elem, (*(*s)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 1)]);
						LA15_: ;
						if (!T14_) goto LA16_;
						result = NIM_TRUE;
						goto BeforeRet_;
				...
				{
					{
						NIM_BOOL T21_;
						T21_ = (NIM_BOOL)0;
						T21_ = sameValue__astalgo_119((*s)._kind_6.sons->data[i], elem);
						if (!T21_) goto LA22_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, overlap__nimsets_40)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	result = (NIM_BOOL)0;
	{
		if (!((*a).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 44))) goto LA3_;
		{
			...
			T9_ = (NIM_BOOL)0;
			T9_ = leValue__astalgo_135((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 1)]);
			if (!(T9_)) goto LA10_;
			T9_ = leValue__astalgo_135((*b)._kind_6.sons->data[((NI) 0)], (*a)._kind_6.sons->data[((NI) 1)]);
			LA10_: ;
			result = T9_;
		}
		goto LA5_;
		LA7_: ;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = leValue__astalgo_135((*a)._kind_6.sons->data[((NI) 0)], b);
			if (!(T12_)) goto LA13_;
			T12_ = leValue__astalgo_135(b, (*a)._kind_6.sons->data[((NI) 1)]);
			LA13_: ;
			result = T12_;
		}
		LA5_: ;
	...
	{
		{
			...
			T19_ = (NIM_BOOL)0;
			T19_ = leValue__astalgo_135((*b)._kind_6.sons->data[((NI) 0)], a);
			if (!(T19_)) goto LA20_;
			T19_ = leValue__astalgo_135(a, (*b)._kind_6.sons->data[((NI) 1)]);
			LA20_: ;
			result = T19_;
		}
		goto LA15_;
		LA17_: ;
		{
			result = sameValue__astalgo_119(a, b);
		}
		LA15_: ;
	}
	LA1_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, emptyRange__nimsets_273)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	NIM_BOOL result;
	NIM_BOOL T1_;
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = leValue__astalgo_135(a, b);
	result = !(T1_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, deduplicate__nimsets_236)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a) {
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tySequence__6H5Oh5UUvVCLiakt9aTwtUQ* x;
	result = NIM_NIL;
	x = toBitSet__nimsets_103(conf, a);
