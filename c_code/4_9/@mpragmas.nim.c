			...
			res = ((NI) 0);
			{
				while (1) {
					...
					m = v_2;
					{
						NimStringDesc* T19_;
						T19_ = NIM_NIL;
						T19_ = substr__system_7756(reprEnum((NI)m, (&NTItmagic__shZhZOdbVC5nnFvcXQAImg_)), ((NI) 1));
		...
		a = ((NI) 0);
		{
			while (1) {
				...
				b = nsuFindChar(str, marker, ((NI) (a)), ((NI) 0));
				{
					...
					sub = substr__system_7756(str, a);
				}
				goto LA14_;
				LA16_: ;
				{
					sub = substr__system_7744(str, a, (NI)(b - ((NI) 1)));
				}
				LA14_: ;
				{
				...
				c = nsuFindChar(str, marker, ((NI) ((NI)(b + ((NI) 1)))), ((NI) 0));
				{
					...
					sub = substr__system_7756(str, (NI)(b + ((NI) 1)));
				}
				goto LA28_;
				LA30_: ;
				{
					sub = substr__system_7744(str, (NI)(b + ((NI) 1)), (NI)(c - ((NI) 1)));
				}
				LA28_: ;
				{
					NIM_BOOL amb;
