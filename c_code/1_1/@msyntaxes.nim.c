...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setupParser__syntaxes_209)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config);
...
N_LIB_PRIVATE N_NIMCALL(NI, utf8Bom__syntaxes_22)(NimStringDesc* s);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsShebang__syntaxes_25)(NimStringDesc* s, NI i);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, evalPipe__syntaxes_145)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* start);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
static N_INLINE(NIM_BOOL, equalMem__system_1735)(void* a, void* b, NI size);
static N_INLINE(int, nimCmpMem)(void* a, void* b, NI size);
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, applyFilter__syntaxes_126)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* stdin_0);
N_LIB_PRIVATE N_NIMCALL(tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ, getFilter__syntaxes_69)(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA* ident);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*, getCallee__syntaxes_108)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
STRING_LITERAL(TM__Furs9bKK6tVLoyofH3f4bRw_4, "/home/runner/work/nightlies/nightlies/nim/compiler/syntaxes.nim", 63);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, parsePipe__syntaxes_38)(NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* inputStream, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	s = llStreamOpen__llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
	{
		...
		T5_ = (NIM_BOOL)0;
		T5_ = llStreamReadLine__llstream_194(s, (&line));
		(void)(T5_);
		i = utf8Bom__syntaxes_22(line);
		linenumber = ((NI) 1);
		{
			NIM_BOOL T8_;
			NIM_BOOL T11_;
			T8_ = (NIM_BOOL)0;
			T8_ = containsShebang__syntaxes_25(line, i);
			if (!T8_) goto LA9_;
			T11_ = (NIM_BOOL)0;
			T11_ = llStreamReadLine__llstream_194(s, (&line));
			(void)(T11_);
			i = ((NI) 0);
			linenumber += ((NI) 1);
		}
		LA9_: ;
		{
			...
			T24_ = NIM_NIL;
			T24_ = substr__system_7810(line, i);
			T25_ = NIM_NIL;
			T25_ = llStreamOpen__llstream_30(T24_);
			openParser__parser_131((&p), filename, T25_, cache, config);
			result = parseAll__parser_37((&p));
			closeParser__parser_39((&p));
		}
		LA18_: ;
		llStreamClose__llstream_110(s);
	}
	LA3_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*, getCallee__syntaxes_108)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA8_: ;
	{
		...
		T11_ = NIM_NIL;
		T12_ = NIM_NIL;
		T12_ = renderTree__renderer_46(n, 0);
...
appendString(T11_, T12_);
		liMessage__msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T11_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__Furs9bKK6tVLoyofH3f4bRw_10, NIM_FALSE);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, applyFilter__syntaxes_126)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* stdin_0) {
	...
	result = NIM_NIL;
	T1_ = NIM_NIL;
	T1_ = getCallee__syntaxes_108((*p).lex.config, n);
	f = getFilter__syntaxes_69(T1_);
	switch (f) {
	...
	{
		result = filterTmpl__filter95tmpl_191((*p).lex.config, stdin_0, filename, n);
	}
	break;
	...
	}
	{
		if (!!((f == ((tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ) 0)))) goto LA8_;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = hasHint__options_517((*p).lex.config, ((tyEnum_TMsgKind__7VIi6mabc7hDxpCmSMYIug) 81));
			if (!T12_) goto LA13_;
			liMessage__msgs_1117((*p).lex.config, unknownLineInfo__lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 81), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_11, NIM_FALSE);
			msgWriteln__msgs_647((*p).lex.config, (*result).s, 0);
			liMessage__msgs_1117((*p).lex.config, unknownLineInfo__lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 82), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_12, NIM_FALSE);
		}
		LA13_: ;
	}
	LA8_: ;
...
{	result = NIM_NIL;
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					i = res;
					{
						...
						result = evalPipe__syntaxes_145(p, (*n)._kind_6.sons->data[i], filename, result);
					}
					goto LA16_;
					LA18_: ;
					{
						result = applyFilter__syntaxes_126(p, (*n)._kind_6.sons->data[i], filename, result);
					}
					LA16_: ;
					res += ((NI) 1);
				} LA15: ;
	...
	LA11_: ;
	{
		...
		result = evalPipe__syntaxes_145(p, (*n)._kind_6.sons->data[((NI) 0)], filename, result);
	}
	goto LA5_;
	LA22_: ;
	{
		result = applyFilter__syntaxes_126(p, n, filename, result);
	}
	LA5_: ;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, openParser__syntaxes_189)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* inputstream, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* s;
	filename = toFullPathConsiderDirty__msgs_571(config, fileIdx);
	pipe = parsePipe__syntaxes_38(filename, inputstream, cache, config);
	unsureAsgnRef((void**) (&(*p).lex.config), config);
	{
		if (!!((pipe == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA3_;
		s = evalPipe__syntaxes_145(p, pipe, filename, inputstream);
	}
	goto LA1_;
	LA3_: ;
	{
	...
	LA1_: ;
	openParser__parser_125(p, fileIdx, s, cache, config);
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setupParser__syntaxes_209)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	NIM_BOOL result;
	NimStringDesc* filename;
...
appendString(T6_, filename);
		liMessage__msgs_1117(config, unknownLineInfo__lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T6_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_3, NIM_FALSE);
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
	T7_ = NIM_NIL;
	T7_ = llStreamOpen__llstream_63(f);
	openParser__syntaxes_189(p, fileIdx, T7_, cache, config);
	result = NIM_TRUE;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, parseFile__syntaxes_217)(NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	objectInit((&p), (&NTIparser__kUTcqfBOdi2S1yCsNNzzUw_));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = setupParser__syntaxes_209((&p), fileIdx, cache, config);
		if (!T3_) goto LA4_;
		result = parseAll__parser_37((&p));
		closeParser__parser_39((&p));
	}
