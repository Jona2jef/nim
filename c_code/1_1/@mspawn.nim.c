			...
			while (1) {
				...
				i = i_2;
				{
					...
					LA36_: ;
					{
						...
						T62_ = (NIM_BOOL)0;
						size = computeSize__types_3308((*g).config, argType);
						T63_ = (NIM_BOOL)0;
						T63_ = (size < IL64(0));
						if (T63_) goto LA64_;
						T63_ = (IL64(16) < size);
...
N_LIB_PRIVATE N_NIMCALL(void, createWrapperProc__spawn_137)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* f, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* threadParam, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* argsParam, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* varSection, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* varInit, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* call, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* barrier, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* fv, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, tyEnum_TSpawnResult__YOcUu9brt5AKRflRWdxATPw spawnKind, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* result) {
	...
	LA9_: ;
	{
		if (!!((fv == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA12_;
		{
			...
			internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym16_, TM__OiEZ9cmMV1ztTwyI7NGH1RQ_36);
		}
		LA16_: ;
		threadLocalProm = addLocalVar__spawn_83(g, varSection, ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL), idgen, result, (*fv).typ, fv, NIM_FALSE);
	}
	...
	{
		{
			...
			internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym76_, TM__OiEZ9cmMV1ztTwyI7NGH1RQ_5);
		}
		LA5_: ;
	...
	{
		{
			...
			internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym78_, TM__OiEZ9cmMV1ztTwyI7NGH1RQ_7);
		}
		LA10_: ;
