...
{	result = (NIM_BOOL)0;
	...
	{
		{
			...
			if (!T29_) goto LA31_;
			{
				...
				NI T38_;
				T35_ = (NIM_BOOL)0;
				T35_ = sameType__types_1815((*f).sons->data[((NI) 0)], (*a).sons->data[((NI) 0)], 0);
				if (!(T35_)) goto LA36_;
				T37_ = (NI)0;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 12):
	{
		...
		LA55_: ;
		{
			...
			LA60_: ;
			{
				...
				xX60gensym32_ = old;
				T87_ = (NIM_BOOL)0;
				T87_ = containsOrIncl__astalgo_402((&(*m).marker), (NI)((NI)((NU32)(((NI) ((*xX60gensym32_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym32_).Sup.itemId.item))));
				if (!!(T87_)) goto LA88_;
	...
	{
		result = sameType__types_1815(f, a, 0);
	}
	break;
