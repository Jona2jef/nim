...
{	result = (NIM_BOOL)0;
	...
	openPasses__passes_85(graph, a, module, idgen);
	{
		...
		s = llStreamOpen__llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
		{
			...
			liMessage__msgs_1117((*graph).config, unknownLineInfo__lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 4), filename, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Tko7U9cii9bC6Kt2otnwMmCg_5, NIM_FALSE);
			result = NIM_FALSE;
			goto BeforeRet_;
		}
		LA12_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, registerPass__passes_61)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyTuple__4o9cW9aUwdGqgZI9bSHHYnbaQ p) {
	NI T6_;
	{
		...
		internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym1_, TM__Tko7U9cii9bC6Kt2otnwMmCg_13);
	}
	LA4_: ;
