...
static N_INLINE(NimStringDesc*, getCurrentExceptionMsg__system_7037)(void);
...
static N_INLINE(void, setCurrentDir__pureZos_838)(NimStringDesc* newDir);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__pureZos_1506)(NimStringDesc* source, NimStringDesc* dest);
...
N_LIB_PRIVATE N_NIMCALL(void, listDirs__scriptconfig_20)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, tySet_tyEnum_PathComponent__9c1SIU9cO1wHcl09b703A9cDrg filter) {
	...
	result = NIM_NIL;
	{
		...
		h = findFirstFile__pureZos_746(T2_, (&f));
		{
			if (!(h == ((NI) -1))) goto LA5_;
			{
				NI32 T11_;
				...
				raiseOSError__pureZos_462(T11_, dir);
			}
			LA9_: ;
		}
		goto LA3_;
			...
			if (TM__FA6jNt3IW9afkuZFmR0bnUQ_10.status == 0) {
			{
				while (1) {
					...
					k = ((tyEnum_PathComponent__9c1SIU9cO1wHcl09b703A9cDrg) 0);
					{
						...
						NimStringDesc* xx;
						T17_ = (NIM_BOOL)0;
						T17_ = skipFindData__pureZos_756((&f));
						if (!!(T17_)) goto LA18_;
						{
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_59)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	popSafePoint();
		...
		if (isObj(nimBorrowCurrentException()->Sup.m_type, (&NTIoserror__BeJgrOdDsczOwEWOZbRfKA_))) {
			...
			asgnRef((void**) (&(*colonenvP_).errorMsg1), getCurrentExceptionMsg__system_7037());
			popCurrentException();
		}
	}
...
static N_INLINE(void, setCurrentDir__pureZos_838)(NimStringDesc* newDir) {
	{
		...
		T7_ = (NI32)0;
		T7_ = osLastError__pureZos_465();
		raiseOSError__pureZos_462(T7_, newDir);
	}
	LA5_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_79)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T1_ = NIM_NIL;
	T1_ = getString__vm_352(a, ((NI) 0));
	setCurrentDir__pureZos_838(T1_);
	popSafePoint();
	}
	else {
		popSafePoint();
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_109)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T1_ = getString__vm_352(a, ((NI) 0));
	T2_ = NIM_NIL;
	T2_ = findExe__pureZos_785(T1_, NIM_TRUE, ExeExts__pureZos_784, 3);
