...
{	result = (tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag)0;
		...
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				} LA14: ;
				{
					NIM_BOOL T25_;
					T25_ = (NIM_BOOL)0;
					T25_ = sameType__types_1815((*(*a).typ).sons->data[i], (*(*b).typ).sons->data[i], 0);
					if (!T25_) goto LA26_;
					{
						NIM_BOOL T30_;
						T30_ = (NIM_BOOL)0;
				...
				LA26_: ;
				{
					...
					LA38_: ;
					if (!T35_) goto LA41_;
					diff = inheritanceDiff__types_2676(bb, aa);
					{
	...
	}
	{
		if (!(result == ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2))) goto LA61_;
		{
			NIM_BOOL T65_;
			T65_ = (NIM_BOOL)0;
			T65_ = sameTypeOrNil__types_1839((*(*a).typ).sons->data[((NI) 0)], (*(*b).typ).sons->data[((NI) 0)], 0);
			if (!!(T65_)) goto LA66_;
			{
				NIM_BOOL T70_;
				T70_ = (NIM_BOOL)0;
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					t2 = skipTypes__ast_3735((*(*methods->data[i]).typ).sons->data[col], TM__zwdrTKOAAM6OvWnXdBD4GQ_21);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = sameType__types_1815(t2, t, 0);
						if (!!(T11_)) goto LA12_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
		...
		i = ((NI) 1);
		{
			while (1) {
				...
				col = i;
				{
					...
					d = inheritanceDiff__types_2676(aa, bb);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genDispatcher__cgmeth_392)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tySequence__eHqUwlHGGaPw0TDPDeL79cQ* methods, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols) {
	...
	ands = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_289, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_22), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 109));
	iss = getSysMagic__magicsys_29(g, unknownLineInfo__lineinfos_289, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_23), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 15));
	boolType = getSysType__magicsys_60(g, unknownLineInfo__lineinfos_289, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 1));
	{
		NI col;
		NI i;
		col = (NI)0;
