...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_7));
	...
	value__astalgo_1078(this_0, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym118_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym118_).Sup.itemId.item))))));
	{
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_7));
	...
	value__astalgo_1078(this_0, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym113_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym113_).Sup.itemId.item))))));
	{
...
N_LIB_PRIVATE N_NIMCALL(void, idTablePut__astalgo_70)(tyObject_TIdTable__9aiv9bp2t5icFNINcg9c4xi1Q* t, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key, RootObj* val) {
	...
	n = NIM_NIL;
	xX60gensym191_ = key;
	index = idTableRawGet__astalgo_3813((*t), (NI)((NI)((NU32)(((NI) ((*xX60gensym191_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym191_).itemId.item))));
	{
...
N_LIB_PRIVATE N_NIMCALL(RootObj*, idTableGet__astalgo_64)(tyObject_TIdTable__9aiv9bp2t5icFNINcg9c4xi1Q t, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key) {
	...
	result = NIM_NIL;
	xX60gensym177_ = key;
	index = idTableRawGet__astalgo_3813(t, (NI)((NI)((NU32)(((NI) ((*xX60gensym177_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym177_).itemId.item))));
	{
		if (!(((NI) 0) <= index)) goto LA3_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, nextIdentExcluding__astalgo_3432)(tyObject_TIdentIter__Oi4goG2ACEsy9cyTe6OCPrA* ti, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA tab, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* excluding) {
	...
	result = tab.data->data[h];
	{
		while (1) {
			...
			if (!!((result == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA3;
			{
				...
				T8_ = (NIM_BOOL)0;
				T8_ = contains__astalgo_3496(excluding, (NI)((NI)((NU32)(((NI) ((*xX60gensym168_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym168_).Sup.itemId.item))));
				T6_ = !(T8_);
				LA7_: ;
				if (!T6_) goto LA9_;
				goto LA2;
	...
	(*ti).h = nextTry__astalgo_90(h, T16_);
	{
		...
		T19_ = contains__astalgo_3496(excluding, (NI)((NI)((NU32)(((NI) ((*xX60gensym170_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym170_).Sup.itemId.item))));
		LA20_: ;
		if (!T19_) goto LA21_;
		result = ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL);
	}
