				...
				while (1) {
					...
					n = (*list)._kind_6.sons->data[i];
					{
						...
						if (!(((NI) 2) <= T7_)) goto LA8_;
						{
							...
							internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym10_, TM__MWLujk8qP0XkmYs4m9cuPow_5);
						}
						LA14_: ;
...
break;
						...
						LA19_: ;
						{
							...
							tyTuple__7q7q3E6Oj24ZNVJb9aonhAg T42_;
							{
								...
								internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym23_, TM__MWLujk8qP0XkmYs4m9cuPow_23);
							}
							LA40_: ;
						...
						{
							{
								...
								internalErrorImpl__msgs_1430((*g).config, unknownLineInfo__lineinfos_289, argX60gensym44_, TM__MWLujk8qP0XkmYs4m9cuPow_26);
							}
							LA100_: ;
						}
						LA30_: ;
