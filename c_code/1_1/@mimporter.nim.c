...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, importModuleAs__importer_2193)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* realModule, NIM_BOOL importHidden) {
	...
	X5BX5Deq___importer_2284((&(*c).importModuleMap), (NI)((NI)((NU32)(((NI) ((*xX60gensym103_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym103_).Sup.itemId.item))), (NI)((NI)((NU32)(((NI) ((*xX60gensym104_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym104_).Sup.itemId.item))));
	return result;
}
static N_INLINE(void, suggestSym__sigmatch_5375)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ** usageSym, NIM_BOOL isDecl) {
													...
													j_2 = ((NI) 0);
													{
														while (1) {
															if (!!((w == ((NU) 0)))) goto LA36;
															{
																...
																T41_ = (NI)0;
																T41_ = pluspercent___system_696((NI)((NU32)(i_4) << (NU32)(((NI) 5))), j_2);
...
N_LIB_PRIVATE N_NIMCALL(void, afterImport__importer_3615)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* m) {
	...
	xX60gensym139_ = m;
	T1_ = (NI*)0;
	T1_ = X5BX5D___importer_3714((&(*c).importModuleMap), (NI)((NI)((NU32)(((NI) ((*xX60gensym139_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym139_).Sup.itemId.item))));
	realModuleId = (*T1_);
	{
			...
			r = initRodIterAllSyms__icZic_8667((&rodIt), (*(*c).graph).config, (*(*c).graph).cache, (&(*(*c).graph).packed_0), ((NI32) ((*m).position)), importHidden);
			{
				while (1) {
					...
					s = r;
					{
						...
						if (!!(((NI)((NI)((NU32)(((NI) ((*xX60gensym141_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym141_).Sup.itemId.item))) == realModuleId))) goto LA12_;
						xX60gensym142_ = m;
						T14_.Field0 = (NI)((NI)((NU32)(((NI) ((*xX60gensym142_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym142_).Sup.itemId.item)));
						xX60gensym143_ = s;
						T14_.Field1 = (NI)((NI)((NU32)(((NI) ((*xX60gensym143_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym143_).Sup.itemId.item)));
					...
					while (1) {
						...
						s_2 = &colontmp_->data[i];
						{
							...
							s = (*s_2);
							{
								...
								if (!!(((NI)((NI)((NU32)(((NI) ((*xX60gensym141__2).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym141__2).Sup.itemId.item))) == realModuleId))) goto LA30_;
								xX60gensym142__2 = m;
								T32_.Field0 = (NI)((NI)((NU32)(((NI) ((*xX60gensym142__2).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym142__2).Sup.itemId.item)));
								xX60gensym143__2 = s;
								T32_.Field1 = (NI)((NI)((NU32)(((NI) ((*xX60gensym143__2).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym143__2).Sup.itemId.item)));
		...
		L = T3_;
		{
			while (1) {
				...
				it = (&(*(*c).graph).ifaces->data[(*fromMod).position].converters->data[i]);
				{
					...
					T8_ = (NIM_BOOL)0;
					T8_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU32)(((NI) ((*xX60gensym72_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym72_).Sup.itemId.item))));
					if (!!(T8_)) goto LA9_;
					loadPackedSym__modulegraphs_8940((*c).graph, it);
					{
		...
		L_2 = T16_;
		{
			while (1) {
				...
				it_2 = (&(*(*c).graph).ifaces->data[(*fromMod).position].patterns->data[i_2]);
				{
					...
					T21_ = (NIM_BOOL)0;
					T21_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU32)(((NI) ((*xX60gensym75_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym75_).Sup.itemId.item))));
					if (!!(T21_)) goto LA22_;
					loadPackedSym__modulegraphs_8940((*c).graph, it_2);
					{
		...
		L_3 = T29_;
		{
			while (1) {
				...
				it_3 = (&(*(*c).graph).ifaces->data[(*fromMod).position].pureEnums->data[i_3]);
				{
					...
					T34_ = (NIM_BOOL)0;
					T34_ = contains__astalgo_3496(exceptSet, (NI)((NI)((NU32)(((NI) ((*xX60gensym78_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym78_).Sup.itemId.item))));
					if (!!(T34_)) goto LA35_;
					loadPackedSym__modulegraphs_8940((*c).graph, it_3);
					importPureEnumFields__importer_77(c, (*it_3).sym, (*(*it_3).sym).typ);
				}
...
N_LIB_PRIVATE N_NIMCALL(void, rawImportSymbol__importer_119)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* origin, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* importSet) {
	...
	xX60gensym15_ = s;
	incl__pureZcollectionsZintsets_55(importSet, (NI)((NI)((NU32)(((NI) ((*xX60gensym15_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym15_).Sup.itemId.item))));
	{
