...
static N_INLINE(NIM_BOOL, isUpperAscii__strutils50_25)(NIM_CHAR c);
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
	T1_ = (void*)0;
...
N_LIB_PRIVATE N_NIMCALL(void, setLen__strutils50_5)(NimStringDesc** result, NI n, NIM_BOOL isInit) {
	...
	unsureAsgnRef((void**) (&(*result)), setLengthStr((*result), ((NI) (n))));
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		zeroMem__system_1724(((void*) ((&(*result)->data[n0]))), ((NI) ((NI)(n - n0))));
	}
	LA5_: ;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
...
N_LIB_PRIVATE N_NIMCALL(void, forceCopy__strutils50_10)(NimStringDesc** result, NimStringDesc* a) {
	...
	copyMem__system_1727(T1_, T2_, ((NI) (n)));
}
static N_INLINE(NIM_BOOL, isUpperAscii__strutils50_25)(NIM_CHAR c) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
		...
		L = ((*a) ? (*a)->Sup.len : 0);
		{
			while (1) {
				...
				T4_ = (NI)0;
				{
					NIM_BOOL T7_;
					T7_ = (NIM_BOOL)0;
					T7_ = isUpperAscii__strutils50_25((*c));
					if (!T7_) goto LA8_;
					T4_ = ((NI) 32);
				}
				goto LA5_;
