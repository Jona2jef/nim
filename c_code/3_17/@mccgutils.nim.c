...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TCTypeKind__ceqS9bAmd9bxxuxr8tfIIw5w, mapSetType__ccgutils_140)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TType__facALICuu8zUj0hjvbTLFg* typ);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, getPragmaStmt__ccgutils_11)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw w);
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TCTypeKind__ceqS9bAmd9bxxuxr8tfIIw5w, mapSetType__ccgutils_140)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TType__facALICuu8zUj0hjvbTLFg* typ) {
	...
	T1_ = (NI64)0;
	T1_ = getSize__types_3336(conf, typ);
	switch (((NI) (T1_))) {
	case ((NI) 1):
	{
...
{	result = (NIM_BOOL)0;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 17):
	{
		...
		LA13_: ;
		{
			...
			if (T16_) goto LA17_;
			T18_ = (NI64)0;
			T18_ = getSize__types_3336(conf, pt);
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 18):
	{
		...
		T28_ = (NIM_BOOL)0;
		T29_ = (NI64)0;
		T29_ = getSize__types_3336(conf, pt);
	...
	}
	{
		...
		T44_ = mapSetType__ccgutils_140(conf, pt);
...
appendString(result, ((NimStringDesc*) &TM__Z07Nb1SkYoziC0Zz9be4mTA_22));
				...
				default:
				{
					...
					T40_ = NIM_NIL;
					T41_ = NIM_NIL;
					T41_ = toHex__pureZstrutils_1792(((NU8)(c)), ((NI) 2));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, makeSingleLineCString__ccgutils_108)(NimStringDesc* s) {
	NimStringDesc* result;
	result = NIM_NIL;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					result = getPragmaStmt__ccgutils_11((*n)._kind_6.sons->data[i], w);
					{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					i_3 = i_4;
					{
						...
						T15_ = whichPragma__trees_244((*n)._kind_6.sons->data[i_3]);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, stmtsContainPragma__ccgutils_42)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw w) {
	NIM_BOOL result;
	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* T1_;
	result = (NIM_BOOL)0;
	T1_ = NIM_NIL;
	T1_ = getPragmaStmt__ccgutils_11(n, w);
	result = !((T1_ == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI64, hashString__ccgutils_50)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* s) {
	NI64 result;
	result = (NI64)0;
	{
		NU64 b;
		if (!(CPU__platform_691[((*conf).target.targetCPU)- 1].Field4 == ((NI) 64))) goto LA3_;
		b = 0ULL;
		{
			NI i;
			NI colontmp_;
