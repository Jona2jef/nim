...
N_LIB_PRIVATE N_NIMCALL(void, addDeclaredLoc__astmsgs_17)(NimStringDesc** result, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* sym) {
	...
	T1_[0] = toHumanStr__ast_5158((*sym).kind);
	T1_[1] = toFileLineCol__msgs_619(conf, (*sym).info);
	T2_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, genFieldDefect__astmsgs_61)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* field, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* disc) {
	...
	result = nsuFormatOpenArray(((NimStringDesc*) &TM__CwZLJRLFLWYZLf7meTG1cw_6), T1_, 2);
	{
		...
		T6_ = NIM_NIL;
		T6_ = toFileLineCol__msgs_619(conf, (*disc).info);
		T7_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(void, addDeclaredLoc__astmsgs_33)(NimStringDesc** result, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TType__facALICuu8zUj0hjvbTLFg* typ) {
	...
	T1_ = NIM_NIL;
	T1_ = toHumanStr__ast_5188((*typ_2).kind);
	T2_ = NIM_NIL;
...
appendString((*result), T2_);
	{
		...
		T7_ = NIM_NIL;
		T8_ = NIM_NIL;
		T8_ = toFileLineCol__msgs_619(conf, (*(*typ_2).sym).info);
...
N_LIB_PRIVATE N_NIMCALL(void, addDeclaredLocMaybe__astmsgs_21)(NimStringDesc** result, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* sym) {
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, typSym__astmsgs_5)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t) {
...
N_LIB_PRIVATE N_NIMCALL(void, addDeclaredLocMaybe__astmsgs_51)(NimStringDesc** result, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TType__facALICuu8zUj0hjvbTLFg* typ) {
	{
