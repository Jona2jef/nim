...
static N_INLINE(NimStringDesc*, getCurrentExceptionMsg__system_7012)(void);
...
static N_INLINE(void, setCurrentDir__pureZos_713)(NimStringDesc* newDir);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__pureZos_1411)(NimStringDesc* source, NimStringDesc* dest);
...
N_LIB_PRIVATE N_NIMCALL(NI64, toUnix__pureZtimes_914)(tyObject_Time__3y2ZpqsTJLqdZvpC9a0rU2Q t);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, paramStr__pureZos_1496)(NI i);
...
N_LIB_PRIVATE N_NIMCALL(NI, paramCount__pureZos_1502)(void);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAll__systemZio_352)(FILE* file);
	...
	result = NIM_NIL;
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA4_;
			{
				...
				raiseOSError__pureZos_387(T10_, dir);
			}
			LA8_: ;
		}
		goto LA2_;
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							case ((NI) 0):
							{
								...
								LA45_: ;
								{
									...
									if (!T48_) goto LA49_;
									k = getSymlinkFileKind__pureZos_1194(path_2);
								}
								goto LA38_;
								LA49_: ;
								LA38_: ;
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_59)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	popSafePoint();
		...
		if (isObj(nimBorrowCurrentException()->Sup.m_type, (&NTIoserror__BeJgrOdDsczOwEWOZbRfKA_))) {
			...
			asgnRef((void**) (&(*colonenvP_).errorMsg1), getCurrentExceptionMsg__system_7012());
			popCurrentException();
		}
	}
...
static N_INLINE(void, setCurrentDir__pureZos_713)(NimStringDesc* newDir) {
	{
		...
		T6_ = (NI32)0;
		T6_ = osLastError__pureZos_390();
		raiseOSError__pureZos_387(T6_, newDir);
	}
	LA4_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_79)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T1_ = NIM_NIL;
	T1_ = getString__vm_352(a, ((NI) 0));
	setCurrentDir__pureZos_713(T1_);
	popSafePoint();
	}
	else {
		popSafePoint();
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_107)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T3_ = (NI64)0;
	T3_ = toUnix__pureZtimes_914(T2_);
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_109)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T1_ = getString__vm_352(a, ((NI) 0));
	T2_ = NIM_NIL;
	T2_ = findExe__pureZos_626(T1_, NIM_TRUE, ExeExts__pureZos_625, 1);
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_143)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	colonenvP_ = (tyObject_Env_scriptconfigdotnim_setupVM___fRIisSpi80C8vRwjz9bkirQ*) ClE_0;
	T1_ = NIM_NIL;
	T1_ = getNimcacheDir__options_4183((*colonenvP_).conf3);
	setResult__vm_243(a, T1_);
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_145)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	NI64 T1_;
	...
	T2_ = NIM_NIL;
	T2_ = paramStr__pureZos_1496(((NI) (T1_)));
	setResult__vm_243(a, T2_);
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_147)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	NI T1_;
	T1_ = (NI)0;
	T1_ = paramCount__pureZos_1502();
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_153)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	(*(*colonenvP_).conf3).globalOptions |= ((NU64)1)<<((((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 2)) & 63);
	{
		...
		setFromProjectName__options_4088((*colonenvP_).conf3, arg);
	}
	LA4_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_160)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
...
appendString(T1_, T3_);
	...
	val = nosaddFileExt(T4_, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_74));
	{
		...
		if (!T7_) goto LA8_;
		val = pathSubs__options_4205((*colonenvP_).conf3, val, (*colonenvP_).vthisDir4);
	}
	goto LA5_;
	LA8_: ;
	{
		...
		if (!!(T11_)) goto LA12_;
		val = slash___pureZos_121((*colonenvP_).vthisDir4, val);
	}
	goto LA5_;
	LA12_: ;
	LA5_: ;
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_176)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	LA5_: ;
	{
		...
		T8_ = NIM_NIL;
		T8_ = readLine__systemZio_273(stdin);
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_182)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	LA5_: ;
	{
		...
		setResult__vm_243(a, ((NimStringDesc*) NIM_NIL));
		T8_ = NIM_NIL;
		T8_ = readAll__systemZio_352(stdin);
		setResult__vm_243(a, T8_);
	}
	LA1_: ;
	popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TCtx__S3Av1Ng7MBWGEZZBhfDYCw*, setupVM__scriptconfig_39)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, NimStringDesc* scriptName, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	T6_ = (NI)0;
	T6_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_12), T5_);
	nimZeroMem((void*)(&T7_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T7_.ClP_0 = colonanonymous___scriptconfig_63; T7_.ClE_0 = colonenv_;
	T8_ = (NI)0;
	T8_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_14), T7_);
	nimZeroMem((void*)(&T9_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T9_.ClP_0 = colonanonymous___scriptconfig_69; T9_.ClE_0 = colonenv_;
	T10_ = (NI)0;
	T10_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_16), T9_);
	...
	T12_ = (NI)0;
	T12_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_18), T11_);
	...
	T14_ = (NI)0;
	T14_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_20), T13_);
	...
	T16_ = (NI)0;
	T16_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_21), T15_);
	...
	T18_ = (NI)0;
	T18_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_23), T17_);
	...
	T20_ = (NI)0;
	T20_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_25), T19_);
	...
	T22_ = (NI)0;
	T22_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_27), T21_);
	...
	T24_ = (NI)0;
	T24_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_29), T23_);
	...
	T26_ = (NI)0;
	T26_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_31), T25_);
	...
	T28_ = (NI)0;
	T28_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_33), T27_);
	...
	T30_ = (NI)0;
	T30_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_35), T29_);
	...
	T32_ = (NI)0;
	T32_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_37), T31_);
	nimZeroMem((void*)(&T33_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T33_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_40) (colonanonymous___scriptconfig_117)); T33_.ClE_0 = NIM_NIL;
	T34_ = (NI)0;
	T34_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_39), T33_);
	nimZeroMem((void*)(&T35_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T35_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_42) (colonanonymous___scriptconfig_119)); T35_.ClE_0 = NIM_NIL;
	T36_ = (NI)0;
	T36_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_41), T35_);
	nimZeroMem((void*)(&T37_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T37_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_44) (colonanonymous___scriptconfig_121)); T37_.ClE_0 = NIM_NIL;
	T38_ = (NI)0;
	T38_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_43), T37_);
	nimZeroMem((void*)(&T39_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T39_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_46) (colonanonymous___scriptconfig_123)); T39_.ClE_0 = NIM_NIL;
	T40_ = (NI)0;
	T40_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_45), T39_);
	nimZeroMem((void*)(&T41_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T41_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_48) (colonanonymous___scriptconfig_125)); T41_.ClE_0 = NIM_NIL;
	T42_ = (NI)0;
	T42_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_47), T41_);
	nimZeroMem((void*)(&T43_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T43_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_50) (colonanonymous___scriptconfig_127)); T43_.ClE_0 = NIM_NIL;
	T44_ = (NI)0;
	T44_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_49), T43_);
	...
	T46_ = (NI)0;
	T46_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_51), T45_);
	...
	T48_ = (NI)0;
	T48_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_52), T47_);
	...
	T50_ = (NI)0;
	T50_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_53), T49_);
	...
	T52_ = (NI)0;
	T52_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_54), T51_);
	...
	T54_ = (NI)0;
	T54_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_55), T53_);
	...
	T56_ = (NI)0;
	T56_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_56), T55_);
	...
	T58_ = (NI)0;
	T58_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_57), T57_);
	...
	T60_ = (NI)0;
	T60_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_58), T59_);
	nimZeroMem((void*)(&T61_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T61_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_60) (colonanonymous___scriptconfig_145)); T61_.ClE_0 = NIM_NIL;
	T62_ = (NI)0;
	T62_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_59), T61_);
	nimZeroMem((void*)(&T63_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T63_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_62) (colonanonymous___scriptconfig_147)); T63_.ClE_0 = NIM_NIL;
	T64_ = (NI)0;
	T64_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_61), T63_);
	nimZeroMem((void*)(&T65_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T65_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_64) (colonanonymous___scriptconfig_149)); T65_.ClE_0 = NIM_NIL;
	T66_ = (NI)0;
	T66_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_63), T65_);
	nimZeroMem((void*)(&T67_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T67_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_66) (colonanonymous___scriptconfig_151)); T67_.ClE_0 = NIM_NIL;
	T68_ = (NI)0;
	T68_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_65), T67_);
	...
	T70_ = (NI)0;
	T70_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_67), T69_);
	...
	T72_ = (NI)0;
	T72_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_68), T71_);
	...
	T74_ = (NI)0;
	T74_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_69), T73_);
	...
	T76_ = (NI)0;
	T76_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_70), T75_);
	...
	T78_ = (NI)0;
	T78_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_71), T77_);
	...
	T80_ = (NI)0;
	T80_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_72), T79_);
	nimZeroMem((void*)(&T81_), sizeof(tyProc__5QC9cKfPJmKuW0XbCTd8ylA));
	T81_.ClP_0 = ((TM__FA6jNt3IW9afkuZFmR0bnUQ_77) (colonanonymous___scriptconfig_172)); T81_.ClE_0 = NIM_NIL;
	T82_ = (NI)0;
	T82_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_76), T81_);
	...
	T84_ = (NI)0;
	T84_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_78), T83_);
	...
	T86_ = (NI)0;
	T86_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_79), T85_);
	...
	T88_ = (NI)0;
	T88_ = registerCallback__vmdef_433(result, ((NimStringDesc*) &TM__FA6jNt3IW9afkuZFmR0bnUQ_81), T87_);
	return result;
}
