...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOf__aliases_124)(tyObject_TType__facALICuu8zUj0hjvbTLFg* a, tyObject_TType__facALICuu8zUj0hjvbTLFg* b);
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOfAux__aliases_13)(tyObject_TType__facALICuu8zUj0hjvbTLFg* a, tyObject_TType__facALICuu8zUj0hjvbTLFg* b, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker);
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOfAux__aliases_17)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TType__facALICuu8zUj0hjvbTLFg* b, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker);
...
{	result = (tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					result = isPartOfAux__aliases_17((*n)._kind_6.sons->data[i], b, marker);
					{
	...
	{
		result = isPartOfAux__aliases_17((*n)._kind_6.sons->data[((NI) 0)], b, marker);
		{
			...
			i_4 = ((NI) 1);
			{
				while (1) {
					...
					case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 88):
					{
						...
						result = isPartOfAux__aliases_17(T18_, b, marker);
						{
	...
	{
		result = isPartOfAux__aliases_13((*(*n)._kind_4.sym).typ, b, marker);
	}
	break;
	default:
	{
...
{	result = (tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	...
	LA5_: ;
	{
		...
		xX60gensym7_ = a;
		T9_ = (NIM_BOOL)0;
		T9_ = containsOrIncl__astalgo_402(marker, (NI)((NI)((NU64)(((NI) ((*xX60gensym7_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym7_).Sup.itemId.item))));
		if (!T9_) goto LA10_;
		goto BeforeRet_;
	}
	LA10_: ;
	{
		NIM_BOOL T14_;
		T14_ = (NIM_BOOL)0;
		T14_ = compareTypes__types_2668(a, b, ((tyEnum_TDistinctCompare__9bNKHGs63atuMFXnAleTveg) 1), 0);
		if (!T14_) goto LA15_;
	...
	{
		{
			...
			result = isPartOfAux__aliases_13(T22_, b, marker);
		}
		LA20_: ;
		{
			if (!(result == ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0))) goto LA25_;
			result = isPartOfAux__aliases_17((*a).n, b, marker);
		}
		LA25_: ;
	}
	break;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 46):
	{
		...
		T28_ = NIM_NIL;
		T28_ = lastSon__ast_3743(a);
		result = isPartOfAux__aliases_13(T28_, b, marker);
	}
	break;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					result = isPartOfAux__aliases_13((*a).sons->data[i], b, marker);
					{
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOf__aliases_124)(tyObject_TType__facALICuu8zUj0hjvbTLFg* a, tyObject_TType__facALICuu8zUj0hjvbTLFg* b) {
	...
	result = isPartOfAux__aliases_13(b, a, (&marker));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOf__aliases_129)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w result;
	result = (tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	{
			...
			{
				{
					...
					T18_ = isPartOf__aliases_124((*(*a)._kind_4.sym).typ, (*(*b)._kind_4.sym).typ);
		...
		{
			result = isPartOf__aliases_129((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 0)]);
			{
				NIM_BOOL T24_;
				NI T25_;
				NI T27_;
				T24_ = (NIM_BOOL)0;
				T25_ = (NI)0;
				T25_ = len__ast_3198(a);
				T24_ = (((NI) 2) <= T25_);
				if (!(T24_)) goto LA26_;
				T27_ = (NI)0;
				T27_ = len__ast_3198(b);
				T24_ = (((NI) 2) <= T27_);
				LA26_: ;
				if (!T24_) goto LA28_;
				{
					...
					if (!(T33_)) goto LA34_;
					T33_ = isDeepConstExpr__trees_171((*a)._kind_6.sons->data[((NI) 1)], NIM_FALSE);
					LA34_: ;
					T32_ = T33_;
					if (!(T32_)) goto LA35_;
					T32_ = isDeepConstExpr__trees_171((*b)._kind_6.sons->data[((NI) 1)], NIM_FALSE);
					LA35_: ;
					if (!T32_) goto LA36_;
					{
					...
					LA43_: ;
					{
						NIM_BOOL T50_;
						T50_ = (NIM_BOOL)0;
						T50_ = sameValue__astalgo_119(x, y);
						if (!T50_) goto LA51_;
						result = ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 2);
					}
					goto LA48_;
			...
			{
				{
					if (!!((result == ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 2)))) goto LA57_;
					{
						...
						T61_ = isPartOf__aliases_124((*a).typ, (*b).typ);
		...
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 47):
		{
			result = isPartOf__aliases_129((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 0)]);
			{
				if (!!((result == ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 2)))) goto LA76_;
				{
					...
					T80_ = isPartOf__aliases_124((*a).typ, (*b).typ);
		...
		{
			result = isPartOf__aliases_129((*a)._kind_6.sons->data[((NI) 1)], (*b)._kind_6.sons->data[((NI) 1)]);
		}
		break;
	...
	LA3_: ;
	{
		...
		{
			result = isPartOf__aliases_129(a, (*b)._kind_6.sons->data[((NI) 0)]);
		}
		break;
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 47):
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 65):
		{
			{
				...
				T91_ = isPartOf__aliases_124((*a).typ, (*b).typ);
		...
		{
			result = isPartOf__aliases_129(a, (*b)._kind_6.sons->data[((NI) 1)]);
		}
		break;
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
		{
			...
			case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 66) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 67):
			{
				result = isPartOf__aliases_129((*a)._kind_6.sons->data[((NI) 0)], b);
			}
			break;
			case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 58) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 60):
			{
				result = isPartOf__aliases_129((*a)._kind_6.sons->data[((NI) 1)], b);
			}
			break;
			case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 47):
			case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 65):
			{
				{
					...
					T105_ = isPartOf__aliases_124((*a).typ, (*b).typ);
			...
			result = ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0);
			{
				...
				i_2 = ((NI) 1);
				{
					while (1) {
						...
						i = i_2;
						res = isPartOf__aliases_129(a, (*(*b)._kind_6.sons->data[i])._kind_6.sons->data[((NI) 1)]);
						{
			...
			result = ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0);
			{
				...
				i_4 = ((NI) 1);
				{
					while (1) {
						...
						i_3 = i_4;
						res_2 = isPartOf__aliases_129(a, (*b)._kind_6.sons->data[i_3]);
						{
