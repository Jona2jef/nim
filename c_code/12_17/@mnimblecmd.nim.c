...
N_LIB_PRIVATE N_NIMCALL(void, insert__nimblecmd_47)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ** x, NimStringDesc* item, NI i);
...
N_LIB_PRIVATE N_NIMCALL(void, addPathRec__nimblecmd_2087)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* dir, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(void, addPackage__nimblecmd_206)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_Table__d05ldtnZIkg8hVpY02dsdA* packages, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
N_LIB_PRIVATE N_NIMCALL(void, getPathVersionChecksum__nimblecmd_171)(NimStringDesc* p, tyTuple__7q7q3E6Oj24ZNVJb9aonhAg* Result);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isValidVersion__nimblecmd_135)(NimStringDesc* v);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, newVersion__nimblecmd_107)(NimStringDesc* ver);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, lt___nimblecmd_146)(NimStringDesc* ver, NimStringDesc* ver2);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isSpecial__nimblecmd_132)(NimStringDesc* ver);
...
N_LIB_PRIVATE N_NIMCALL(void, getOrDefault__nimblecmd_281)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key, tyTuple__UV3llMMYFckfui8YMBuUZA* Result);
static N_INLINE(NI, rawGet__nimblecmd_290)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key, NI* hc);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__nimblecmd_623)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key);
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___nimblecmd_676)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA* t, NimStringDesc* key, tyTuple__UV3llMMYFckfui8YMBuUZA val);
...
static N_INLINE(NIM_BOOL, mustRehash__nimblecmd_849)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__nimblecmd_1002)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA* t);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__nimblecmd_1306)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA* t, tySequence__6j25whH7XTBoIXcM0x1T7A** data, NimStringDesc* key, tyTuple__UV3llMMYFckfui8YMBuUZA val, NI hc, NI h);
static N_INLINE(NI, rawGetKnownHC__nimblecmd_1475)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key, NI hc);
...
N_LIB_PRIVATE N_NIMCALL(NI, len__nimblecmd_1808)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__nimblecmd_2053)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info);
...
static N_INLINE(NI, find__nimblecmd_2112)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* a, NimStringDesc* item);
N_LIB_PRIVATE N_NIMCALL(void, delete__nimblecmd_2131)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ** x, NI i);
...
STRING_LITERAL(TM__asNQM9aynXXg9ccUABbReyew_12, "/home/runner/work/nightlies/nightlies/nim/compiler/nimblecmd.nim", 64);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = (&a[i_2]);
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = eqeq___options_4073((*i), item);
					if (!T6_) goto LA7_;
					goto BeforeRet_;
				}
				LA7_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, addPath__nimblecmd_11)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* path, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	{
		...
		if (!!(T3_)) goto LA4_;
		insert__nimblecmd_47((&(*conf).searchPaths), path, ((NI) 0));
	}
	LA4_: ;
}
static N_INLINE(void, nimSetMem__systemZmemory_7)(void* a, int v, NI size) {
...
N_LIB_PRIVATE N_NIMCALL(void, getPathVersionChecksum__nimblecmd_171)(NimStringDesc* p, tyTuple__7q7q3E6Oj24ZNVJb9aonhAg* Result) {
	...
	checksumSeparatorIndex = nsuRFindChar(p, 45, ((NI) 0), ((NI) -1));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field2), substr__system_7785(p, (NI)(checksumSeparatorIndex + ((NI) 1))));
		{
			NIM_BOOL T7_;
			T7_ = (NIM_BOOL)0;
	...
	versionSeparatorIndex = nsuRFindStr(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_5), ((NI) 0), (NI)(checksumSeparatorIndex - ((NI) 1)));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field1), substr__system_7773(p, (NI)(versionSeparatorIndex + ((NI) 1)), (NI)(checksumSeparatorIndex - ((NI) 1))));
	}
	goto LA11_;
	LA13_: ;
	{
...
{	result = (NIM_BOOL)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isSpecial__nimblecmd_132(ver);
		if (T3_) goto LA4_;
		T3_ = isSpecial__nimblecmd_132(ver2);
		LA4_: ;
		if (!T3_) goto LA5_;
		{
			NIM_BOOL T9_;
			...
			NimStringDesc* T14_;
			T9_ = (NIM_BOOL)0;
			T9_ = isSpecial__nimblecmd_132(ver2);
			if (!(T9_)) goto LA10_;
			T11_ = NIM_NIL;
		...
		LA12_: ;
		{
			...
			NimStringDesc* T20_;
			T17_ = (NIM_BOOL)0;
			T17_ = isSpecial__nimblecmd_132(ver2);
			if (!!(T17_)) goto LA18_;
			T20_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(void, getOrDefault__nimblecmd_281)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key, tyTuple__UV3llMMYFckfui8YMBuUZA* Result) {
	...
	unsureAsgnRef((void**)&(*Result).Field1, NIM_NIL);
	hcX60gensym14_ = (NI)0;
	indexX60gensym14_ = rawGet__nimblecmd_290(t, key, (&hcX60gensym14_));
	{
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasKey__nimblecmd_623)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA t, NimStringDesc* key) {
	...
	hc = (NI)0;
	T1_ = (NI)0;
	T1_ = rawGet__nimblecmd_290(t, key, (&hc));
	result = (((NI) 0) <= T1_);
	return result;
}
static N_INLINE(NI, slotsNeeded__pureZcollectionsZtables_42)(NI count) {
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				eh = n->data[i].Field0;
				{
					...
					rawInsert__nimblecmd_1306(t, (&(*t).data), T17_, T18_, eh, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___nimblecmd_676)(tyObject_Table__d05ldtnZIkg8hVpY02dsdA* t, NimStringDesc* key, tyTuple__UV3llMMYFckfui8YMBuUZA val) {
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__nimblecmd_290((*t), key, (&hc));
	{
		NimStringDesc* T10_;
		NimStringDesc* T11_;
	...
	LA8_: ;
	{
		...
		LA16_: ;
		{
			NIM_BOOL T20_;
			T20_ = (NIM_BOOL)0;
			T20_ = mustRehash__nimblecmd_849((*t));
			if (!T20_) goto LA21_;
			enlarge__nimblecmd_1002(t);
			index = rawGetKnownHC__nimblecmd_1475((*t), key, hc);
		}
		LA21_: ;
		index = (NI)(((NI) -1) - index);
		rawInsert__nimblecmd_1306(t, (&(*t).data), key, val, hc, index);
		(*t).counter += ((NI) 1);
	}
	LA6_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, addPackage__nimblecmd_206)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_Table__d05ldtnZIkg8hVpY02dsdA* packages, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	getPathVersionChecksum__nimblecmd_171(p, (&T1_));
	name = NIM_NIL;
	name = T1_.Field0;
	ver = NIM_NIL;
	ver = T1_.Field1;
	...
	checksum = T1_.Field2;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = isValidVersion__nimblecmd_135(ver);
		if (!T4_) goto LA5_;
		version = newVersion__nimblecmd_107(ver);
		{
			NIM_BOOL T9_;
			...
			getOrDefault__nimblecmd_281((*packages), name, (&T10_));
			T11_ = NIM_NIL;
			T11_ = newVersion__nimblecmd_107(T10_.Field0);
			T9_ = lt___nimblecmd_146(T11_, version);
			if (T9_) goto LA12_;
			T13_ = (NIM_BOOL)0;
			T13_ = hasKey__nimblecmd_623((*packages), name);
			T9_ = !(T13_);
			LA12_: ;
			if (!T9_) goto LA14_;
			{
				...
				X5BX5Deq___nimblecmd_676(packages, name, T21_);
			}
			goto LA16_;
			LA19_: ;
			{
				...
				X5BX5Deq___nimblecmd_676(packages, name, T23_);
			}
			LA16_: ;
		}
		LA14_: ;
...
appendString(T25_, p);
		liMessage__msgs_1118(conf, info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T25_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__asNQM9aynXXg9ccUABbReyew_11, NIM_FALSE);
	}
	LA2_: ;
}
static N_INLINE(void, popSafePoint)(void) {
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__nimblecmd_2053)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	resultX60gensym38_ = NIM_NIL;
	{
		...
		colontmp_ = NIM_NIL;
		colontmp_ = slash___pureZos_121(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_13));
	...
	nimbleLinks = resultX60gensym38_;
	{
		...
		T23_ = NIM_NIL;
		T23_ = readFile__systemZio_467(nimbleLinks->data[((NI) 0)]);
		...
		path = copyString(nimbleLinkLines->data[((NI) 1)]);
		{
			...
			if (!!(T26_)) goto LA27_;
			path = slash___pureZos_121(p, path);
		}
		LA27_: ;
	}
	LA21_: ;
	{
		NIM_BOOL T31_;
		T31_ = (NIM_BOOL)0;
		T31_ = contains__nimblecmd_15((*conf).searchPaths->data, ((*conf).searchPaths ? (*conf).searchPaths->Sup.len : 0), path);
		if (!!(T31_)) goto LA32_;
		liMessage__msgs_1118(conf, info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 84), path, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__asNQM9aynXXg9ccUABbReyew_15, NIM_FALSE);
		insert__nimblecmd_47((&(*conf).lazyPaths), path, ((NI) 0));
	}
	LA32_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, addPathRec__nimblecmd_2087)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* dir, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	LA3_: ;
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA8_;
			{
				...
				raiseOSError__pureZos_387(T14_, dir);
			}
			LA12_: ;
		}
		goto LA6_;
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							path = slash___pureZos_121(dir, y);
							{
							...
							case ((NI) 0):
							{
								...
								LA49_: ;
								{
									...
									if (!T52_) goto LA53_;
									k_2 = getSymlinkFileKind__pureZos_1194(path);
								}
								goto LA42_;
								LA53_: ;
								LA42_: ;
							...
							p = y;
							{
								...
								LA59_: ;
								if (!T58_) goto LA60_;
								addPackage__nimblecmd_206(conf, (&packages), p, info);
							}
							LA60_: ;
						}
						LA27_: ;
	...
	}
	{
		...
		p_2 = NIM_NIL;
		{
			...
			L = len__nimblecmd_1808(packages);
			{
				NI h;
				NI colontmp_;
				NI T68_;
				...
				res = ((NI) 0);
				{
					while (1) {
						...
						h = res;
						{
							...
							NimStringDesc* res_2;
							T73_ = (NIM_BOOL)0;
							T73_ = isFilled__pureZcollectionsZtables_31(packages.data->data[h].Field0);
							if (!T73_) goto LA74_;
...
appendString(res_2, val.Field1);
							...
							LA82_: ;
							p_2 = res_2;
							addNimblePath__nimblecmd_2053(conf, p_2, info);
						}
						LA74_: ;
						res += ((NI) 1);
					} LA70: ;
		...
		L = T2_;
		{
			while (1) {
				...
				i = (&a->data[i_2]);
				{
					NIM_BOOL T7_;
					T7_ = (NIM_BOOL)0;
					T7_ = eqeq___options_4073((*i), item);
					if (!T7_) goto LA8_;
					goto BeforeRet_;
				}
				LA8_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, nimblePath__nimblecmd_2108)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* path, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	NI i;
	addPathRec__nimblecmd_2087(conf, path, info);
	addNimblePath__nimblecmd_2053(conf, path, info);
	i = find__nimblecmd_2112((*conf).nimblePaths, path);
	{
		if (!!((i == ((NI) -1)))) goto LA3_;
		delete__nimblecmd_2131((&(*conf).nimblePaths), ((NI) (i)));
	}
	LA3_: ;
	insert__nimblecmd_47((&(*conf).nimblePaths), path, ((NI) 0));
}
