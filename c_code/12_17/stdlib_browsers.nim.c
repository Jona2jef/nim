...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, prepare__pureZbrowsers_6)(NimStringDesc* s) {
	...
	LA4_: ;
	{
		...
		T9_ = NIM_NIL;
		T9_ = absolutePath__pureZos_715(s, T8_);
...
appendString(T4_, u);
	...
	LA6_: ;
	{
		...
		b = NIM_NIL;
		colontmp_ = NIM_NIL;
		colontmp_ = getEnv__pureZos_400(((NimStringDesc*) &TM__CZNeKGdQ8AWxD1HSDIq5DQ_6), ((NimStringDesc*) NIM_NIL));
		...
		splitsX60gensym34_ = ((NI) -1);
		{
			while (1) {
				...
				LA17_: ;
				b = substr__system_7773(colontmp_, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
