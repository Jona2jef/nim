...
N_LIB_PRIVATE N_NIMCALL(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog, classifyViewTypeAux__typeallowed_503)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker, tyObject_TType__facALICuu8zUj0hjvbTLFg* t);
...
static N_INLINE(void, combine__typeallowed_486)(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog* dest, tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog b);
N_LIB_PRIVATE N_NIMCALL(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog, classifyViewTypeNode__typeallowed_506)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog, classifyViewTypeNode__typeallowed_506)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	{
		result = classifyViewTypeAux__typeallowed_503(marker, (*n).typ);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 85):
	{
		...
		result = classifyViewTypeNode__typeallowed_506(marker, T3_);
	}
	break;
	default:
	{
			...
			child = NIM_NIL;
			{
				...
				i_2 = ((NI) 0);
				{
					while (1) {
						...
						T9_ = classifyViewTypeNode__typeallowed_506(marker, child);
						combine__typeallowed_486((&result), T9_);
						{
...
{	result = (tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog)0;
	{
		...
		xX60gensym87_ = t;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl__astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym87_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym87_).Sup.itemId.item))));
		if (!T3_) goto LA4_;
		result = ((tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog) 0);
		goto BeforeRet_;
	}
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 60):
	{
		...
		T9_ = NIM_NIL;
		T9_ = lastSon__ast_3743(t);
		result = classifyViewTypeAux__typeallowed_503(marker, T9_);
	}
	break;
	...
	{
		{
			...
			T13_ = (NI)0;
			T13_ = len__ast_4002(t);
			if (!(((NI) 0) < T13_)) goto LA14_;
			T16_ = NIM_NIL;
			T16_ = lastSon__ast_3743(t);
			result = classifyViewTypeAux__typeallowed_503(marker, T16_);
		}
		goto LA11_;
		LA14_: ;
		{
		...
		result = ((tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog) 0);
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					T22_ = classifyViewTypeAux__typeallowed_503(marker, (*t).sons->data[i]);
					combine__typeallowed_486((&result), T22_);
					{
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 17):
	{
		result = ((tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog) 0);
		{
			...
			result = classifyViewTypeNode__typeallowed_506(marker, (*t).n);
		}
		LA30_: ;
		{
			...
			T36_ = classifyViewTypeAux__typeallowed_503(marker, (*t).sons->data[((NI) 0)]);
			combine__typeallowed_486((&result), T36_);
		}
		LA34_: ;
	}
	break;
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog, classifyViewType__typeallowed_564)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t) {
	...
	result = classifyViewTypeAux__typeallowed_503((&marker), t);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, requiresInit__typeallowed_578)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t) {
	...
	T3_ = classifyViewType__typeallowed_564(t);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__facALICuu8zUj0hjvbTLFg*, typeAllowedNode__typeallowed_25)(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* marker, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw kind, tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tySet_tyEnum_TTypeAllowedFlag__JBIyoJI1E5LVXKYAX3xeBg flags) {
	...
	result = NIM_NIL;
	{
		...
		result = typeAllowedAux__typeallowed_19(marker, (*n).typ, kind, c, flags);
		{
			...
			{
				{
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							result = typeAllowedNode__typeallowed_25(marker, it, kind, c, flags);
							{
...
{	result = NIM_NIL;
	...
	LA3_: ;
	{
		...
		xX60gensym6_ = typ;
		T7_ = (NIM_BOOL)0;
		T7_ = containsOrIncl__astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym6_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym6_).Sup.itemId.item))));
		if (!T7_) goto LA8_;
		result = ((tyObject_TType__facALICuu8zUj0hjvbTLFg*) NIM_NIL);
		goto BeforeRet_;
	}
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 47):
	{
		...
		LA24_: ;
		{
			...
			case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 27):
			{
				...
				LA39_: ;
				{
					result = typeAllowedAux__typeallowed_19(marker, (*t2).sons->data[((NI) 0)], kind, c, (flags | 8));
				}
				LA33_: ;
			}
			break;
			case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 49):
			{
				...
				LA47_: ;
				{
					result = typeAllowedAux__typeallowed_19(marker, (*t2).sons->data[((NI) 0)], kind, c, flags);
				}
				LA43_: ;
			}
			break;
			...
			default:
			{
				...
				LA56_: ;
				{
					result = typeAllowedAux__typeallowed_19(marker, t2, kind, c, flags);
				}
				LA52_: ;
			}
			break;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 25):
	{
		...
		LA64_: ;
		{
			tySet_tyEnum_TTypeAllowedFlag__JBIyoJI1E5LVXKYAX3xeBg f;
			{
				NIM_BOOL T69_;
				T69_ = (NIM_BOOL)0;
				T69_ = isInlineIterator__ast_4989(typ);
				if (!(T69_)) goto LA70_;
			...
			LA73_: ;
			{
				...
				i_2 = ((NI) 1);
				{
					while (1) {
						...
						LA83_: ;
						result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[i], ((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 3), c, (f & ~ 8));
						i_2 += ((NI) 1);
					} LA80: ;
				}
			} LA78: ;
			{
				...
				LA88_: ;
				if (!T87_) goto LA89_;
				result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[((NI) 0)], ((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 11), c, flags);
			}
			LA89_: ;
		}
		LA60_: ;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 56) ... ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 59):
	{
		...
		LA128_: ;
		{
			...
			T133_ = NIM_NIL;
			T133_ = lastSon__ast_3743(t);
			result = typeAllowedAux__typeallowed_19(marker, T133_, kind, c, flags);
		}
		goto LA124_;
		LA131_: ;
		{
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 55):
	{
		...
		T152_ = NIM_NIL;
		T152_ = lastSon__ast_3743(t);
		result = typeAllowedAux__typeallowed_19(marker, T152_, kind, c, flags);
	}
	break;
	...
	{
		{
			...
			T156_ = NIM_NIL;
			T156_ = skipTypes__ast_3735((*t).sons->data[((NI) 0)], TM__FLm9aU7VXleJfAvJR1cpHXQ_3);
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 27):
	{
		...
		LA166_: ;
		{
			result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[((NI) 0)], kind, c, (flags | 8));
		}
		LA160_: ;
	}
	break;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 46):
	{
		...
		LA184_: ;
		{
			result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[((NI) 0)], kind, c, flags);
		}
		LA178_: ;
	}
	break;
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 49):
	{
		...
		LA192_: ;
		{
			...
			T195_ = NIM_NIL;
			T195_ = lastSon__ast_3743(t);
			result = typeAllowedAux__typeallowed_19(marker, T195_, kind, c, (flags & ~ 2));
		}
		LA188_: ;
	}
	break;
	...
	{
		{
			...
			result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[((NI) 0)], kind, c, (flags | 2));
		}
		goto LA197_;
		LA199_: ;
		{
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 16):
	{
		...
		LA207_: ;
		{
			...
			result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[((NI) 1)], kind, c, flags);
		}
		goto LA205_;
		LA210_: ;
		{
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 22):
	{
		...
		LA218_: ;
		{
			...
			T221_ = NIM_NIL;
			T221_ = lastSon__ast_3743(t);
			result = typeAllowedAux__typeallowed_19(marker, T221_, kind, c, (flags | 2));
		}
		LA216_: ;
	}
	break;
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 21):
	{
		...
		T223_ = NIM_NIL;
		T223_ = lastSon__ast_3743(t);
		result = typeAllowedAux__typeallowed_19(marker, T223_, kind, c, (flags | 2));
	}
	break;
	...
	{
		{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					i_3 = i_4;
					result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[i_3], kind, c, flags);
					{
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 18):
	{
		...
		LA239_: ;
		{
			...
			flags_2 = (flags | 1);
			{
				...
				i_6 = ((NI) 0);
				{
					while (1) {
						...
						i_5 = i_6;
						result = typeAllowedAux__typeallowed_19(marker, (*t).sons->data[i_5], kind, c, flags_2);
						{
			...
			} LA242: ;
			{
				...
				result = typeAllowedNode__typeallowed_25(marker, (*t).n, kind, c, flags_2);
			}
			LA253_: ;
		}
		LA233_: ;
	...
	{
		{
			...
			T264_ = (NIM_BOOL)0;
			T265_ = (NI)0;
			T265_ = len__ast_4002(t);
			T264_ = (T265_ == ((NI) 1));
			if (!(T264_)) goto LA266_;
			T267_ = NIM_NIL;
			T267_ = skipTypes__ast_3735((*t).sons->data[((NI) 0)], TM__FLm9aU7VXleJfAvJR1cpHXQ_4);
			...
			T270_ = NIM_NIL;
			T270_ = lastSon__ast_3743(t);
			result = typeAllowedAux__typeallowed_19(marker, T270_, kind, c, (flags | 2));
		}
		goto LA262_;
		LA268_: ;
		{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType__facALICuu8zUj0hjvbTLFg*, typeAllowed__typeallowed_472)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw kind, tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tySet_tyEnum_TTypeAllowedFlag__JBIyoJI1E5LVXKYAX3xeBg flags) {
	tyObject_TType__facALICuu8zUj0hjvbTLFg* result;
	tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA marker;
	result = NIM_NIL;
	nimZeroMem((void*)(&marker), sizeof(tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA));
	initIntSet__pureZcollectionsZintsets_238((&marker));
	result = typeAllowedAux__typeallowed_19((&marker), t, kind, c, flags);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog, directViewType__typeallowed_568)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t) {
	tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog result;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 55):
	{
		...
		result = directViewType__typeallowed_568(T4_);
	}
	break;
	default:
	{
