			...
			while (1) {
				...
				count = wait_for_objects_etc((&info), ((int) 1), ((NU32) 8), ((NI64) (timeout)));
				{
					...
					err = ((int) (count));
					{
						if (!(err == ETIMEDOUT)) goto LA25_;
						{
							...
							raiseOSError__pureZos_405(T32_, ((NimStringDesc*) NIM_NIL));
						}
						LA30_: ;
						{
							pid_t T35_;
							...
							raiseOSError__pureZos_405(T38_, ((NimStringDesc*) NIM_NIL));
						}
						LA36_: ;
						(*p).exitFlag = NIM_TRUE;
				...
				LA21_: ;
				{
					if (!(((NI) 0) < count)) goto LA43_;
					{
						...
						T50_ = (NI32)0;
						T50_ = osLastError__pureZos_408();
						raiseOSError__pureZos_405(T50_, ((NimStringDesc*) NIM_NIL));
					}
					LA48_: ;
					(*p).exitFlag = NIM_TRUE;
					(*p).exitStatus = status_2;
