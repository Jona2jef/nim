...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__pureZosproc_320)(void) {
	...
	T7_ = (void*)0;
	T7_ = alloc0Impl__system_1745(((NI) ((NI)((NI)(counter + ((NI) 1)) * ((NI) 4)))));
	result = ((NCSTRING*) (T7_));
	i_2 = ((NI) 0);
	{
		NimStringDesc* key_2;
		...
		val_2 = NIM_NIL;
		{
			...
			gEnv_2 = (*T10_);
			{
				while (1) {
					...
					void* T15_;
					T13_ = (NIM_BOOL)0;
					T13_ = eqeq___system_7723(gEnv_2[i_3], ((NCSTRING) NIM_NIL));
					if (!!(T13_)) goto LA12;
...
{	result = (pid_t)0;
	...
	res = (int)0;
	{
		...
		setCurrentDir__pureZos_750(T100_);
	}
	LA98_: ;
	pid = (pid_t)0;
	{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingDir, NimStringDesc** args, NI argsLen_0, tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* env, tySet_tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA options) {
	...
	pid = startProcessAuxSpawn__pureZosproc_348((&data));
	{
		...
		setCurrentDir__pureZos_750(currentDir);
	}
	LA38_: ;
	{
...
{	result = (NI)0;
	{
		...
		T5_ = (int)0;
		T5_ = exitStatusLikeShell__pureZos_1136((*p).exitStatus);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	...
	LA6_: ;
	T72_ = (int)0;
	T72_ = exitStatusLikeShell__pureZos_1136((*p).exitStatus);
	result = ((NI) (T72_));
	}BeforeRet_: ;
	return result;
}
...
{	result = (NI)0;
	...
	ret = waitpid((*p).id, (&status), WNOHANG);
	{
		if (!(((NI32) 0) < ret)) goto LA8_;
		{
			...
			(*p).exitStatus = status;
			T15_ = (int)0;
			T15_ = exitStatusLikeShell__pureZos_1136(status);
			result = ((NI) (T15_));
		}
		LA13_: ;
	}
