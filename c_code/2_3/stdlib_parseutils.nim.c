...
N_LIB_PRIVATE N_NIMCALL(NI, rawParseUInt__pureZparseutils_375)(NimStringDesc* s, NU64* b, NI start);
...
N_LIB_PRIVATE N_NIMCALL(NI, npuParseBiggestUInt)(NimStringDesc* s, NU64* number, NI start) {
	...
	result = (NI)0;
	res = 0ULL;
	result = rawParseUInt__pureZparseutils_375(s, (&res), start);
	{
		if (!!((result == ((NI) 0)))) goto LA3_;
		(*number) = res;
	}
...
N_LIB_PRIVATE N_NIMCALL(NI, parseIdent__pureZparseutils_57)(NimStringDesc* s, NimStringDesc** ident, NI start) {
	...
	i = start;
	{
		...
		unsureAsgnRef((void**) (&(*ident)), substr__system_7723(s, start, (NI)(i - ((NI) 1))));
		result = (NI)(i - start);
	}
	LA5_: ;
	return result;
