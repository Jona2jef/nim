	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				LA12_: ;
				T14_ = NIM_NIL;
				T14_ = substr__system_7723(s, i, (NI)(j - ((NI) 1)));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA21_: ;
				T23_ = NIM_NIL;
				T23_ = substr__system_7723(s, i_2, (NI)(j_2 - ((NI) 1)));
...
appendString(result, by);
		...
		T24_ = NIM_NIL;
		T24_ = substr__system_7735(s, i_2);
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						NimStringDesc* T69_;
						T69_ = NIM_NIL;
						T69_ = substr__system_7723(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = NIM_NIL;
					T82_ = substr__system_7723(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym34_ = maxsplit;
		{
			while (1) {
				...
				LA10_: ;
				xX60gensym67_ = substr__system_7723(s, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				xX60gensym76_ = substr__system_7723(s, first, T25_);
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T31_ = result->Sup.len++;
				T32_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuStrip)(NimStringDesc* s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	LA11_: ;
	result = substr__system_7723(s, first, last);
	return result;
}
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym41_ = maxsplit;
		{
			while (1) {
				...
				LA15_: ;
				xX60gensym72_ = substr__system_7723(s, firstX60gensym41_, (NI)(lastX60gensym41_ - ((NI) 1)));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T17_ = result->Sup.len++;
				T18_ = NIM_NIL;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				line = substr__system_7723(s, first, T25_);
				{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuCapitalizeAscii)(NimStringDesc* s) {
	...
	LA3_: ;
	{
		...
		T8_ = NIM_NIL;
		T8_ = substr__system_7735(s, ((NI) 1));
