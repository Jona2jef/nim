...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, slash___pathutils_111)(NimStringDesc* base, NimStringDesc* f) {
	...
	result = NIM_NIL;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty__pathutils_93(base);
		if (!T3_) goto LA4_;
	...
	state = ((NI) 0);
	addNormalizePath__pureZpathnorm_71(base_2, (&result), (&state), 47);
	addNormalizePath__pureZpathnorm_71(f, (&result), (&state), 47);
	return result;
}
static N_INLINE(NimStringDesc*, slash___pureZos_121)(NimStringDesc* head, NimStringDesc* tail) {
	NimStringDesc* result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toAbsoluteDir__pathutils_71)(NimStringDesc* path) {
	...
	LA4_: ;
	{
		...
		result = slash___pureZos_121(T7_, path);
	}
	LA1_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toAbsolute__pathutils_137)(NimStringDesc* file, NimStringDesc* base) {
	...
	LA4_: ;
	{
		result = slash___pathutils_89(base, file);
	}
	LA1_: ;
	return result;
}
