...
appendString((*config).commandLine, T11_);
				...
				LA9_: ;
				{
					...
					p.key = copyString(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_5));
					{
						NIM_BOOL T18_;
						T18_ = (NIM_BOOL)0;
						T18_ = processArgument__commands_1518(pass, (&p), (&argsCount), config);
						if (!T18_) goto LA19_;
						goto LA2;
					}
					LA19_: ;
				...
				LA14_: ;
				{
					processSwitch__commands_1511(pass, (&p), config);
				}
				LA12_: ;
			}
			break;
...
appendString((*config).commandLine, T23_);
				{
					NIM_BOOL T26_;
					T26_ = (NIM_BOOL)0;
					T26_ = processArgument__commands_1518(pass, (&p), (&argsCount), config);
					if (!T26_) goto LA27_;
					goto LA2;
				}
				LA27_: ;
	...
	} LA2: ;
	{
		if (!(pass == ((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1))) goto LA31_;
		{
			...
			LA38_: ;
			if (!T35_) goto LA39_;
			liMessage__msgs_1118(config, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_7, NIM_FALSE);
		}
		LA39_: ;
	}
	LA31_: ;
...
static N_INLINE(NimStringDesc*, findNodeJs__nodejs_2)(void) {
	NimStringDesc* result;
	result = NIM_NIL;
	result = findExe__pureZos_653(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts__pureZos_652, 1);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe__pureZos_653(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts__pureZos_652, 1);
	}
	LA3_: ;
	{
...
appendString(T50_, (*conf).arguments);
		...
		case ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 18) ... ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 21):
		{
			NimStringDesc* T59_;
			{
				...
				liMessage__msgs_1118(conf, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T58_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_24, NIM_FALSE);
			}
			LA55_: ;
			T59_ = NIM_NIL;
			T59_ = dollar___options_4373(output);
		...
		default:
		{
			...
			liMessage__msgs_1118(conf, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T62_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_26, NIM_FALSE);
		}
		break;
		}
	}
