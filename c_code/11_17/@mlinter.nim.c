...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, differs__linter_172)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, NimStringDesc* newName);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, differ__linter_74)(NimStringDesc* line, NI a, NI b, NimStringDesc* x);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, substrEq__linter_80)(NimStringDesc* s, NI pos, NI last, NimStringDesc* substr);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, beautifyName__linter_31)(NimStringDesc* s, tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw k);
...
STRING_LITERAL(TM__NvI37FoCN5uTD3k9bAqbGMA_6, "/home/runner/work/nightlies/nightlies/nim/compiler/linter.nim", 61);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, differ__linter_74)(NimStringDesc* line, NI a, NI b, NimStringDesc* x) {
	...
	result = ((NimStringDesc*) NIM_NIL);
	{
		...
		T3_ = (NIM_BOOL)0;
		T3_ = substrEq__linter_80(line, a, b, x);
		if (!!(T3_)) goto LA4_;
		T6_ = dotdot___pureZunicode_840(a, b);
		y = X5BX5D___pureZunicode_865(line, T6_);
		{
			NI T9_;
			T9_ = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, differs__linter_172)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, NimStringDesc* newName) {
	...
	NI T19_;
{	result = NIM_NIL;
	line = sourceLine__msgs_1101(conf, info);
	...
	LA17_: ;
	T19_ = (NI)0;
	T19_ = identLen__linter_11(line, first);
	last = (NI)((NI)(first + T19_) - ((NI) 1));
	result = differ__linter_74(line, first, last, newName);
	}BeforeRet_: ;
	return result;
}
static N_INLINE(int, nimCmpMem)(void* a, void* b, NI size) {
...
{	{
	...
	LA11_: ;
	newName = (*(*s).name).s;
	badName = differs__linter_172(conf, info, newName);
	{
		NIM_BOOL forceHint;
		NIM_BOOL T17_;
		NIM_BOOL T18_;
		...
		LA24_: ;
		liMessage__msgs_1118(conf, info, msgX60gensym24_, mX60gensym24_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NvI37FoCN5uTD3k9bAqbGMA_5, NIM_FALSE);
	}
	LA15_: ;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, checkPragmaUse__linter_240)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw w, NimStringDesc* pragmaName) {
	...
	wanted = reprEnum((NI)w, (&NTItspecialword__ycbpMCRV6Cd2eBh3X9biEiw_));
	{
		...
		LA6_: ;
		liMessage__msgs_1118(conf, info, msgX60gensym28_, mX60gensym28_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NvI37FoCN5uTD3k9bAqbGMA_7, NIM_FALSE);
	}
	LA3_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqtilde___linter_23)(NimStringDesc* s, NimStringDesc** a, NI aLen_0) {
...
{	result = NIM_NIL;
	...
	default:
	{
		...
		LA21_: ;
		{
			NIM_BOOL T24_;
			T24_ = (NIM_BOOL)0;
			T24_ = contains__pureZos_645(s->data, (s ? s->Sup.len : 0), 95);
			if (!T24_) goto LA25_;
			result = addChar(result, s->data[i]);
		}
		goto LA17_;
...
N_LIB_PRIVATE N_NIMCALL(void, nep1CheckDefImpl__linter_110)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw k) {
	NimStringDesc* beau;
{	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
	...
	LA25_: ;
	beau = beautifyName__linter_31((*(*s).name).s, k);
	{
		...
		LA32_: ;
		liMessage__msgs_1118(conf, info, msgX60gensym16_, mX60gensym16_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__NvI37FoCN5uTD3k9bAqbGMA_52, NIM_FALSE);
	}
	LA29_: ;
	}BeforeRet_: ;
}
