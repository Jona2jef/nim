...
N_LIB_PRIVATE N_NIMCALL(NI, hashIgnoreCase__pureZhashes_365)(NimStringDesc* x);
N_LIB_PRIVATE N_NIMCALL(NI, hashIgnoreStyle__pureZhashes_302)(NimStringDesc* x);
...
N_LIB_PRIVATE N_NIMCALL(NI, myhash__pureZstrtabs_101)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	{
		result = hash__pureZhashes_291(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 1):
	{
		result = hashIgnoreCase__pureZhashes_365(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 2):
	{
		result = hashIgnoreStyle__pureZhashes_302(key);
	}
	break;
	}
	return result;
...
{	result = NIM_NIL;
	...
	LA4_: ;
	{
		...
		result = getEnv__pureZos_418(key, ((NimStringDesc*) NIM_NIL));
	}
	goto LA6_;
	LA8_: ;
	{
		...
		while (1) {
			if (!(i < (f ? f->Sup.len : 0))) goto LA2;
			{
				...
				case 123:
				{
					...
					T13_ = NIM_NIL;
					T13_ = substr__system_7713(f, (NI)(i + ((NI) 2)), (NI)(j - ((NI) 1)));
					T14_ = NIM_NIL;
...
appendString(result, T14_);
				...
				case 95:
				{
					...
					T20_ = NIM_NIL;
					T20_ = substr__system_7713(f, (NI)(i + ((NI) 1)), (NI)(j_2 - ((NI) 1)));
					T21_ = NIM_NIL;
