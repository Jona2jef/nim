...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, ansiStyleCode__pureZterminal_295)(NI style);
...
N_LIB_PRIVATE N_NIMCALL(void, formatValue__pureZterminal_172)(NimStringDesc** result, NI value, NimStringDesc* specifier);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ, parseStandardFormatSpecifier__pureZstrformat_56)(NimStringDesc* s, NI start, NIM_BOOL ignoreUnknownSuffix);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, formatInt__pureZterminal_180)(NI n, NI radix, tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ spec);
...
N_LIB_PRIVATE NI gFG__pureZterminal_278;
N_LIB_PRIVATE NI gBG__pureZterminal_279;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isatty__pureZterminal_502)(FILE* f) {
	...
	result = (NIM_BOOL)0;
	T1_ = (int)0;
	T1_ = getFileHandle__systemZio_229(f);
	T2_ = (int)0;
	T2_ = isatty(T1_);
	result = !((T2_ == ((NI32) 0)));
	return result;
...
appendChar(T12_, spec.typ);
	...
	T13_ = NIM_NIL;
	T13_ = formatInt__pureZterminal_180(value, radix, spec);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, ansiStyleCode__pureZterminal_295)(NI style) {
	...
	formatValue__pureZstrformat_160((&fmtRes), ((NimStringDesc*) &TM__CN3raB9atujkEiPpxYAdlgQ_4), ((NimStringDesc*) NIM_NIL));
	formatValue__pureZterminal_172((&fmtRes), style, ((NimStringDesc*) NIM_NIL));
		...
		i = ((NI) 1);
		{
			while (1) {
				if (!(i <= ((NI) 9))) goto LA3;
				{
					...
					T8_ = NIM_NIL;
					T8_ = ansiStyleCode__pureZterminal_295(((NI) (s)));
...
N_LIB_PRIVATE N_NIMCALL(void, resetAttributes__pureZterminal_280)(FILE* f) {
	write__systemZio_205(f, ((NimStringDesc*) &TM__CN3raB9atujkEiPpxYAdlgQ_12));
	gFG__pureZterminal_278 = ((NI) 0);
	gBG__pureZterminal_279 = ((NI) 0);
}
N_LIB_PRIVATE N_NIMCALL(void, setForegroundColor__pureZterminal_387)(FILE* f, tyEnum_ForegroundColor__ez9ah4IgQc0AbdW68acioDg fg, NIM_BOOL bright) {
	NimStringDesc* T5_;
	gFG__pureZterminal_278 = fg;
	{
		if (!bright) goto LA3_;
		gFG__pureZterminal_278 += ((NI) 60);
	}
	LA3_: ;
	T5_ = NIM_NIL;
	T5_ = ansiStyleCode__pureZterminal_295(gFG__pureZterminal_278);
