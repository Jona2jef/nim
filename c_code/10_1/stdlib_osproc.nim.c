...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream__pureZosproc_598)(int* handle, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg fileMode);
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__pureZosproc_320)(void) {
	...
	T6_ = (void*)0;
	T6_ = alloc0Impl__system_1745(((NI) ((NI)((NI)(counter + ((NI) 1)) * ((NI) 4)))));
	result = ((NCSTRING*) (T6_));
	i_2 = ((NI) 0);
	{
		NimStringDesc* key_2;
		...
		val_2 = NIM_NIL;
		{
			...
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					void* T13_;
					T11_ = (NIM_BOOL)0;
					T11_ = eqeq___system_7723(environ[i_3], ((NCSTRING) NIM_NIL));
					if (!!(T11_)) goto LA10;
					kv_2 = cstrToNimstr(environ[i_3]);
					i_3 += ((NI) 1);
					p_2 = nsuFindChar(kv_2, 61, ((NI) 0), ((NI) 0));
					ai_2.Field0 = substr__system_7743(kv_2, ((NI) 0), (NI)(p_2 - ((NI) 1)));
					ai_2.Field1 = substr__system_7755(kv_2, (NI)(p_2 + ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__pureZosproc_309)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t) {
	...
	T1_ = nstlen(t);
	T2_ = (void*)0;
	T2_ = alloc0Impl__system_1745(((NI) ((NI)((NI)(T1_ + ((NI) 1)) * ((NI) 4)))));
	result = ((NCSTRING*) (T2_));
	i = ((NI) 0);
	{
		NimStringDesc* key;
...
{	result = (pid_t)0;
	...
	nimZeroMem((void*)(&fops), sizeof(posix_spawn_file_actions_t));
	{
		...
		T6_ = (NI32)0;
		T6_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T6_, ((NimStringDesc*) NIM_NIL));
	}
	LA4_: ;
	{
		int T9_;
		...
		T12_ = (NI32)0;
		T12_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T12_, ((NimStringDesc*) NIM_NIL));
	}
	LA10_: ;
	mask = (sigset_t)0;
	{
		...
		T18_ = (NI32)0;
		T18_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T18_, ((NimStringDesc*) NIM_NIL));
	}
	LA16_: ;
	{
		int T21_;
		...
		T24_ = (NI32)0;
		T24_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T24_, ((NimStringDesc*) NIM_NIL));
	}
	LA22_: ;
	{
		if (!(((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 6))&7U)))!=0)) goto LA27_;
		{
			...
			T34_ = (NI32)0;
			T34_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T34_, ((NimStringDesc*) NIM_NIL));
		}
		LA32_: ;
	}
	LA27_: ;
	...
	LA37_: ;
	{
		...
		T44_ = (NI32)0;
		T44_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T44_, ((NimStringDesc*) NIM_NIL));
	}
	LA42_: ;
	{
		if (!!((((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA47_;
		{
			...
			raiseOSError__pureZos_396(T54_, ((NimStringDesc*) NIM_NIL));
		}
		LA52_: ;
		{
			int T57_;
			...
			T60_ = (NI32)0;
			T60_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T60_, ((NimStringDesc*) NIM_NIL));
		}
		LA58_: ;
		{
			int T63_;
			...
			T66_ = (NI32)0;
			T66_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T66_, ((NimStringDesc*) NIM_NIL));
		}
		LA64_: ;
		{
			int T69_;
			...
			T72_ = (NI32)0;
			T72_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T72_, ((NimStringDesc*) NIM_NIL));
		}
		LA70_: ;
		{
			int T75_;
			...
			T78_ = (NI32)0;
			T78_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T78_, ((NimStringDesc*) NIM_NIL));
		}
		LA76_: ;
		{
			if (!(((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA81_;
			{
				...
				T88_ = (NI32)0;
				T88_ = osLastError__pureZos_399();
				raiseOSError__pureZos_396(T88_, ((NimStringDesc*) NIM_NIL));
			}
			LA86_: ;
		}
		goto LA79_;
		...
		{
			{
				...
				T95_ = (NI32)0;
				T95_ = osLastError__pureZos_399();
				raiseOSError__pureZos_396(T95_, ((NimStringDesc*) NIM_NIL));
			}
			LA93_: ;
		}
		LA79_: ;
	...
	res = (int)0;
	{
		...
		setCurrentDir__pureZos_731(T100_);
	}
	LA98_: ;
	pid = (pid_t)0;
	{
	...
	(void)(T107_);
	{
		...
		raiseOSError__pureZos_396(res, (*data).sysCommand);
	}
	LA110_: ;
	result = pid;
	goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingDir, NimStringDesc** args, NI argsLen_0, tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* env, tySet_tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA options) {
	...
	(*result).exitFlag = NIM_TRUE;
	{
		if (!!(((options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA3_;
		{
			...
			if (!T7_) goto LA14_;
			T16_ = (NI32)0;
			T16_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T16_, ((NimStringDesc*) NIM_NIL));
		}
		LA14_: ;
	}
	LA3_: ;
	...
	pid = startProcessAuxSpawn__pureZosproc_348((&data));
	{
		...
		setCurrentDir__pureZos_731(currentDir);
	}
	LA38_: ;
	{
...
{	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_598((&(*p).inHandle), ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1));
...
{	result = NIM_NIL;
	{
		...
		T5_ = NIM_NIL;
		T5_ = createStream__pureZosproc_598((&(*p).outHandle), ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
...
{	result = (NI)0;
	{
		...
		T5_ = (int)0;
		T5_ = exitStatusLikeShell__pureZos_1098((*p).exitStatus);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
	{
		...
		status = ((int) 1);
		{
			...
			T15_ = (NI32)0;
			T15_ = osLastError__pureZos_399();
			raiseOSError__pureZos_396(T15_, ((NimStringDesc*) NIM_NIL));
		}
		LA13_: ;
		(*p).exitFlag = NIM_TRUE;
		(*p).exitStatus = status;
			...
			while (1) {
				...
				count = wait_for_objects_etc((&info), ((int) 1), ((NU32) 8), ((NI64) (timeout)));
				{
					...
					err = ((int) (count));
					{
						if (!(err == ETIMEDOUT)) goto LA25_;
						{
							...
							raiseOSError__pureZos_396(T32_, ((NimStringDesc*) NIM_NIL));
						}
						LA30_: ;
						{
							pid_t T35_;
							...
							T38_ = (NI32)0;
							T38_ = osLastError__pureZos_399();
							raiseOSError__pureZos_396(T38_, ((NimStringDesc*) NIM_NIL));
						}
						LA36_: ;
						(*p).exitFlag = NIM_TRUE;
					...
					LA25_: ;
					{
						...
						raiseOSError__pureZos_396(err, ((NimStringDesc*) NIM_NIL));
					}
					goto LA23_;
					LA40_: ;
					LA23_: ;
				...
				LA21_: ;
				{
					if (!(((NI) 0) < count)) goto LA43_;
					{
						...
						T50_ = (NI32)0;
						T50_ = osLastError__pureZos_399();
						raiseOSError__pureZos_396(T50_, ((NimStringDesc*) NIM_NIL));
					}
					LA48_: ;
					(*p).exitFlag = NIM_TRUE;
					(*p).exitStatus = status_2;
				...
				{
					{
						...
						failedAssertImpl__systemZassertions_56(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_12));
					}
					LA54_: ;
				}
				LA19_: ;
	...
	LA6_: ;
	T56_ = (int)0;
	T56_ = exitStatusLikeShell__pureZos_1098((*p).exitStatus);
	result = ((NI) (T56_));
	}BeforeRet_: ;
	return result;
}
...
{	result = (NI)0;
	...
	ret = waitpid((*p).id, (&status), WNOHANG);
	{
		if (!(((NI32) 0) < ret)) goto LA8_;
		{
			...
			(*p).exitStatus = status;
			T15_ = (int)0;
			T15_ = exitStatusLikeShell__pureZos_1098(status);
			result = ((NI) (T15_));
		}
		LA13_: ;
	}
