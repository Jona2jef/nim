...
static N_INLINE(NimStringDesc*, getCurrentExceptionMsg__system_6982)(void);
...
static N_INLINE(void, setCurrentDir__pureZos_731)(NimStringDesc* newDir);
...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__pureZos_1432)(NimStringDesc* source, NimStringDesc* dest);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, paramStr__pureZos_1517)(NI i);
...
N_LIB_PRIVATE N_NIMCALL(NI, paramCount__pureZos_1523)(void);
	...
	result = NIM_NIL;
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA4_;
			{
				...
				raiseOSError__pureZos_396(T10_, dir);
			}
			LA8_: ;
		}
		goto LA2_;
				...
				while (1) {
					{
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							LA36_: ;
							{
								...
								if (!T39_) goto LA40_;
								k = getSymlinkFileKind__pureZos_1224(path_2);
							}
							goto LA29_;
							LA40_: ;
							LA29_: ;
...
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_59)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	popSafePoint();
		...
		if (isObj(nimBorrowCurrentException()->Sup.m_type, (&NTIoserror__BeJgrOdDsczOwEWOZbRfKA_))) {
			...
			asgnRef((void**) (&(*colonenvP_).errorMsg1), getCurrentExceptionMsg__system_6982());
			popCurrentException();
		}
	}
...
static N_INLINE(void, setCurrentDir__pureZos_731)(NimStringDesc* newDir) {
	{
		...
		T6_ = (NI32)0;
		T6_ = osLastError__pureZos_399();
		raiseOSError__pureZos_396(T6_, newDir);
	}
	LA4_: ;
}
N_LIB_PRIVATE N_CLOSURE(void, colonanonymous___scriptconfig_79)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a, void* ClE_0) {
	...
	T1_ = NIM_NIL;
	T1_ = getString__vm_352(a, ((NI) 0));
	setCurrentDir__pureZos_731(T1_);
	popSafePoint();
	}
	else {
		popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_145)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	...
	T2_ = NIM_NIL;
	T2_ = paramStr__pureZos_1517(((NI) (T1_)));
	setResult__vm_243(a, T2_);
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_147)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	NI T1_;
	T1_ = (NI)0;
	T1_ = paramCount__pureZos_1523();
