...
N_LIB_PRIVATE N_NIMCALL(void, moveDir__pureZos_1429)(NimStringDesc* source, NimStringDesc* dest);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, paramStr__pureZos_1514)(NI i);
...
N_LIB_PRIVATE N_NIMCALL(NI, paramCount__pureZos_1520)(void);
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							case ((NI) 0):
							{
								...
								LA45_: ;
								{
									...
									if (!T48_) goto LA49_;
									k = getSymlinkFileKind__pureZos_1212(path_2);
								}
								goto LA38_;
								LA49_: ;
								LA38_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_145)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	...
	T2_ = NIM_NIL;
	T2_ = paramStr__pureZos_1514(((NI) (T1_)));
	setResult__vm_243(a, T2_);
}
N_LIB_PRIVATE N_NIMCALL(void, colonanonymous___scriptconfig_147)(tyObject_VmArgs__0UUl6e5CNNQfMon2xW2bVA* a) {
	NI T1_;
	T1_ = (NI)0;
	T1_ = paramCount__pureZos_1520();
