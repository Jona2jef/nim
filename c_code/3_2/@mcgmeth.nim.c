...
N_LIB_PRIVATE N_NIMCALL(void, fixupDispatcher__cgmeth_240)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* meth, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* disp, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	LA13_: ;
	{
		...
		liMessage__msgs_1118(conf, (*meth).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 52), T21_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_4, NIM_FALSE);
		{
			...
			while (1) {
				...
				case ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2):
				{
					...
					checkMethodEffects__sempass50_4507(g, disp, s);
					{
						...
						LA11_: ;
						if (!T10_) goto LA12_;
						liMessage__msgs_1118((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_7, NIM_FALSE);
					}
					LA12_: ;
					goto BeforeRet_;
				}
...
appendString(T26_, T27_);
		liMessage__msgs_1118((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T26_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_10, NIM_FALSE);
	}
	goto LA22_;
	LA24_: ;
	{
		if (!!((((*s).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 20))&63U)))!=0))) goto LA29_;
		liMessage__msgs_1118((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 33), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_11, NIM_FALSE);
	}
	goto LA22_;
	LA29_: ;
	LA22_: ;
	...
	source = skipTypes__ast_3735((*n).typ, TM__zwdrTKOAAM6OvWnXdBD4GQ_13);
	{
		...
		LA9_: ;
		{
			...
			add__ast_4797(result, n);
			{
				...
				internalErrorImpl__msgs_1431(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_14), TM__zwdrTKOAAM6OvWnXdBD4GQ_15);
			}
			LA16_: ;
		}
		goto LA7_;
		LA12_: ;
		{
			...
			add__ast_4797(result, n);
			{
				...
				internalErrorImpl__msgs_1431(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_16), TM__zwdrTKOAAM6OvWnXdBD4GQ_17);
			}
			LA23_: ;
		}
		goto LA7_;
...
appendString(T9_, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_19));
		liMessage__msgs_1118(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T9_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_20, NIM_FALSE);
	}
	LA1_: ;
	return result;
}
