...
appendString(T7_, T8_);
		filename = toGeneratedFile__options_4235(conf, T7_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_4));
		f = (FILE*)0;
		{
			NIM_BOOL T11_;
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__systemZio_391(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
			LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_ = readAll__systemZio_352(f);
			colontmp__2 = ((NI) 0);
		...
		readSuccessful = NIM_TRUE;
		{
			...
			writeFile__systemZio_476(filename, (*Result).Field0);
		}
		LA24_: ;
		popSafePoint();
		}
