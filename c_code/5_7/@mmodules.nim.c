...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getPackage__modules_22)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx) {
	...
	pck = getPackageName__options_4143((*graph).config, filename);
	{
	...
	LA9_: ;
	{
		...
		LA15_: ;
		{
			...
			LA24_: ;
			if (!T23_) goto LA25_;
			pck3 = fakePackageName__options_4148((*graph).config, filename);
			T27_ = NIM_NIL;
...
appendString(T8_, (*(*result).name).s);
		liMessage__msgs_1118((*graph).config, unknownLineInfo__lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T8_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_3, NIM_FALSE);
	}
	LA6_: ;
		...
		filename = toFullPath__msgs_538((*graph).config, fileIdx);
		{
			...
			sX60gensym27_ = NIM_NIL;
			{
				if (!((flags_2 &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0)) goto LA15_;
				{
					...
					sX60gensym27_ = llStreamOpen__llstream_63(__stdinp);
				}
				goto LA17_;
				LA19_: ;
				{
	...
	LA7_: ;
	{
		...
		sX60gensym30_ = NIM_NIL;
		{
			if (!((flags_2 &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0)) goto LA41_;
			{
				...
				sX60gensym30_ = llStreamOpen__llstream_63(__stdinp);
			}
			goto LA43_;
			LA45_: ;
			{
...
N_LIB_PRIVATE N_NIMCALL(void, wantMainModule__modules_2883)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	NimStringDesc* T6_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty__options_4495((*conf).projectFull);
		if (!T3_) goto LA4_;
		liMessage__msgs_1118(conf, gCmdLineInfo__msgs_404, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 1), ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_10), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_11, NIM_FALSE);
	}
	LA4_: ;
	T6_ = NIM_NIL;
