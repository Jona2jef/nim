...
N_LIB_PRIVATE N_NIMCALL(void, getPathVersionChecksum__nimblecmd_171)(NimStringDesc* p, tyTuple__7q7q3E6Oj24ZNVJb9aonhAg* Result) {
	...
	checksumSeparatorIndex = nsuRFindChar(p, 45, ((NI) 0), ((NI) -1));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field2), substr__system_7776(p, (NI)(checksumSeparatorIndex + ((NI) 1))));
		{
			NIM_BOOL T7_;
			T7_ = (NIM_BOOL)0;
	...
	versionSeparatorIndex = nsuRFindStr(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_5), ((NI) 0), (NI)(checksumSeparatorIndex - ((NI) 1)));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field1), substr__system_7764(p, (NI)(versionSeparatorIndex + ((NI) 1)), (NI)(checksumSeparatorIndex - ((NI) 1))));
	}
	goto LA11_;
	LA13_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__nimblecmd_2053)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	nimbleLinks = resultX60gensym38_;
	{
		...
		T23_ = NIM_NIL;
		T23_ = readFile__systemZio_465(nimbleLinks->data[((NI) 0)]);
	...
	LA3_: ;
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			if (!(d == ((DIR*) NIM_NIL))) goto LA8_;
			{
				...
				raiseOSError__pureZos_405(T14_, dir);
			}
			LA12_: ;
		}
		goto LA6_;
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							case ((NI) 0):
							{
								...
								LA49_: ;
								{
									...
									if (!T52_) goto LA53_;
									k_2 = getSymlinkFileKind__pureZos_1227(path);
								}
								goto LA42_;
								LA53_: ;
								LA42_: ;
