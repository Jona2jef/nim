...
N_LIB_PRIVATE N_NIMCALL(void, checkModule__icZintegrity_662)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedModule__ZSxNoR2V6oK5xosmtvhjNQ* m);
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSym__icZintegrity_521)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, NI32 item);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsOrIncl__icZintegrity_62)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A* s, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key);
...
static N_INLINE(NI, rawGet__icZintegrity_112)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, NI* hc);
...
static N_INLINE(NIM_BOOL, mustRehash__icZintegrity_189)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A t);
N_LIB_PRIVATE N_NIMCALL(void, enlarge__icZintegrity_267)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A* s);
static N_INLINE(NI, rawGetKnownHC__icZintegrity_333)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A t, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, NI hc);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__icZintegrity_412)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A* s, tySequence__A8KE235PFPwL9bP9cMGmiM9bw** data, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key, NI hc, NI h);
N_LIB_PRIVATE N_NIMCALL(void, checkSym__icZintegrity_500)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedSym__XjVn21MwvH8ij6CfopYZWw* s);
...
N_LIB_PRIVATE N_NIMCALL(void, checkTree__icZintegrity_617)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw t);
...
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSymIds__icZintegrity_621)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedModule__ZSxNoR2V6oK5xosmtvhjNQ* m, tySequence__48JTohSgTy339bRxHzUD8KA* symIds);
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					...
					if (!T9_) goto LA10_;
					T12_ = (NI)0;
					T12_ = rawGetKnownHC__icZintegrity_333((*s), n->data[i].Field1, n->data[i].Field0);
					j = (NI)(((NI) -1) - T12_);
					rawInsert__icZintegrity_412(s, (&(*s).data), n->data[i].Field1, n->data[i].Field0, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsOrIncl__icZintegrity_62)(tyObject_HashSet__P87v3NNTmMGypvkpum3x1A* s, tyObject_ItemId__ozxAxZLHTQ9c3akTzYvt67g key) {
	...
	LA4_: ;
	hc = (NI)0;
	index = rawGet__icZintegrity_112((*s), key, (&hc));
	{
	...
	{
		{
			NIM_BOOL T13_;
			T13_ = (NIM_BOOL)0;
			T13_ = mustRehash__icZintegrity_189((*s));
			if (!T13_) goto LA14_;
			enlarge__icZintegrity_267(s);
			index = rawGetKnownHC__icZintegrity_333((*s), key, hc);
		}
		LA14_: ;
		rawInsert__icZintegrity_412(s, (&(*s).data), key, hc, (NI)(((NI) -1) - index));
		(*s).counter += ((NI) 1);
	}
	LA6_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, checkForeignSym__icZintegrity_21)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedItemId__FzcXUzSZ9cNfGYsfibgjWlQ symId) {
	...
	itemId = translateId__icZic_8432(symId, (*(*c).g).packed_0, ((NI) ((*c).thisModule)), (*(*c).g).config);
	{
		NIM_BOOL T3_;
		NI32 oldThisModule;
		T3_ = (NIM_BOOL)0;
		...
		checkSym__icZintegrity_500(c, (&(*(*c).g).packed_0->data[itemId.module].fromDisk.syms->data[itemId.item]));
...
N_LIB_PRIVATE N_NIMCALL(void, checkNode__icZintegrity_24)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree, NI n) {
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = eqeq___icZic_6137((*T3_).typeId_0, nilItemId__icZpacked95ast_14);
		if (!!(T4_)) goto LA5_;
		T7_ = (tyObject_PackedNode__7lDGAZiNp4zbO65GEpoKow*)0;
		T7_ = X5BX5D___icZpacked95ast_299((&tree), n);
	...
	{
		checkLocalSym__icZintegrity_521(c, tree.nodes->data[n].operand);
	}
	break;
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 162):
	{
		...
		T15_ = sons2__icZpacked95ast_498(tree, n);
		n1 = T15_.Field0;
		n2 = T15_.Field1;
		...
		checkForeignSym__icZintegrity_21(c, T16_);
	}
	break;
	default:
	{
...
N_LIB_PRIVATE N_NIMCALL(void, checkTypeObj__icZintegrity_28)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedType__IhXsK7mrwumUBtEqbZ2BqA* typ) {
	...
	}
	{
		...
		checkNode__icZintegrity_24(c, (*(*c).g).packed_0->data[(*c).thisModule].fromDisk.bodies, ((NI) ((*typ).n)));
	}
	LA7_: ;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = eqeq___icZic_6137((*typ).sym, nilItemId__icZpacked95ast_14);
		if (!!(T11_)) goto LA12_;
	...
	LA12_: ;
	{
		NIM_BOOL T16_;
		T16_ = (NIM_BOOL)0;
		T16_ = eqeq___icZic_6137((*typ).owner, nilItemId__icZpacked95ast_14);
		if (!!(T16_)) goto LA17_;
...
{	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___icZic_6137(typeId_0, nilItemId__icZpacked95ast_14);
		if (!T3_) goto LA4_;
		goto BeforeRet_;
	}
	LA4_: ;
	itemId = translateId__icZic_8432(typeId_0, (*(*c).g).packed_0, ((NI) ((*c).thisModule)), (*(*c).g).config);
	{
		NIM_BOOL T8_;
		NI32 oldThisModule;
		T8_ = (NIM_BOOL)0;
		...
		oldThisModule = (*c).thisModule;
		(*c).thisModule = itemId.module;
		checkTypeObj__icZintegrity_28(c, (&(*(*c).g).packed_0->data[itemId.module].fromDisk.types->data[itemId.item]));
		(*c).thisModule = oldThisModule;
	}
	LA9_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, checkSym__icZintegrity_500)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedSym__XjVn21MwvH8ij6CfopYZWw* s) {
	...
	checkType__icZintegrity_18(c, (*s).typ);
	{
		...
		checkNode__icZintegrity_24(c, (*(*c).g).packed_0->data[(*c).thisModule].fromDisk.bodies, ((NI) ((*s).ast)));
	}
	LA7_: ;
	{
		NIM_BOOL T11_;
		T11_ = (NIM_BOOL)0;
		T11_ = eqeq___icZic_6137((*s).owner, nilItemId__icZpacked95ast_14);
		if (!!(T11_)) goto LA12_;
...
N_LIB_PRIVATE N_NIMCALL(void, checkLocalSym__icZintegrity_521)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, NI32 item) {
	...
	itemId.item = item;
	{
		...
		T3_ = containsOrIncl__icZintegrity_62((&(*c).checkedSyms), itemId);
		if (!!(T3_)) goto LA4_;
		checkSym__icZintegrity_500(c, (&(*(*c).g).packed_0->data[(*c).thisModule].fromDisk.syms->data[item]));
	}
	LA4_: ;
}
static N_INLINE(NI, len__icZpacked95ast_293)(tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw tree) {
...
N_LIB_PRIVATE N_NIMCALL(void, checkTree__icZintegrity_617)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedTree__8otSrA7MENGYESDkEP7nnw t) {
	{
		...
		p_2 = ((NI) 0);
		{
			while (1) {
				...
				NI s;
				T4_ = (NI)0;
				T4_ = len__icZpacked95ast_293(t);
				if (!(p_2 < T4_)) goto LA3;
				p = p_2;
				checkNode__icZintegrity_24(c, t, p);
				s = span__icZpacked95ast_494(t, p_2);
				p_2 += s;
			} LA3: ;
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(void, checkModule__icZintegrity_662)(tyObject_CheckedContext__Lm150hXPA9af9bhpisAToqtA* c, tyObject_PackedModule__ZSxNoR2V6oK5xosmtvhjNQ* m) {
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				checkLocalSym__icZintegrity_521(c, ((NI32) (i)));
				res += ((NI) 1);
			} LA4: ;
		}
	}
	checkTree__icZintegrity_617(c, (*m).toReplay);
	checkTree__icZintegrity_617(c, (*m).topLevel);
	{
	...
	checkLocalSymIds__icZintegrity_621(c, m, (*m).converters);
	checkLocalSymIds__icZintegrity_621(c, m, (*m).methods);
	checkLocalSymIds__icZintegrity_621(c, m, (*m).trmacros);
	checkLocalSymIds__icZintegrity_621(c, m, (*m).pureEnums);
}
	...
	c.g = g;
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				{
					c.thisModule = ((NI32) (i));
					checkModule__icZintegrity_662((&c), (&(*g).packed_0->data[i].fromDisk));
				}
				break;
				}
				res += ((NI) 1);
