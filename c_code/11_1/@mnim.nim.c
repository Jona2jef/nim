...
static N_INLINE(NimStringDesc*, findNodeJs__nodejs_2)(void) {
	NimStringDesc* result;
	result = NIM_NIL;
	result = findExe__pureZos_647(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts__pureZos_646, 1);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe__pureZos_647(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts__pureZos_646, 1);
	}
	LA3_: ;
	{
